...
await ssyr2k(device, "lower", "no-transpose", n, n, 1.0, AGpu, AGpu.lda, BGpu, BGpu.lda, 0.0, CGpu, CGpu.lda); // C (lower) = A*B^T + B*A^T

// single readback
const result = await CGpu.read();
console.log("C (lower triangle = A*B^T + B*A^T, upper triangle untouched zeros):");
