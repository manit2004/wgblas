var wgblas=(()=>{var ue=Object.create;var $=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var le=Object.getOwnPropertyNames;var me=Object.getPrototypeOf,fe=Object.prototype.hasOwnProperty;var Q=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var U=(t,r,e)=>()=>{if(e)throw e[0];try{return t&&(r=t(t=0)),r}catch(a){throw e=[a],a}};var rr=(t,r)=>{for(var e in r)$(t,e,{get:r[e],enumerable:!0})},er=(t,r,e,a)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of le(r))!fe.call(t,o)&&o!==e&&$(t,o,{get:()=>r[o],enumerable:!(a=ce(r,o))||a.enumerable});return t};var X=(t,r,e)=>(e=t!=null?ue(me(t)):{},er(r||!t||!t.__esModule?$(e,"default",{value:t,enumerable:!0}):e,t)),pe=t=>er($({},"__esModule",{value:!0}),t);var pr,fr=U(()=>{pr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var gr,dr=U(()=>{gr=`// sum reduction: collapses 2*WGS partials into one scalar.
// dispatch: 1 workgroup of WGS threads.
...
`});var br,wr=U(()=>{br=`// sscal: x = alpha * x
...
`});var _r,hr=U(()=>{_r=`// saxpy: y = alpha * x + y
...
`});var Er,Br=U(()=>{Er=`// sdot: result = sum(x[i] * y[i])
...
`});var Pr,Ar=U(()=>{Pr=`// sasum: result = sum(|x[i]|)
...
`});var Sr,kr=U(()=>{Sr=`// snrm2: result = sqrt(sum(x[i] * x[i]))
...
`});var Wr,Fr=U(()=>{Wr=`// srot: x = c*x + s*y,  y = -s*x + c*y
...
`});var Tr,Ir=U(()=>{Tr=`// srotm: applies modified Givens rotation H to vectors x and y.
...
`});var Ur,Rr=U(()=>{Ur=`// isamax: returns index of element with largest absolute value
...
`});var Mr,Nr=U(()=>{Mr=`// sgemv_n: y = alpha * A * x + beta * y  (A is m\xD7n row-major, no-transpose)
//
...
`});var Vr,Dr=U(()=>{Vr=`// sgemv_t: y = alpha * A^T * x + beta * y  (A is m\xD7n row-major, transposed)
...
`});var Cr,Lr=U(()=>{Cr=`// ssymv: y = alpha * A * x + beta * y
