var wgblas=(()=>{var St=Object.create;var mr=Object.defineProperty;var Pt=Object.getOwnPropertyDescriptor;var Dt=Object.getOwnPropertyNames;var Lt=Object.getPrototypeOf,It=Object.prototype.hasOwnProperty;var pr=(o=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(o,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):o)(function(o){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+o+'" is not supported')});var F=(o,e,r)=>()=>{if(r)throw r[0];try{return o&&(e=o(o=0)),e}catch(a){throw r=[a],a}};var Br=(o,e)=>{for(var r in e)mr(o,r,{get:e[r],enumerable:!0})},Ar=(o,e,r,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let t of Dt(e))!It.call(o,t)&&t!==r&&mr(o,t,{get:()=>e[t],enumerable:!(a=Pt(e,t))||a.enumerable});return o};var gr=(o,e,r)=>(r=o!=null?St(Lt(o)):{},Ar(e||!o||!o.__esModule?mr(r,"default",{value:o,enumerable:!0}):r,o)),jt=o=>Ar(mr({},"__esModule",{value:!0}),o);var Tr,Mr=F(()=>{Tr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var Ie,Le=F(()=>{Ie=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var Ne,je=F(()=>{Ne=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
fn main(
  ...
  // Load indices are independent of the compute thread shape (As is BM x BK,
  // Bs is BK x BN, neither matches the BN x (BM/TM) compute grid) \u2014 each of
  // the NUM_THREADS threads loads exactly one element of each tile.
  ...
  for (var t = 0u; t < numTiles; t++) {
    ...
    for (var dotIdx = 0u; dotIdx < BK; dotIdx++) {
      let bTmp = Bs[dotIdx * BN + threadCol];
