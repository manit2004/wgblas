var wgblas=(()=>{var tt=Object.create;var or=Object.defineProperty;var at=Object.getOwnPropertyDescriptor;var it=Object.getOwnPropertyNames;var ot=Object.getPrototypeOf,nt=Object.prototype.hasOwnProperty;var nr=(a=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(a,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):a)(function(a){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+a+'" is not supported')});var j=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(i){throw e=[i],i}};var hr=(a,r)=>{for(var e in r)or(a,e,{get:r[e],enumerable:!0})},xr=(a,r,e,i)=>{if(r&&typeof r=="object"||typeof r=="function")for(let t of it(r))!nt.call(a,t)&&t!==e&&or(a,t,{get:()=>r[t],enumerable:!(i=at(r,t))||i.enumerable});return a};var sr=(a,r,e)=>(e=a!=null?tt(ot(a)):{},xr(r||!a||!a.__esModule?or(e,"default",{value:a,enumerable:!0}):e,a)),st=a=>xr(or({},"__esModule",{value:!0}),a);var Nr,Ir=j(()=>{Nr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var ge,pe=j(()=>{ge=`// f64add: adds two doubles, each packed as a [main, aux] pair (main: f32
...
`});var be,we=j(()=>{be=`// dasum: result = sum(|x[i]|)
...
`});var xe,he=j(()=>{xe=`// strsv_invert_block: computes ONE column (workgroup_id.x) of ONE block's
...
`});var ye,ve=j(()=>{ye=`// strsv_apply_inverse: given a precomputed block inverse (from
...
`});var Ee,_e=j(()=>{Ee=`// strsv_update: subtracts a solved block's contribution from every
...
`});var ke={};hr(ke,{shaderSources:()=>Tt});var Tt,Be=j(()=>{Ir();Wr();Mr();Tr();Vr();Dr();Or();Qr();Zr();Xr();Yr();re();te();ie();ne();ue();fe();de();pe();we();he();ve();_e();Tt={"reduction/argmax":Nr,"reduction/sum":jr,"reduction/sumF64":Ur,sscal:Rr,sswap:Hr,saxpy:Cr,scopy:zr,sdot:qr,sasum:Kr,snrm2:$r,srot:Jr,srotm:ee,isamax:ae,sgemv_n:oe,sgemv_t:se,ssymv:le,strmv:ce,sger:me,f64add:ge,dasum:be,strsv_invert_block:xe,strsv_apply_inverse:ye,strsv_update:Ee}});var Ct={};hr(Ct,{GpuMatrix:()=>D,GpuVector:()=>x,cleanup:()=>Br,dasum:()=>je,gpuName:()=>Gr,init:()=>kr,isamax:()=>Te,randomFloat32Array:()=>Fr,randomFloat64Array:()=>Lr,sasum:()=>We,saxpy:()=>Se,scopy:()=>Fe,sdot:()=>Ie,sgemv:()=>He,sger:()=>qe,snrm2:()=>Ue,srot:()=>Re,srotm:()=>Ve,sscal:()=>Ae,sswap:()=>Pe,ssymv:()=>De,strmv:()=>Ce,strsv:()=>Qe});function vr(a,r){return r?a.features.has("timestamp-query")?{requiredFeatures:["timestamp-query"]}:(console.warn("timestamp-query not supported on this device \u2014 benchmark mode disabled."),{}):{}}function yr(){if(!_r())return{querySet:null,passDescriptor:void 0};let r=M().createQuerySet({type:"timestamp",count:2});return{querySet:r,passDescriptor:{timestampWrites:{querySet:r,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}}}function ur(a,r){if(!r)return null;let e=M(),i=e.createBuffer({label:"timestamp-resolve",size:16,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC});a.resolveQuerySet(r,0,2,i,0);let t=e.createBuffer({label:"timestamp-readback",size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return a.copyBufferToBuffer(i,0,t,0,16),{tsReadBuffer:t,resolveBuffer:i,querySet:r}}async function A(a){if(!a)return;let{tsReadBuffer:r,resolveBuffer:e,querySet:i}=a;await r.mapAsync(GPUMapMode.READ);let t=new BigInt64Array(r.getMappedRange().slice());return r.unmap(),r.destroy(),e.destroy(),i.destroy(),Math.max(0,Number(t[1]-t[0]))/1e6}var Q=null,$=null,Er=null,fr=!1;async function kr({powerPreference:a="high-performance",benchmark:r=!1}={}){if(Q)return Q;let e;if(typeof window>"u"){let{create:o,globals:u}=await import("webgpu");Object.assign(globalThis,u),e=o([]),Er=e}else e=navigator.gpu;if(!e)throw new Error("WebGPU not supported in this environment.");if($=await e.requestAdapter({powerPreference:a})??await e.requestAdapter(),!$)throw new Error("No WebGPU adapter found.");fr=r;let t=[...vr($,r).requiredFeatures??[]];return Q=await $.requestDevice({requiredFeatures:t}),Q.addEventListener("uncapturederror",o=>{console.error("Uncaptured GPU error:",o.error.message)}),Q}function Br(){Q&&(Q.destroy(),Q=null),$=null,Er=null,fr=!1}function Gr(){if(!$)throw new Error("WebGPU adapter not initialized \u2014 call init() first.");let{device:a,description:r}=$.info;return{description:r||"unknown",device:a||"unknown"}}function _r(){return fr}function M(){if(!Q)throw new Error("WebGPU device not initialized \u2014 call init() first.");return Q}function m(...a){a.flat().forEach(r=>r.destroy())}function b(a,r="blas-input",e=!1){let i=M(),t=i.limits.maxStorageBufferBindingSize,o=a.byteLength;if(o>t)throw new Error(`Buffer size ${o} bytes exceeds device limit of ${t} bytes.`);let u=e?GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC:GPUBufferUsage.STORAGE,n=i.createBuffer({label:r,size:o,usage:u,mappedAtCreation:!0}),s=a.constructor;return new s(n.getMappedRange()).set(a),n.unmap(),n}function H(a,r="blas-storage"){return M().createBuffer({label:r,size:a,usage:GPUBufferUsage.STORAGE})}function O(a,r="blas-result"){return M().createBuffer({label:r,size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC})}function E(a,r){let i=M().createBuffer({label:"blas-readback",size:r.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return a.copyBufferToBuffer(r,0,i,0,r.size),i}function I(a,r="blas-params"){let e=M(),i=a.length*4,t=Math.ceil(i/16)*16,o=new ArrayBuffer(t),u=new DataView(o);a.forEach(({value:s,type:l},c)=>{let d=c*4;if(l==="u32")u.setUint32(d,s,!0);else if(l==="i32")u.setInt32(d,s,!0);else if(l==="f32")u.setFloat32(d,s,!0);else throw new Error(`Unknown param type "${l}". Use "f32", "u32", or "i32".`)});let n=e.createBuffer({label:r,size:t,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return e.queue.writeBuffer(n,0,o),n}async function y(a,r=Float32Array){try{await a.mapAsync(GPUMapMode.READ);let e=new r(a.getMappedRange().slice());return a.unmap(),e}finally{a.destroy()}}var ut=new ArrayBuffer(8),J=new DataView(ut),Ar=new ArrayBuffer(4),Pr=new Uint32Array(Ar),Sr=new Float32Array(Ar);function lt(a){return Pr[0]=a>>>0,Sr[0]}function ft(a){return Sr[0]=a,Pr[0]}function ct(a,r,e,i){let t=r>>>3,o=r&7,u=i>>>29,n=e<<3|u,s=i&536870911,l=a<<31|t<<23|n,c=o>>>2&1,d=o&3,f=s>>>23,p=s&8388607,g=d<<6|f,w=(c<<31|g<<23|p)>>>0;return[lt(l),w]}function dt(a,r){let e=ft(a);r=r>>>0;let i=e>>>31,t=e>>>23&255,o=e&8388607,u=r>>>31,n=r>>>23&255,s=r&8388607,l=u<<2|n>>>6,c=(n&63)<<23|s,d=t<<3|l,f=o>>>3,g=((o&7)<<29|c)>>>0;return{sign:i,rawExp:d,mantissaHi:f,lo:g}}var mt=2040;function lr(a){J.setFloat64(0,a,!1);let r=J.getUint32(0,!1),e=J.getUint32(4,!1),i=r>>>31,t=r>>>20&2047,o=r&1048575;if(t>=mt)throw new RangeError(`packF64: |${a}| is too large to pack safely (must be finite with magnitude below ~1.4e306); main's bit pattern would itself be NaN/Infinity-shaped and get silently corrupted by any real float32 round-trip`);return ct(i,t,o,e)}function rr(a,r){let{sign:e,rawExp:i,mantissaHi:t,lo:o}=dt(a,r),u=(e<<31|i<<20|t)>>>0;return J.setUint32(0,u,!1),J.setUint32(4,o,!1),J.getFloat64(0,!1)}var x=class a{constructor(r,e,i=Float32Array,t=null){this._buf=r,this._auxBuf=t,this.length=e,this.dtype=i}static from(r){if(r instanceof Float64Array){let i=new Float32Array(r.length),t=new Uint32Array(r.length);for(let n=0;n<r.length;n++){let s=lr(r[n]);i[n]=s[0],t[n]=s[1]}let o=b(i,"gpu-vector-f64-main",!0),u=b(t,"gpu-vector-f64-aux",!0);return new a(o,r.length,Float64Array,u)}if(!(r instanceof Float32Array))throw new Error("GpuVector.from expects a Float32Array or Float64Array.");let e=b(r,"gpu-vector",!0);return new a(e,r.length,r.constructor)}async read(){let r=M(),e=r.createCommandEncoder(),i=E(e,this._buf);if(r.queue.submit([e.finish()]),!this._auxBuf)return y(i,this.dtype);let t=r.createCommandEncoder(),o=E(t,this._auxBuf);r.queue.submit([t.finish()]);let[u,n]=await Promise.all([y(i,Float32Array),y(o,Uint32Array)]),s=new Float64Array(this.length);for(let l=0;l<this.length;l++)s[l]=rr(u[l],n[l]);return s}destroy(){this._buf.destroy(),this._auxBuf&&this._auxBuf.destroy()}};var D=class a{constructor(r,e,i,t,o=null){this._buf=r,this._auxBuf=o,this.rows=e,this.cols=i,this.lda=t}static from(r,e,i,t=i){if(!(r instanceof Float32Array)&&!(r instanceof Float64Array))throw new Error("GpuMatrix.from expects a Float32Array or Float64Array.");if(!Number.isInteger(e)||e<=0)throw new Error("rows must be a positive integer.");if(!Number.isInteger(i)||i<=0)throw new Error("cols must be a positive integer.");if(!Number.isInteger(t)||t<i)throw new Error("lda must be an integer >= cols.");if(r.length<e*t)throw new Error("data does not have enough elements for the given rows and lda.");if(r instanceof Float64Array){let u=e*t,n=new Float32Array(u),s=new Uint32Array(u);for(let d=0;d<u;d++){let f=lr(r[d]);n[d]=f[0],s[d]=f[1]}let l=b(n,"gpu-matrix-f64-main",!0),c=b(s,"gpu-matrix-f64-aux",!0);return new a(l,e,i,t,c)}let o=b(r.subarray(0,e*t),"gpu-matrix",!0);return new a(o,e,i,t)}async read(){let r=M(),e=r.createCommandEncoder(),i=E(e,this._buf);if(r.queue.submit([e.finish()]),this._auxBuf){let u=r.createCommandEncoder(),n=E(u,this._auxBuf);r.queue.submit([u.finish()]);let[s,l]=await Promise.all([y(i,Float32Array),y(n,Uint32Array)]),c=new Float64Array(this.rows*this.lda);for(let f=0;f<c.length;f++)c[f]=rr(s[f],l[f]);if(this.lda===this.cols)return c;let d=new Float64Array(this.rows*this.cols);for(let f=0;f<this.rows;f++)d.set(c.subarray(f*this.lda,f*this.lda+this.cols),f*this.cols);return d}let t=await y(i,Float32Array);if(this.lda===this.cols)return t;let o=new Float32Array(this.rows*this.cols);for(let u=0;u<this.rows;u++)o.set(t.subarray(u*this.lda,u*this.lda+this.cols),u*this.cols);return o}destroy(){this._buf.destroy(),this._auxBuf&&this._auxBuf.destroy()}};function Fr(a,r=-1,e=1){let i=new Float32Array(a);for(let t=0;t<a;t++)i[t]=r+Math.random()*(e-r);return i}function Lr(a,r=-1,e=1){let i=new Float64Array(a);for(let t=0;t<a;t++)i[t]=r+Math.random()*(e-r);return i}function B(a,r,e=0){let i=M(),t=r.map((o,u)=>({binding:e+u,resource:o instanceof GPUBuffer?{buffer:o}:o}));return i.createBindGroup({layout:a,entries:t})}var pt=new WeakMap;function P(a){M().queue.submit([a.finish()])}function cr(){let a=M(),{querySet:r,passDescriptor:e}=yr();return{commandEncoder:a.createCommandEncoder(),querySet:r,passDescriptor:e}}function ar(a,r,e,i,t){let o=a.beginComputePass(t);o.setPipeline(r),o.setBindGroup(0,e),typeof i=="number"?o.dispatchWorkgroups(i):o.dispatchWorkgroups(i.x,i.y),o.end(),pt.set(a,o)}function S(a,r,e){let{commandEncoder:i,querySet:t,passDescriptor:o}=cr();ar(i,a,r,e,o);let u=ur(i,t);return{commandEncoder:i,ts:u}}var Ht={},dr=new WeakMap;async function G(a,r,e="main"){dr.has(a)||dr.set(a,new Map);let i=dr.get(a),t=Array.isArray(r)?r:[r],o=`${t.join("+")}::${e}`;return i.has(o)||i.set(o,await Vt(t,e)),i.get(o)}async function Rt(a){if(typeof process>"u"||!process.versions?.node){let{shaderSources:r}=await Promise.resolve().then(()=>(Be(),ke)),e=r[a];if(!e)throw new Error(`Shader "${a}" not found in browser bundle.`);return e}else{let{readFileSync:r}=await import("fs"),{fileURLToPath:e}=await import("url"),{dirname:i,join:t}=await import("path"),o=i(e(Ht.url));return r(t(o,`../shaders/${a}.wgsl`),"utf8")}}async function Vt(a,r="main"){let e=M(),i=a.join("+"),t=(await Promise.all(a.map(Rt))).join(`
...
`)}`);let s=r==="main"?{module:o}:{module:o,entryPoint:r},l=e.createComputePipeline({label:i,layout:"auto",compute:s});return l._shaderModule=o,l}var Dt=64,Ge=8;function C(a,r){let e=M().limits.maxComputeWorkgroupsPerDimension;return r===void 0?Math.min(Math.ceil(a/Dt),e):{x:Math.min(Math.ceil(r/Ge),e),y:Math.min(Math.ceil(a/Ge),e)}}async function Ae(a,r,e,i,t){let o=i instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(t))throw new Error("n and incx must be integers.");if(typeof e!="number")throw new Error("alpha must be a number.");if(Number.isNaN(e))throw new Error("alpha must not be NaN.");if(!Number.isFinite(e))throw new Error("alpha must be finite.");if(t<=0)throw new Error("incx must be positive.");if(!(i instanceof Float32Array)&&!(i instanceof x))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return o?{}:i;if(i.length<(r-1)*t+1)throw new Error("x does not have enough elements for the given n and incx.");let u=await G(a,"sscal"),n=null,s=null,l=null;try{n=o?i._buf:b(i,"sscal-x",!0),s=I([{value:r,type:"u32"},{value:e,type:"f32"},{value:t,type:"u32"}],"sscal-params");let c=B(u.getBindGroupLayout(0),[n,s]),{commandEncoder:d,ts:f}=S(u,c,C(r));l=o?null:E(d,n),P(d);let p=await A(f);if(o)return p!==void 0?{gpuTimeMs:p}:{};let g=await y(l,Float32Array);return l=null,p!==void 0?{x:g,gpuTimeMs:p}:g}finally{!o&&n&&m(n),s&&m(s),l&&m(l)}}async function Pe(a,r,e,i,t,o){let u=e instanceof x,n=t instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(o))throw new Error("n, incx, and incy must be integers.");if(i<=0||o<=0)throw new Error("incx and incy must be positive.");if(!(e instanceof Float32Array)&&!(e instanceof x))throw new Error("x must be a Float32Array or GpuVector.");if(!(t instanceof Float32Array)&&!(t instanceof x))throw new Error("y must be a Float32Array or GpuVector.");if(e.constructor!==t.constructor)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return u?{}:{x:e,y:t};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(r-1)*o+1)throw new Error("y does not have enough elements for the given n and incy.");let s=await G(a,"sswap"),l=null,c=null,d=null,f=null,p=null;try{l=u?e._buf:b(e,"sswap-x",!0),c=n?t._buf:b(t,"sswap-y",!0),d=I([{value:r,type:"u32"},{value:i,type:"u32"},{value:o,type:"u32"}],"sswap-params");let g=B(s.getBindGroupLayout(0),[l,c,d]),{commandEncoder:w,ts:_}=S(s,g,C(r));f=u?null:E(w,l),p=n?null:E(w,c),P(w);let h=await A(_);if(u&&n)return h!==void 0?{gpuTimeMs:h}:{};let k=await y(f,Float32Array);f=null;let v=await y(p,Float32Array);return p=null,h!==void 0?{x:k,y:v,gpuTimeMs:h}:{x:k,y:v}}finally{!u&&l&&m(l),!n&&c&&m(c),d&&m(d),f&&m(f),p&&m(p)}}async function Se(a,r,e,i,t,o,u){let n=i instanceof x,s=o instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(t)||!Number.isInteger(u))throw new Error("n, incx, and incy must be integers.");if(typeof e!="number")throw new Error("alpha must be a number.");if(Number.isNaN(e))throw new Error("alpha must not be NaN.");if(!Number.isFinite(e))throw new Error("alpha must be finite.");if(t<=0||u<=0)throw new Error("incx and incy must be positive.");if(!n&&!(i instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!s&&!(o instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(n!==s)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return s?{}:{y:o};if(i.length<(r-1)*t+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*u+1)throw new Error("y does not have enough elements for the given n and incy.");let l=await G(a,"saxpy"),c=null,d=null,f=null,p=null;try{c=n?i._buf:b(i,"saxpy-x",!1),d=s?o._buf:b(o,"saxpy-y",!0),f=I([{value:r,type:"u32"},{value:e,type:"f32"},{value:t,type:"u32"},{value:u,type:"u32"}],"saxpy-params");let g=B(l.getBindGroupLayout(0),[c,d,f]),{commandEncoder:w,ts:_}=S(l,g,C(r));p=s?null:E(w,d),P(w);let h=await A(_);if(s&&n)return h!==void 0?{gpuTimeMs:h}:{};let k=await y(p,Float32Array);return p=null,h!==void 0?{y:k,gpuTimeMs:h}:{y:k}}finally{!n&&c&&m(c),!s&&d&&m(d),f&&m(f),p&&m(p)}}async function Fe(a,r,e,i,t,o){let u=e instanceof x,n=t instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(o))throw new Error("n, incx, and incy must be integers.");if(i<=0||o<=0)throw new Error("incx and incy must be positive.");if(!u&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(u!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return n?{}:{y:t};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(r-1)*o+1)throw new Error("y does not have enough elements for the given n and incy.");let s=await G(a,"scopy"),l=null,c=null,d=null,f=null;try{l=u?e._buf:b(e,"scopy-x",!1),c=n?t._buf:b(t,"scopy-y",!0),d=I([{value:r,type:"u32"},{value:i,type:"u32"},{value:o,type:"u32"}],"scopy-params");let p=B(s.getBindGroupLayout(0),[l,c,d]),{commandEncoder:g,ts:w}=S(s,p,C(r));f=n?null:E(g,c),P(g);let _=await A(w);if(n&&u)return _!==void 0?{gpuTimeMs:_}:{};let h=await y(f,Float32Array);return f=null,_!==void 0?{y:h,gpuTimeMs:_}:{y:h}}finally{!u&&l&&m(l),!n&&c&&m(c),d&&m(d),f&&m(f)}}var Le=64;async function Ie(a,r,e,i,t,o){let u=e instanceof x,n=t instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(o))throw new Error("n, incx, and incy must be integers.");if(i<=0||o<=0)throw new Error("incx and incy must be positive.");if(!u&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(u!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return{dot:0};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(r-1)*o+1)throw new Error("y does not have enough elements for the given n and incy.");let s=await G(a,"sdot"),l=await G(a,"reduction/sum"),c=null,d=null,f=null,p=null,g=null,w=null;try{c=u?e._buf:b(e,"sdot-x",!1),d=n?t._buf:b(t,"sdot-y",!1),f=H(2*Le*4,"sdot-partials"),p=O(4,"sdot-result"),g=I([{value:r,type:"u32"},{value:i,type:"u32"},{value:o,type:"u32"}],"sdot-params");let _=B(s.getBindGroupLayout(0),[c,d,f,g]),{commandEncoder:h,ts:k}=S(s,_,2*Le);P(h);let v=B(l.getBindGroupLayout(0),[f,p]),{commandEncoder:F,ts:N}=S(l,v,1);w=E(F,p),P(F);let W=y(w,Float32Array);w=null;let[L,U,T]=await Promise.all([A(k),A(N),W]);return L!==void 0&&U!==void 0?{dot:T[0],gpuTimeMs:L+U}:{dot:T[0]}}finally{!u&&c&&m(c),!n&&d&&m(d),f&&m(f),p&&m(p),g&&m(g),w&&m(w)}}var Ne=64;async function We(a,r,e,i){let t=e instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i))throw new Error("n and incx must be integers.");if(i<=0)throw new Error("incx must be positive.");if(!t&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{asum:0};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");let o=await G(a,"sasum"),u=await G(a,"reduction/sum"),n=null,s=null,l=null,c=null,d=null;try{n=t?e._buf:b(e,"sasum-x",!1),s=H(2*Ne*4,"sasum-partials"),l=O(4,"sasum-result"),c=I([{value:r,type:"u32"},{value:i,type:"u32"}],"sasum-params");let f=B(o.getBindGroupLayout(0),[n,s,c]),{commandEncoder:p,ts:g}=S(o,f,2*Ne);P(p);let w=B(u.getBindGroupLayout(0),[s,l]),{commandEncoder:_,ts:h}=S(u,w,1);d=E(_,l),P(_);let k=y(d,Float32Array);d=null;let[v,F,N]=await Promise.all([A(g),A(h),k]);return v!==void 0&&F!==void 0?{asum:N[0],gpuTimeMs:v+F}:{asum:N[0]}}finally{!t&&n&&m(n),s&&m(s),l&&m(l),c&&m(c),d&&m(d)}}var mr=64;async function je(a,r,e,i){let t=e instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i))throw new Error("n and incx must be integers.");if(i<=0)throw new Error("incx must be positive.");if(!t&&!(e instanceof Float64Array))throw new Error("x must be a Float64Array or GpuVector.");if(t&&e.dtype!==Float64Array)throw new Error("x must be a Float64Array-backed GpuVector.");if(r<=0)return{asum:0};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");let o=await G(a,["f64add","dasum"]),u=await G(a,["f64add","reduction/sumF64"]),n=null,s=null,l=null,c=null,d=null,f=null,p=null,g=null;try{n=t?e:x.from(e),s=H(2*mr*4,"dasum-partialsMain"),l=H(2*mr*4,"dasum-partialsAux"),c=O(4,"dasum-result-main"),d=O(4,"dasum-result-aux"),f=I([{value:r,type:"u32"},{value:i,type:"u32"}],"dasum-params");let w=B(o.getBindGroupLayout(0),[n._buf,n._auxBuf,s,l,f]),{commandEncoder:_,ts:h}=S(o,w,2*mr);P(_);let k=B(u.getBindGroupLayout(0),[s,l,c,d]),{commandEncoder:v,ts:F}=S(u,k,1);p=E(v,c),g=E(v,d),P(v);let N=y(p,Float32Array),W=y(g,Uint32Array);p=null,g=null;let[L,U,T,R]=await Promise.all([A(h),A(F),N,W]),V=rr(T[0],R[0]);return L!==void 0&&U!==void 0?{asum:V,gpuTimeMs:L+U}:{asum:V}}finally{!t&&n&&n.destroy(),s&&m(s),l&&m(l),c&&m(c),d&&m(d),f&&m(f),p&&m(p),g&&m(g)}}var Me=64;async function Ue(a,r,e,i){let t=e instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i))throw new Error("n and incx must be integers.");if(i<=0)throw new Error("incx must be positive.");if(!t&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{nrm2:0};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");let o=await G(a,"snrm2"),u=await G(a,"reduction/sum"),n=null,s=null,l=null,c=null,d=null;try{n=t?e._buf:b(e,"snrm2-x",!1),s=H(2*Me*4,"snrm2-partials"),l=O(4,"snrm2-result"),c=I([{value:r,type:"u32"},{value:i,type:"u32"}],"snrm2-params");let f=B(o.getBindGroupLayout(0),[n,s,c]),{commandEncoder:p,ts:g}=S(o,f,2*Me);P(p);let w=B(u.getBindGroupLayout(0),[s,l]),{commandEncoder:_,ts:h}=S(u,w,1);d=E(_,l),P(_);let k=y(d,Float32Array);d=null;let[v,F,N]=await Promise.all([A(g),A(h),k]),W=Math.sqrt(N[0]);return v!==void 0&&F!==void 0?{nrm2:W,gpuTimeMs:v+F}:{nrm2:W}}finally{!t&&n&&m(n),s&&m(s),l&&m(l),c&&m(c),d&&m(d)}}var pr=64;async function Te(a,r,e,i){let t=e instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i))throw new Error("n and incx must be integers.");if(i<=0)throw new Error("incx must be positive.");if(!t&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{index:0};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");let o=await G(a,"isamax"),u=await G(a,"reduction/argmax"),n=null,s=null,l=null,c=null,d=null,f=null;try{n=t?e._buf:b(e,"isamax-x",!1),s=H(2*pr*4,"isamax-partials-val"),l=H(2*pr*4,"isamax-partials-idx"),c=O(4,"isamax-result"),d=I([{value:r,type:"u32"},{value:i,type:"u32"}],"isamax-params");let p=B(o.getBindGroupLayout(0),[n,s,l,d]),{commandEncoder:g,ts:w}=S(o,p,2*pr);P(g);let _=B(u.getBindGroupLayout(0),[s,l,c]),{commandEncoder:h,ts:k}=S(u,_,1);f=E(h,c),P(h);let v=y(f,Uint32Array);f=null;let[F,N,W]=await Promise.all([A(w),A(k),v]),L=W[0];return F!==void 0&&N!==void 0?{index:L,gpuTimeMs:F+N}:{index:L}}finally{!t&&n&&m(n),s&&m(s),l&&m(l),c&&m(c),d&&m(d),f&&m(f)}}async function Re(a,r,e,i,t,o,u,n){let s=e instanceof x,l=t instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(o))throw new Error("n, incx, and incy must be integers.");if(typeof u!="number")throw new Error("c must be a number.");if(typeof n!="number")throw new Error("s must be a number.");if(Number.isNaN(u)||Number.isNaN(n))throw new Error("c and s must not be NaN.");if(!Number.isFinite(u))throw new Error("c must be finite.");if(!Number.isFinite(n))throw new Error("s must be finite.");if(i<=0||o<=0)throw new Error("incx and incy must be positive.");if(!s&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!l&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(s!==l)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return s?{}:{x:e,y:t};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(r-1)*o+1)throw new Error("y does not have enough elements for the given n and incy.");let c=await G(a,"srot"),d=null,f=null,p=null,g=null,w=null;try{d=s?e._buf:b(e,"srot-x",!0),f=l?t._buf:b(t,"srot-y",!0),p=I([{value:r,type:"u32"},{value:u,type:"f32"},{value:n,type:"f32"},{value:i,type:"u32"},{value:o,type:"u32"}],"srot-params");let _=B(c.getBindGroupLayout(0),[d,f,p]),{commandEncoder:h,ts:k}=S(c,_,C(r));g=s?null:E(h,d),w=l?null:E(h,f),P(h);let v=await A(k);if(s&&l)return v!==void 0?{gpuTimeMs:v}:{};let F=y(g,Float32Array),N=y(w,Float32Array);g=null,w=null;let[W,L]=await Promise.all([F,N]);return v!==void 0?{x:W,y:L,gpuTimeMs:v}:{x:W,y:L}}finally{!s&&d&&m(d),!l&&f&&m(f),p&&m(p),g&&m(g),w&&m(w)}}async function Ve(a,r,e,i,t,o,u){let n=e instanceof x,s=t instanceof x;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(o))throw new Error("n, incx, and incy must be integers.");if(!(u instanceof Float32Array)||u.length!==5)throw new Error("param must be a Float32Array of length 5.");if(i<=0||o<=0)throw new Error("incx and incy must be positive.");if(!n&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!s&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(n!==s)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0||u[0]===-2)return n?{}:{x:e,y:t};if(e.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(r-1)*o+1)throw new Error("y does not have enough elements for the given n and incy.");let l=await G(a,"srotm"),c=null,d=null,f=null,p=null,g=null,w=null;try{c=n?e._buf:b(e,"srotm-x",!0),d=s?t._buf:b(t,"srotm-y",!0),f=b(u,"srotm-param",!1),p=I([{value:r,type:"u32"},{value:i,type:"u32"},{value:o,type:"u32"}],"srotm-params");let _=B(l.getBindGroupLayout(0),[c,d,f,p]),{commandEncoder:h,ts:k}=S(l,_,C(r));g=n?null:E(h,c),w=s?null:E(h,d),P(h);let v=await A(k);if(n&&s)return v!==void 0?{gpuTimeMs:v}:{};let F=y(g,Float32Array),N=y(w,Float32Array);g=null,w=null;let[W,L]=await Promise.all([F,N]);return v!==void 0?{x:W,y:L,gpuTimeMs:v}:{x:W,y:L}}finally{!n&&c&&m(c),!s&&d&&m(d),f&&m(f),p&&m(p),g&&m(g),w&&m(w)}}async function He(a,r,e,i,t,o,u,n,s,l,c,d){let f=n instanceof x,p=c instanceof x,g=o instanceof D,w=r==="no-transpose";if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!w&&r!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!Number.isInteger(e)||!Number.isInteger(i)||!Number.isInteger(s)||!Number.isInteger(d)||!Number.isInteger(u))throw new Error("m, n, incx, incy, and lda must be integers.");if(typeof t!="number")throw new Error("alpha must be a number.");if(Number.isNaN(t))throw new Error("alpha must not be NaN.");if(!Number.isFinite(t))throw new Error("alpha must be finite.");if(typeof l!="number")throw new Error("beta must be a number.");if(Number.isNaN(l))throw new Error("beta must not be NaN.");if(!Number.isFinite(l))throw new Error("beta must be finite.");if(s<=0||d<=0)throw new Error("incx and incy must be positive.");if(u<i)throw new Error("lda must be >= n.");if(!g&&!(o instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!f&&!(n instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!p&&!(c instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(f!==p)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(f&&!g)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(f&&n._buf===c._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(g&&u!==o.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(g&&(o.rows<e||o.cols<i))throw new Error("A is too small for the given m and n.");if(e<0||i<0)throw new Error("m and n must be non-negative.");if(e===0||i===0)return p?{}:{y:c};let _=w?i:e,h=w?e:i;if(!g&&o.length<(e-1)*u+i)throw new Error("A does not have enough elements for the given m, n, and lda.");if(n.length<(_-1)*s+1)throw new Error("x does not have enough elements for the given dimensions and incx.");if(c.length<(h-1)*d+1)throw new Error("y does not have enough elements for the given dimensions and incy.");let v=await G(a,w?"sgemv_n":"sgemv_t"),F=g?o._buf:b(o,"sgemv-A",!1),N=f?n._buf:b(n,"sgemv-x",!1),W=p?c._buf:b(c,"sgemv-y",!0),L=I([{value:e,type:"u32"},{value:i,type:"u32"},{value:t,type:"f32"},{value:l,type:"f32"},{value:s,type:"u32"},{value:d,type:"u32"},{value:u,type:"u32"}],"sgemv-params");try{let U=B(v.getBindGroupLayout(0),[F,N,W,L]),T=w?Math.min(e,a.limits.maxComputeWorkgroupsPerDimension):C(h),{commandEncoder:R,ts:V}=S(v,U,T),z=p?null:E(R,W);P(R);let Y=await A(V);if(p)return Y!==void 0?{gpuTimeMs:Y}:{};let Z=await y(z,Float32Array);return Y!==void 0?{y:Z,gpuTimeMs:Y}:{y:Z}}finally{g||m(F),f||m(N),p||m(W),m(L)}}async function De(a,r,e,i,t,o,u,n,s,l,c){let d=u instanceof x,f=l instanceof x,p=t instanceof D,g=r==="lower";if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!g&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(!Number.isInteger(e)||!Number.isInteger(n)||!Number.isInteger(c)||!Number.isInteger(o))throw new Error("n, incx, incy, and lda must be integers.");if(typeof i!="number")throw new Error("alpha must be a number.");if(Number.isNaN(i))throw new Error("alpha must not be NaN.");if(!Number.isFinite(i))throw new Error("alpha must be finite.");if(typeof s!="number")throw new Error("beta must be a number.");if(Number.isNaN(s))throw new Error("beta must not be NaN.");if(!Number.isFinite(s))throw new Error("beta must be finite.");if(n<=0||c<=0)throw new Error("incx and incy must be positive.");if(o<e)throw new Error("lda must be >= n.");if(!p&&!(t instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!d&&!(u instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!f&&!(l instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(d!==f)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(d&&!p)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(d&&u._buf===l._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(p&&o!==t.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(p&&(t.rows<e||t.cols<e))throw new Error("A is too small for the given n.");if(e<0)throw new Error("n must be non-negative.");if(e===0)return f?{}:{y:l};if(!p&&t.length<(e-1)*o+e)throw new Error("A does not have enough elements for the given n and lda.");if(u.length<(e-1)*n+1)throw new Error("x does not have enough elements for the given n and incx.");if(l.length<(e-1)*c+1)throw new Error("y does not have enough elements for the given n and incy.");let w=await G(a,"ssymv"),_=null,h=null,k=null,v=null;try{_=p?t._buf:b(t,"ssymv-A",!1),h=d?u._buf:b(u,"ssymv-x",!1),k=f?l._buf:b(l,"ssymv-y",!0),v=I([{value:e,type:"u32"},{value:i,type:"f32"},{value:s,type:"f32"},{value:n,type:"u32"},{value:c,type:"u32"},{value:o,type:"u32"},{value:g?0:1,type:"u32"}],"ssymv-params");let F=B(w.getBindGroupLayout(0),[_,h,k,v]),N=Math.min(e,a.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:W,ts:L}=S(w,F,N),U=f?null:E(W,k);P(W);let T=await A(L);if(f)return T!==void 0?{gpuTimeMs:T}:{};let R=await y(U,Float32Array);return T!==void 0?{y:R,gpuTimeMs:T}:{y:R}}finally{!p&&_&&m(_),!d&&h&&m(h),!f&&k&&m(k),v&&m(v)}}async function Ce(a,r,e,i,t,o,u,n,s,l,c){let d=n instanceof x,f=l instanceof x,p=o instanceof D,g=r==="lower",w=e==="no-transpose",_=i==="unit";if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!g&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(!w&&e!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!_&&i!=="non-unit")throw new Error("diag must be 'unit' or 'non-unit'.");if(!Number.isInteger(t)||!Number.isInteger(s)||!Number.isInteger(c)||!Number.isInteger(u))throw new Error("n, incx, incy, and lda must be integers.");if(s<=0||c<=0)throw new Error("incx and incy must be positive.");if(u<t)throw new Error("lda must be >= n.");if(!p&&!(o instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!d&&!(n instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!f&&!(l instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(d!==f)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(d&&n._buf===l._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(d&&!p)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(p&&f&&o._buf===l._buf)throw new Error("A and y must not reference the same GPU buffer.");if(p&&u!==o.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(p&&(o.rows<t||o.cols<t))throw new Error("A is too small for the given n.");if(t<0)throw new Error("n must be non-negative.");if(t===0)return f?{}:{y:l};if(!p&&o.length<(t-1)*u+t)throw new Error("A does not have enough elements for the given n and lda.");if(n.length<(t-1)*s+1)throw new Error("x does not have enough elements for the given n and incx.");if(l.length<(t-1)*c+1)throw new Error("y does not have enough elements for the given n and incy.");let h=await G(a,"strmv"),k=null,v=null,F=null,N=null;try{k=p?o._buf:b(o,"strmv-A",!1),v=d?n._buf:b(n,"strmv-x",!1),F=f?l._buf:b(l,"strmv-y",!0),N=I([{value:t,type:"u32"},{value:s,type:"u32"},{value:c,type:"u32"},{value:u,type:"u32"},{value:w?0:1,type:"u32"},{value:g?0:1,type:"u32"},{value:_?1:0,type:"u32"}],"strmv-params");let W=B(h.getBindGroupLayout(0),[k,v,F,N]),L=Math.min(t,a.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:U,ts:T}=S(h,W,L),R=f?null:E(U,F);P(U);let V=await A(T);if(f)return V!==void 0?{gpuTimeMs:V}:{};let z=await y(R,Float32Array);return V!==void 0?{y:z,gpuTimeMs:V}:{y:z}}finally{!p&&k&&m(k),!d&&v&&m(v),!f&&F&&m(F),N&&m(N)}}var q=64;function Oe(a,r,e){let i=new ArrayBuffer(a*r),t=new DataView(i);for(let o=0;o<a;o++){let u=e(o),n=o*r;u.forEach((s,l)=>t.setUint32(n+l*4,s,!0))}return i}function ze(a,r,e){let i=a.createBuffer({label:e,size:r.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return a.queue.writeBuffer(i,0,r),i}async function Qe(a,r,e,i,t,o,u,n,s){let l=n instanceof x,c=o instanceof D,d=r==="lower",f=e==="no-transpose",p=i==="unit";if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!d&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(!f&&e!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!p&&i!=="non-unit")throw new Error("diag must be 'unit' or 'non-unit'.");if(!Number.isInteger(t)||!Number.isInteger(s)||!Number.isInteger(u))throw new Error("n, incx, and lda must be integers.");if(s<=0)throw new Error("incx must be positive.");if(u<t)throw new Error("lda must be >= n.");if(!c&&!(o instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!l&&!(n instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(l&&!c)throw new Error("A must be a GpuMatrix when x is a GpuVector.");if(c&&u!==o.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(c&&(o.rows<t||o.cols<t))throw new Error("A is too small for the given n.");if(t<0)throw new Error("n must be non-negative.");if(t===0)return l?{}:{x:n};if(!c&&o.length<(t-1)*u+t)throw new Error("A does not have enough elements for the given n and lda.");if(n.length<(t-1)*s+1)throw new Error("x does not have enough elements for the given n and incx.");let g=await G(a,"strsv_invert_block"),w=await G(a,"strsv_apply_inverse"),_=await G(a,"strsv_update"),h=f===d,k=[];for(let z=0;z<t;z+=q)k.push(z);h||k.reverse();let v=k.length,F=a.limits.maxComputeWorkgroupsPerDimension,N=a.limits.minUniformBufferOffsetAlignment,W=null,L=null,U=null,T=null,R=null,V=null;try{W=c?o._buf:b(o,"strsv-A",!1),L=l?n._buf:b(n,"strsv-x",!0),U=H(v*q*q*4,"strsv-Ainv");let z=Oe(v,N,K=>{let X=K*q,tr=Math.min(X+q,t);return[s,K,X,tr]});T=ze(a,z,"strsv-apply-params");let Y=Oe(v,N,K=>{let X=K*q,tr=Math.min(X+q,t);return[t,s,u,f?0:1,d?0:1,X,tr]});R=ze(a,Y,"strsv-update-params");let{commandEncoder:Z,querySet:er}=cr();V=I([{value:t,type:"u32"},{value:u,type:"u32"},{value:f?0:1,type:"u32"},{value:d?0:1,type:"u32"},{value:p?1:0,type:"u32"}],"strsv-invert-params");let Ze=B(g.getBindGroupLayout(0),[W,U,V]);ar(Z,g,Ze,{x:q,y:v},er?{timestampWrites:{querySet:er,beginningOfPassWriteIndex:0}}:void 0);for(let K=0;K<k.length;K++){let X=k[K],tr=Math.min(X+q,t),$e=X/q,Ye=K===k.length-1,wr=$e*N,Je=B(w.getBindGroupLayout(0),[U,L,{buffer:T,offset:wr,size:16}]);ar(Z,w,Je,1,Ye&&er?{timestampWrites:{querySet:er,endOfPassWriteIndex:1}}:void 0);let br=h?t-tr:X;if(br===0)continue;let rt=B(_.getBindGroupLayout(0),[W,L,{buffer:R,offset:wr,size:32}]),et=Math.min(br,F);ar(Z,_,rt,et)}let Ke=ur(Z,er),Xe=l?null:E(Z,L);P(Z);let ir=await A(Ke);if(l)return ir!==void 0?{gpuTimeMs:ir}:{};let gr=await y(Xe,Float32Array);return ir!==void 0?{x:gr,gpuTimeMs:ir}:{x:gr}}finally{!c&&W&&m(W),!l&&L&&m(L),U&&m(U),T&&m(T),R&&m(R),V&&m(V)}}async function qe(a,r,e,i,t,o,u,n,s,l){let c=t instanceof x,d=u instanceof x,f=s instanceof D;if(!(a instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(e)||!Number.isInteger(o)||!Number.isInteger(n)||!Number.isInteger(l))throw new Error("m, n, incx, incy, and lda must be integers.");if(typeof i!="number")throw new Error("alpha must be a number.");if(Number.isNaN(i))throw new Error("alpha must not be NaN.");if(!Number.isFinite(i))throw new Error("alpha must be finite.");if(o<=0||n<=0)throw new Error("incx and incy must be positive.");if(l<e)throw new Error("lda must be >= n.");if(!f&&!(s instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!c&&!(t instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!d&&!(u instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(c!==d)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(c&&!f)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(f&&c&&s._buf===t._buf)throw new Error("A and x must not reference the same GPU buffer.");if(f&&d&&s._buf===u._buf)throw new Error("A and y must not reference the same GPU buffer.");if(f&&l!==s.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(f&&(s.rows<r||s.cols<e))throw new Error("A is too small for the given m and n.");if(r<0||e<0)throw new Error("m and n must be non-negative.");if(r===0||e===0)return f?{}:{A:s};if(!f&&s.length<(r-1)*l+e)throw new Error("A does not have enough elements for the given m, n, and lda.");if(t.length<(r-1)*o+1)throw new Error("x does not have enough elements for the given m and incx.");if(u.length<(e-1)*n+1)throw new Error("y does not have enough elements for the given n and incy.");let p=await G(a,"sger"),g=null,w=null,_=null,h=null;try{g=c?t._buf:b(t,"sger-x",!1),w=d?u._buf:b(u,"sger-y",!1),_=f?s._buf:b(s,"sger-A",!0),h=I([{value:r,type:"u32"},{value:e,type:"u32"},{value:i,type:"f32"},{value:o,type:"u32"},{value:n,type:"u32"},{value:l,type:"u32"}],"sger-params");let k=B(p.getBindGroupLayout(0),[g,w,_,h]),v=Math.min(r,a.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:F,ts:N}=S(p,k,v),W=f?null:E(F,_);P(F);let L=await A(N);if(f)return L!==void 0?{gpuTimeMs:L}:{};let U=await y(W,Float32Array);return L!==void 0?{A:U,gpuTimeMs:L}:{A:U}}finally{!c&&g&&m(g),!d&&w&&m(w),!f&&_&&m(_),h&&m(h)}}return st(Ct);})();
