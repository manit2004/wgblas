var wgblas=(()=>{var Pt=Object.create;var mr=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var Dt=Object.getPrototypeOf,jt=Object.prototype.hasOwnProperty;var pr=(o=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(o,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):o)(function(o){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+o+'" is not supported')});var N=(o,e,r)=>()=>{if(r)throw r[0];try{return o&&(e=o(o=0)),e}catch(a){throw r=[a],a}};var Ar=(o,e)=>{for(var r in e)mr(o,r,{get:e[r],enumerable:!0})},Br=(o,e,r,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let t of It(e))!jt.call(o,t)&&t!==r&&mr(o,t,{get:()=>e[t],enumerable:!(a=Lt(e,t))||a.enumerable});return o};var gr=(o,e,r)=>(r=o!=null?Pt(Dt(o)):{},Br(e||!o||!o.__esModule?mr(r,"default",{value:o,enumerable:!0}):r,o)),Ft=o=>Br(mr({},"__esModule",{value:!0}),o);var Mr,Tr=N(()=>{Mr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var Ur,Rr=N(()=>{Ur=`// amax reduction (f64, double-double): collapses 2*WGS (value, index) pairs
...
`});var Hr,Vr=N(()=>{Hr=`// sum reduction: collapses 2*WGS partials into one scalar.
// dispatch: 1 workgroup of WGS threads.
...
`});var $r,Zr=N(()=>{$r=`// saxpy: y = alpha * x + y
...
`});var De,Ie=N(()=>{De=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var Me,Te=N(()=>{Me=`// dasum: sum(|x[i]|), double-double (Dekker). Same ILP=4 shape as sasum.wgsl;
...
`});var Ue,Re=N(()=>{Ue=`// idamax: returns index of element with largest absolute value (f64, double-double)
...
`});var He,Ve=N(()=>{He=`// strsv_invert_block: computes ONE column (workgroup_id.x) of ONE block's
...
`});var Ke,Qe=N(()=>{Ke=`// sgemm_naive: C = alpha * op(A) * op(B) + beta * C
...
fn main(
  ...
  for (var t = 0u; t < numTiles; t++) {
    ...
    // Cooperative load: each thread caches one entry of op(A)'s and op(B)'s
    // TILE x TILE sub-tile. threadCol stays the coalescing-fast index for
    // both loads, same reasoning as kernel 2. Out-of-range loads (m/n/k not
    // multiples of TILE) are zero-padded rather than skipped, since every
    // thread in the workgroup depends on the full tile being populated.
    let aK = kBase + threadCol;
    let aIdx = select(row * params.lda + aK, aK * params.lda + row, params.transA != 0u);
    As[threadRow * TILE + threadCol] = select(0.0, A[aIdx], row < params.m && aK < params.k);

    let bK = kBase + threadRow;
    let bIdx = select(bK * params.ldb + col, col * params.ldb + bK, params.transB != 0u);
    Bs[threadRow * TILE + threadCol] = select(0.0, B[bIdx], bK < params.k && col < params.n);
...
`});var Ze={};Ar(Ze,{shaderSources:()=>ga});var ga,$e=N(()=>{Tr();Rr();Vr();Cr();zr();Qr();Zr();Xr();Jr();ee();ae();ie();se();le();ce();me();ge();be();xe();ye();Ee();Ae();ke();Pe();Ie();je();Ne();Te();Re();Ve();Ce();ze();Qe();ga={"reduction/argmax":Mr,"reduction/argmaxF64":Ur,"reduction/sum":Hr,"reduction/sumF64":Or,sscal:qr,sswap:Kr,saxpy:$r,scopy:Yr,sdot:re,sasum:te,snrm2:oe,srot:ne,srotm:ue,isamax:fe,sgemv_n:de,sgemv_t:pe,ssymv:we,strmv:he,sger:ve,ssyr:_e,ssyr2:Ge,f64add:Be,"f64/dekker":Se,"f64/utils/abs":Le,"f64/utils/add":De,"f64/utils/greater":Fe,"f64/utils/equal":We,dasum:Me,idamax:Ue,strsv_invert_block:He,strsv_apply_inverse:Oe,strsv_update:qe,sgemm:Ke}});var va={};Ar(va,{GpuMatrix:()=>V,GpuVector:()=>y,cleanup:()=>Dr,dasum:()=>nt,gpuName:()=>jr,idamax:()=>ft,init:()=>Ir,isamax:()=>lt,randomFloat32Array:()=>Fr,randomFloat64Array:()=>Nr,randomTriangularFloat32Array:()=>Wr,sasum:()=>it,saxpy:()=>rt,scopy:()=>et,sdot:()=>at,sgemm:()=>Et,sgemv:()=>mt,sger:()=>xt,snrm2:()=>ut,srot:()=>ct,srotm:()=>dt,sscal:()=>Ye,sswap:()=>Je,ssymv:()=>pt,ssyr:()=>vt,ssyr2:()=>yt,strmv:()=>gt,strsv:()=>ht});function kr(o,e){return e?o.features.has("timestamp-query")?{requiredFeatures:["timestamp-query"]}:(console.warn("timestamp-query not supported on this device \u2014 benchmark mode disabled."),{}):{}}function Sr(){if(!Pr())return{querySet:null,passDescriptor:void 0};let e=U().createQuerySet({type:"timestamp",count:2});return{querySet:e,passDescriptor:{timestampWrites:{querySet:e,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}}}function wr(o,e){if(!e)return null;let r=U(),a=r.createBuffer({label:"timestamp-resolve",size:16,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC});o.resolveQuerySet(e,0,2,a,0);let t=r.createBuffer({label:"timestamp-readback",size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return o.copyBufferToBuffer(a,0,t,0,16),{tsReadBuffer:t,resolveBuffer:a,querySet:e}}async function P(o){if(!o)return;let{tsReadBuffer:e,resolveBuffer:r,querySet:a}=o;await e.mapAsync(GPUMapMode.READ);let t=new BigInt64Array(e.getMappedRange().slice());return e.unmap(),e.destroy(),r.destroy(),a.destroy(),Math.max(0,Number(t[1]-t[0]))/1e6}var X=null,or=null,Lr=null,hr=!1;async function Ir({powerPreference:o="high-performance",benchmark:e=!1}={}){if(X)return X;let r;if(typeof window>"u"){let{create:i,globals:u}=await import("webgpu");Object.assign(globalThis,u),r=i([]),Lr=r}else r=navigator.gpu;if(!r)throw new Error("WebGPU not supported in this environment.");if(or=await r.requestAdapter({powerPreference:o})??await r.requestAdapter(),!or)throw new Error("No WebGPU adapter found.");hr=e;let t=[...kr(or,e).requiredFeatures??[]];return X=await or.requestDevice({requiredFeatures:t}),X.addEventListener("uncapturederror",i=>{console.error("Uncaptured GPU error:",i.error.message)}),X}function Dr(){X&&(X.destroy(),X=null),or=null,Lr=null,hr=!1}function jr(){if(!or)throw new Error("WebGPU adapter not initialized \u2014 call init() first.");let{device:o,description:e}=or.info;return{description:e||"unknown",device:o||"unknown"}}function Pr(){return hr}function U(){if(!X)throw new Error("WebGPU device not initialized \u2014 call init() first.");return X}function d(...o){o.flat().forEach(e=>e.destroy())}function b(o,e="blas-input",r=!1){let a=U(),t=a.limits.maxStorageBufferBindingSize,i=o.byteLength;if(i>t)throw new Error(`Buffer size ${i} bytes exceeds device limit of ${t} bytes.`);let u=r?GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC:GPUBufferUsage.STORAGE,l=a.createBuffer({label:e,size:i,usage:u,mappedAtCreation:!0}),n=o.constructor;return new n(l.getMappedRange()).set(o),l.unmap(),l}function O(o,e="blas-storage"){return U().createBuffer({label:e,size:o,usage:GPUBufferUsage.STORAGE})}function Z(o,e="blas-result"){return U().createBuffer({label:e,size:o,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC})}function G(o,e){let a=U().createBuffer({label:"blas-readback",size:e.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return o.copyBufferToBuffer(e,0,a,0,e.size),a}function j(o,e="blas-params"){let r=U(),a=o.length*4,t=Math.ceil(a/16)*16,i=new ArrayBuffer(t),u=new DataView(i);o.forEach(({value:n,type:s},f)=>{let c=f*4;if(s==="u32")u.setUint32(c,n,!0);else if(s==="i32")u.setInt32(c,n,!0);else if(s==="f32")u.setFloat32(c,n,!0);else throw new Error(`Unknown param type "${s}". Use "f32", "u32", or "i32".`)});let l=r.createBuffer({label:e,size:t,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return r.queue.writeBuffer(l,0,i),l}async function _(o,e=Float32Array){try{await o.mapAsync(GPUMapMode.READ);let r=new e(o.getMappedRange().slice());return o.unmap(),r}finally{o.destroy()}}function er(o){let e=o.length,r=new Float32Array(e),a=new Float32Array(e);for(let t=0;t<e;t++){let i=Math.fround(o[t]);r[t]=i,a[t]=Math.fround(o[t]-i)}return{hi:r,lo:a}}function sr(o,e){let r=o.length,a=new Float64Array(r);for(let t=0;t<r;t++)a[t]=o[t]+e[t];return a}var y=class o{constructor(e,r,a=Float32Array,t=null){this._buf=e,this._loBuf=t,this.length=r,this.dtype=a}static from(e){if(e instanceof Float64Array){let{hi:a,lo:t}=er(e),i=b(a,"gpu-vector-f64-hi",!0),u=b(t,"gpu-vector-f64-lo",!0);return new o(i,e.length,Float64Array,u)}if(!(e instanceof Float32Array))throw new Error("GpuVector.from expects a Float32Array or Float64Array.");let r=b(e,"gpu-vector",!0);return new o(r,e.length,e.constructor)}async read(){let e=U(),r=e.createCommandEncoder(),a=G(r,this._buf);if(e.queue.submit([r.finish()]),!this._loBuf)return _(a,this.dtype);let t=e.createCommandEncoder(),i=G(t,this._loBuf);e.queue.submit([t.finish()]);let[u,l]=await Promise.all([_(a,Float32Array),_(i,Float32Array)]);return sr(u,l)}destroy(){this._buf.destroy(),this._loBuf&&this._loBuf.destroy()}};var V=class o{constructor(e,r,a,t,i=null,u="row-major"){this._buf=e,this._loBuf=i,this.rows=r,this.cols=a,this.lda=t,this.layout=u}static from(e,r,a,t,i="row-major"){if(i!=="row-major"&&i!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");let u=i==="row-major";if(t===void 0&&(t=u?a:r),!(e instanceof Float32Array)&&!(e instanceof Float64Array))throw new Error("GpuMatrix.from expects a Float32Array or Float64Array.");if(!Number.isInteger(r)||r<=0)throw new Error("rows must be a positive integer.");if(!Number.isInteger(a)||a<=0)throw new Error("cols must be a positive integer.");let l=u?a:r;if(!Number.isInteger(t)||t<l)throw new Error(`lda must be an integer >= ${u?"cols":"rows"}.`);let n=u?r:a;if(e.length<n*t)throw new Error("data does not have enough elements for the given rows, cols, and lda.");if(e instanceof Float64Array){let f=n*t,{hi:c,lo:p}=er(e.subarray(0,f)),m=b(c,"gpu-matrix-f64-hi",!0),g=b(p,"gpu-matrix-f64-lo",!0);return new o(m,r,a,t,g,i)}let s=b(e.subarray(0,n*t),"gpu-matrix",!0);return new o(s,r,a,t,null,i)}async read(){let e=U(),r=e.createCommandEncoder(),a=G(r,this._buf);e.queue.submit([r.finish()]);let t=this.layout!=="column-major",i=t?this.rows:this.cols,u=t?this.cols:this.rows;if(this._loBuf){let s=e.createCommandEncoder(),f=G(s,this._loBuf);e.queue.submit([s.finish()]);let[c,p]=await Promise.all([_(a,Float32Array),_(f,Float32Array)]),m=sr(c,p);if(this.lda===u)return m;let g=new Float64Array(i*u);for(let w=0;w<i;w++)g.set(m.subarray(w*this.lda,w*this.lda+u),w*u);return g}let l=await _(a,Float32Array);if(this.lda===u)return l;let n=new Float32Array(i*u);for(let s=0;s<i;s++)n.set(l.subarray(s*this.lda,s*this.lda+u),s*u);return n}destroy(){this._buf.destroy(),this._loBuf&&this._loBuf.destroy()}};function Fr(o,e=-1,r=1){let a=new Float32Array(o);for(let t=0;t<o;t++)a[t]=e+Math.random()*(r-e);return a}function Nr(o,e=-1,r=1){let a=new Float64Array(o);for(let t=0;t<o;t++)a[t]=e+Math.random()*(r-e);return a}function Wr(o,e,r="lower",a=-1,t=1,i=5,u=15){if(r!=="lower"&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(e<o)throw new Error("lda must be >= n.");let l=new Float32Array(o*e);for(let n=0;n<o;n++){for(let s=0;s<o;s++){if(n===s)continue;(r==="lower"?s<n:s>n)&&(l[n*e+s]=a+Math.random()*(t-a))}l[n*e+n]=i+Math.random()*(u-i)}return l}function B(o,e,r=0){let a=U(),t=e.map((i,u)=>({binding:r+u,resource:i instanceof GPUBuffer?{buffer:i}:i}));return a.createBindGroup({layout:o,entries:t})}var Nt=new WeakMap;function L(o){U().queue.submit([o.finish()])}function xr(){let o=U(),{querySet:e,passDescriptor:r}=Sr();return{commandEncoder:o.createCommandEncoder(),querySet:e,passDescriptor:r}}function lr(o,e,r,a,t){let i=o.beginComputePass(t);i.setPipeline(e),i.setBindGroup(0,r),typeof a=="number"?i.dispatchWorkgroups(a):i.dispatchWorkgroups(a.x,a.y,a.z??1),i.end(),Nt.set(o,i)}function D(o,e,r){let{commandEncoder:a,querySet:t,passDescriptor:i}=xr();lr(a,o,e,r,i);let u=wr(a,t);return{commandEncoder:a,ts:u}}var ha={},vr=new WeakMap;async function k(o,e,r="main"){vr.has(o)||vr.set(o,new Map);let a=vr.get(o),t=Array.isArray(e)?e:[e],i=`${t.join("+")}::${r}`;return a.has(i)||a.set(i,await ba(t,r)),a.get(i)}async function wa(o){if(typeof process>"u"||!process.versions?.node){let{shaderSources:e}=await Promise.resolve().then(()=>($e(),Ze)),r=e[o];if(!r)throw new Error(`Shader "${o}" not found in browser bundle.`);return r}else{let{readFileSync:e}=await import("fs"),{fileURLToPath:r}=await import("url"),{dirname:a,join:t}=await import("path"),i=a(r(ha.url));return e(t(i,`../shaders/${o}.wgsl`),"utf8")}}async function ba(o,e="main"){let r=U(),a=o.join("+"),t=(await Promise.all(o.map(wa))).join(`
