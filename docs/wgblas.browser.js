var wgblas=(()=>{var St=Object.create;var mr=Object.defineProperty;var Pt=Object.getOwnPropertyDescriptor;var Dt=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var pr=(o=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(o,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):o)(function(o){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+o+'" is not supported')});var F=(o,e,r)=>()=>{if(r)throw r[0];try{return o&&(e=o(o=0)),e}catch(a){throw r=[a],a}};var Br=(o,e)=>{for(var r in e)mr(o,r,{get:e[r],enumerable:!0})},Ar=(o,e,r,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let t of Dt(e))!Lt.call(o,t)&&t!==r&&mr(o,t,{get:()=>e[t],enumerable:!(a=Pt(e,t))||a.enumerable});return o};var gr=(o,e,r)=>(r=o!=null?St(It(o)):{},Ar(e||!o||!o.__esModule?mr(r,"default",{value:o,enumerable:!0}):r,o)),Nt=o=>Ar(mr({},"__esModule",{value:!0}),o);var Tr,Mr=F(()=>{Tr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var Cr,Rr=F(()=>{Cr=`// amax reduction (f64, double-double): collapses 2*WGS (value, index) pairs
...
`});var Ur,Hr=F(()=>{Ur=`// sum reduction: collapses 2*WGS partials into one scalar.
// dispatch: 1 workgroup of WGS threads.
...
`});var Or,Vr=F(()=>{Or=`// sum reduction (f64, double-double): collapses 2*WGS partial (hi, lo) pairs
...
`});var qr,zr=F(()=>{qr=`// sscal: x = alpha * x
...
`});var Xr,Zr=F(()=>{Xr=`// saxpy: y = alpha * x + y
...
`});var re,Jr=F(()=>{re=`// sdot: result = sum(x[i] * y[i])
...
`});var te,ee=F(()=>{te=`// sasum: result = sum(|x[i]|)
...
`});var oe,ae=F(()=>{oe=`// snrm2: result = sqrt(sum(x[i] * x[i]))
...
`});var ue,se=F(()=>{ue=`// srotm: applies modified Givens rotation H to vectors x and y.
...
`});var fe,le=F(()=>{fe=`// isamax: returns index of element with largest absolute value
...
`});var ce,de=F(()=>{ce=`// sgemv_n: y = alpha * A * x + beta * y  (A is m\xD7n row-major, no-transpose)
//
...
`});var pe,me=F(()=>{pe=`// sgemv_t: y = alpha * A^T * x + beta * y  (A is m\xD7n row-major, transposed)
...
`});var we,ge=F(()=>{we=`// ssymv: y = alpha * A * x + beta * y
...
`});var ve,xe=F(()=>{ve=`// sger: A := alpha * x * y^T + A  (rank-1 update, A is m\xD7n general/dense)
...
`});var _e,ye=F(()=>{_e=`// ssyr: A := alpha * x * x^T + A  (symmetric rank-1 update)
...
`});var Ge,Ee=F(()=>{Ge=`// ssyr2: A := alpha * x * y^T + alpha * y * x^T + A  (symmetric rank-2 update)
// A is n\xD7n symmetric; only the triangle specified by uplo is referenced/updated,
// the other triangle is implied by symmetry (not touched).
...
`});var Ae,Be=F(()=>{Ae=`// f64add: adds two doubles, each packed as a [main, aux] pair (main: f32
...
`});var Se,ke=F(()=>{Se=`// Double-double arithmetic via Dekker's algorithm \u2014 an alternative to
...
`});var De,Pe=F(()=>{De=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var Le,Ie=F(()=>{Le=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var je,Ne=F(()=>{je=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var We,Fe=F(()=>{We=`// Requires f64/dekker.wgsl concatenated first for the DD struct.
...
`});var Te,Me=F(()=>{Te=`// dasum: sum(|x[i]|), double-double (Dekker). Same ILP=4 shape as sasum.wgsl;
...
`});var Ce,Re=F(()=>{Ce=`// idamax: returns index of element with largest absolute value (f64, double-double)
...
`});var Ue,He=F(()=>{Ue=`// strsv_invert_block: computes ONE column (workgroup_id.x) of ONE block's
...
`});var Oe,Ve=F(()=>{Oe=`// strsv_apply_inverse: given a precomputed block inverse (from
...
`});var qe,ze=F(()=>{qe=`// strsv_update: subtracts a solved block's contribution from every
...
`});var Qe,Ke=F(()=>{Qe=`// sgemm_naive: C = alpha * op(A) * op(B) + beta * C
...
`});var Ze={};Br(Ze,{shaderSources:()=>pa});var pa,Xe=F(()=>{Mr();Rr();Hr();Vr();zr();Kr();Zr();$r();Jr();ee();ae();ie();se();le();de();me();ge();be();xe();ye();Ee();Be();ke();Pe();Ie();Ne();Fe();Me();Re();He();Ve();ze();Ke();pa={"reduction/argmax":Tr,"reduction/argmaxF64":Cr,"reduction/sum":Ur,"reduction/sumF64":Or,sscal:qr,sswap:Qr,saxpy:Xr,scopy:Yr,sdot:re,sasum:te,snrm2:oe,srot:ne,srotm:ue,isamax:fe,sgemv_n:ce,sgemv_t:pe,ssymv:we,strmv:he,sger:ve,ssyr:_e,ssyr2:Ge,f64add:Ae,"f64/dekker":Se,"f64/utils/abs":De,"f64/utils/add":Le,"f64/utils/greater":je,"f64/utils/equal":We,dasum:Te,idamax:Ce,strsv_invert_block:Ue,strsv_apply_inverse:Oe,strsv_update:qe,sgemm:Qe}});var ya={};Br(ya,{GpuMatrix:()=>H,GpuVector:()=>y,cleanup:()=>Lr,dasum:()=>nt,gpuName:()=>Nr,idamax:()=>ft,init:()=>Ir,isamax:()=>lt,randomFloat32Array:()=>jr,randomFloat64Array:()=>Fr,randomTriangularFloat32Array:()=>Wr,sasum:()=>it,saxpy:()=>rt,scopy:()=>et,sdot:()=>at,sgemm:()=>_t,sgemv:()=>mt,sger:()=>xt,snrm2:()=>ut,srot:()=>dt,srotm:()=>ct,sscal:()=>Ye,sswap:()=>Je,ssymv:()=>pt,ssyr:()=>vt,ssyr2:()=>yt,strmv:()=>gt,strsv:()=>ht});function kr(o,e){return e?o.features.has("timestamp-query")?{requiredFeatures:["timestamp-query"]}:(console.warn("timestamp-query not supported on this device \u2014 benchmark mode disabled."),{}):{}}function Sr(){if(!Pr())return{querySet:null,passDescriptor:void 0};let e=C().createQuerySet({type:"timestamp",count:2});return{querySet:e,passDescriptor:{timestampWrites:{querySet:e,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}}}function wr(o,e){if(!e)return null;let r=C(),a=r.createBuffer({label:"timestamp-resolve",size:16,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC});o.resolveQuerySet(e,0,2,a,0);let t=r.createBuffer({label:"timestamp-readback",size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return o.copyBufferToBuffer(a,0,t,0,16),{tsReadBuffer:t,resolveBuffer:a,querySet:e}}async function P(o){if(!o)return;let{tsReadBuffer:e,resolveBuffer:r,querySet:a}=o;await e.mapAsync(GPUMapMode.READ);let t=new BigInt64Array(e.getMappedRange().slice());return e.unmap(),e.destroy(),r.destroy(),a.destroy(),Math.max(0,Number(t[1]-t[0]))/1e6}var $=null,or=null,Dr=null,hr=!1;async function Ir({powerPreference:o="high-performance",benchmark:e=!1}={}){if($)return $;let r;if(typeof window>"u"){let{create:i,globals:u}=await import("webgpu");Object.assign(globalThis,u),r=i([]),Dr=r}else r=navigator.gpu;if(!r)throw new Error("WebGPU not supported in this environment.");if(or=await r.requestAdapter({powerPreference:o})??await r.requestAdapter(),!or)throw new Error("No WebGPU adapter found.");hr=e;let t=[...kr(or,e).requiredFeatures??[]];return $=await or.requestDevice({requiredFeatures:t}),$.addEventListener("uncapturederror",i=>{console.error("Uncaptured GPU error:",i.error.message)}),$}function Lr(){$&&($.destroy(),$=null),or=null,Dr=null,hr=!1}function Nr(){if(!or)throw new Error("WebGPU adapter not initialized \u2014 call init() first.");let{device:o,description:e}=or.info;return{description:e||"unknown",device:o||"unknown"}}function Pr(){return hr}function C(){if(!$)throw new Error("WebGPU device not initialized \u2014 call init() first.");return $}function c(...o){o.flat().forEach(e=>e.destroy())}function b(o,e="blas-input",r=!1){let a=C(),t=a.limits.maxStorageBufferBindingSize,i=o.byteLength;if(i>t)throw new Error(`Buffer size ${i} bytes exceeds device limit of ${t} bytes.`);let u=r?GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC:GPUBufferUsage.STORAGE,l=a.createBuffer({label:e,size:i,usage:u,mappedAtCreation:!0}),n=o.constructor;return new n(l.getMappedRange()).set(o),l.unmap(),l}function O(o,e="blas-storage"){return C().createBuffer({label:e,size:o,usage:GPUBufferUsage.STORAGE})}function Z(o,e="blas-result"){return C().createBuffer({label:e,size:o,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC})}function G(o,e){let a=C().createBuffer({label:"blas-readback",size:e.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return o.copyBufferToBuffer(e,0,a,0,e.size),a}function N(o,e="blas-params"){let r=C(),a=o.length*4,t=Math.ceil(a/16)*16,i=new ArrayBuffer(t),u=new DataView(i);o.forEach(({value:n,type:s},f)=>{let d=f*4;if(s==="u32")u.setUint32(d,n,!0);else if(s==="i32")u.setInt32(d,n,!0);else if(s==="f32")u.setFloat32(d,n,!0);else throw new Error(`Unknown param type "${s}". Use "f32", "u32", or "i32".`)});let l=r.createBuffer({label:e,size:t,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return r.queue.writeBuffer(l,0,i),l}async function _(o,e=Float32Array){try{await o.mapAsync(GPUMapMode.READ);let r=new e(o.getMappedRange().slice());return o.unmap(),r}finally{o.destroy()}}function er(o){let e=o.length,r=new Float32Array(e),a=new Float32Array(e);for(let t=0;t<e;t++){let i=Math.fround(o[t]);r[t]=i,a[t]=Math.fround(o[t]-i)}return{hi:r,lo:a}}function sr(o,e){let r=o.length,a=new Float64Array(r);for(let t=0;t<r;t++)a[t]=o[t]+e[t];return a}var y=class o{constructor(e,r,a=Float32Array,t=null){this._buf=e,this._loBuf=t,this.length=r,this.dtype=a}static from(e){if(e instanceof Float64Array){let{hi:a,lo:t}=er(e),i=b(a,"gpu-vector-f64-hi",!0),u=b(t,"gpu-vector-f64-lo",!0);return new o(i,e.length,Float64Array,u)}if(!(e instanceof Float32Array))throw new Error("GpuVector.from expects a Float32Array or Float64Array.");let r=b(e,"gpu-vector",!0);return new o(r,e.length,e.constructor)}async read(){let e=C(),r=e.createCommandEncoder(),a=G(r,this._buf);if(e.queue.submit([r.finish()]),!this._loBuf)return _(a,this.dtype);let t=e.createCommandEncoder(),i=G(t,this._loBuf);e.queue.submit([t.finish()]);let[u,l]=await Promise.all([_(a,Float32Array),_(i,Float32Array)]);return sr(u,l)}destroy(){this._buf.destroy(),this._loBuf&&this._loBuf.destroy()}};var H=class o{constructor(e,r,a,t,i=null,u="row-major"){this._buf=e,this._loBuf=i,this.rows=r,this.cols=a,this.lda=t,this.layout=u}static from(e,r,a,t,i="row-major"){if(i!=="row-major"&&i!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");let u=i==="row-major";if(t===void 0&&(t=u?a:r),!(e instanceof Float32Array)&&!(e instanceof Float64Array))throw new Error("GpuMatrix.from expects a Float32Array or Float64Array.");if(!Number.isInteger(r)||r<=0)throw new Error("rows must be a positive integer.");if(!Number.isInteger(a)||a<=0)throw new Error("cols must be a positive integer.");let l=u?a:r;if(!Number.isInteger(t)||t<l)throw new Error(`lda must be an integer >= ${u?"cols":"rows"}.`);let n=u?r:a;if(e.length<n*t)throw new Error("data does not have enough elements for the given rows, cols, and lda.");if(e instanceof Float64Array){let f=n*t,{hi:d,lo:p}=er(e.subarray(0,f)),m=b(d,"gpu-matrix-f64-hi",!0),g=b(p,"gpu-matrix-f64-lo",!0);return new o(m,r,a,t,g,i)}let s=b(e.subarray(0,n*t),"gpu-matrix",!0);return new o(s,r,a,t,null,i)}async read(){let e=C(),r=e.createCommandEncoder(),a=G(r,this._buf);e.queue.submit([r.finish()]);let t=this.layout!=="column-major",i=t?this.rows:this.cols,u=t?this.cols:this.rows;if(this._loBuf){let s=e.createCommandEncoder(),f=G(s,this._loBuf);e.queue.submit([s.finish()]);let[d,p]=await Promise.all([_(a,Float32Array),_(f,Float32Array)]),m=sr(d,p);if(this.lda===u)return m;let g=new Float64Array(i*u);for(let w=0;w<i;w++)g.set(m.subarray(w*this.lda,w*this.lda+u),w*u);return g}let l=await _(a,Float32Array);if(this.lda===u)return l;let n=new Float32Array(i*u);for(let s=0;s<i;s++)n.set(l.subarray(s*this.lda,s*this.lda+u),s*u);return n}destroy(){this._buf.destroy(),this._loBuf&&this._loBuf.destroy()}};function jr(o,e=-1,r=1){let a=new Float32Array(o);for(let t=0;t<o;t++)a[t]=e+Math.random()*(r-e);return a}function Fr(o,e=-1,r=1){let a=new Float64Array(o);for(let t=0;t<o;t++)a[t]=e+Math.random()*(r-e);return a}function Wr(o,e,r="lower",a=-1,t=1,i=5,u=15){if(r!=="lower"&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(e<o)throw new Error("lda must be >= n.");let l=new Float32Array(o*e);for(let n=0;n<o;n++){for(let s=0;s<o;s++){if(n===s)continue;(r==="lower"?s<n:s>n)&&(l[n*e+s]=a+Math.random()*(t-a))}l[n*e+n]=i+Math.random()*(u-i)}return l}function A(o,e,r=0){let a=C(),t=e.map((i,u)=>({binding:r+u,resource:i instanceof GPUBuffer?{buffer:i}:i}));return a.createBindGroup({layout:o,entries:t})}var jt=new WeakMap;function D(o){C().queue.submit([o.finish()])}function xr(){let o=C(),{querySet:e,passDescriptor:r}=Sr();return{commandEncoder:o.createCommandEncoder(),querySet:e,passDescriptor:r}}function lr(o,e,r,a,t){let i=o.beginComputePass(t);i.setPipeline(e),i.setBindGroup(0,r),typeof a=="number"?i.dispatchWorkgroups(a):i.dispatchWorkgroups(a.x,a.y,a.z??1),i.end(),jt.set(o,i)}function L(o,e,r){let{commandEncoder:a,querySet:t,passDescriptor:i}=xr();lr(a,o,e,r,i);let u=wr(a,t);return{commandEncoder:a,ts:u}}var ba={},vr=new WeakMap;async function k(o,e,r="main"){vr.has(o)||vr.set(o,new Map);let a=vr.get(o),t=Array.isArray(e)?e:[e],i=`${t.join("+")}::${r}`;return a.has(i)||a.set(i,await wa(t,r)),a.get(i)}async function ga(o){if(typeof process>"u"||!process.versions?.node){let{shaderSources:e}=await Promise.resolve().then(()=>(Xe(),Ze)),r=e[o];if(!r)throw new Error(`Shader "${o}" not found in browser bundle.`);return r}else{let{readFileSync:e}=await import("fs"),{fileURLToPath:r}=await import("url"),{dirname:a,join:t}=await import("path"),i=a(r(ba.url));return e(t(i,`../shaders/${o}.wgsl`),"utf8")}}async function wa(o,e="main"){let r=C(),a=o.join("+"),t=(await Promise.all(o.map(ga))).join(`
...
`)}`);let n=e==="main"?{module:i}:{module:i,entryPoint:e},s=r.createComputePipeline({label:a,layout:"auto",compute:n});return s._shaderModule=i,s}var ha=64,$e=8;function K(o,e){let r=C().limits.maxComputeWorkgroupsPerDimension;return e===void 0?Math.min(Math.ceil(o/ha),r):{x:Math.min(Math.ceil(e/$e),r),y:Math.min(Math.ceil(o/$e),r)}}async function Ye(o,e,r,a,t){let i=a instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(t))throw new Error("n and incx must be integers.");if(typeof r!="number")throw new Error("alpha must be a number.");if(Number.isNaN(r))throw new Error("alpha must not be NaN.");if(!Number.isFinite(r))throw new Error("alpha must be finite.");if(t<=0)throw new Error("incx must be positive.");if(!(a instanceof Float32Array)&&!(a instanceof y))throw new Error("x must be a Float32Array or GpuVector.");if(e<=0)return i?{}:a;if(a.length<(e-1)*t+1)throw new Error("x does not have enough elements for the given n and incx.");let u=await k(o,"sscal"),l=null,n=null,s=null;try{l=i?a._buf:b(a,"sscal-x",!0),n=N([{value:e,type:"u32"},{value:r,type:"f32"},{value:t,type:"u32"}],"sscal-params");let f=A(u.getBindGroupLayout(0),[l,n]),{commandEncoder:d,ts:p}=L(u,f,K(e));s=i?null:G(d,l),D(d);let m=await P(p);if(i)return m!==void 0?{gpuTimeMs:m}:{};let g=await _(s,Float32Array);return s=null,m!==void 0?{x:g,gpuTimeMs:m}:g}finally{!i&&l&&c(l),n&&c(n),s&&c(s)}}async function Je(o,e,r,a,t,i){let u=r instanceof y,l=t instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!(r instanceof Float32Array)&&!(r instanceof y))throw new Error("x must be a Float32Array or GpuVector.");if(!(t instanceof Float32Array)&&!(t instanceof y))throw new Error("y must be a Float32Array or GpuVector.");if(r.constructor!==t.constructor)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0)return u?{}:{x:r,y:t};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(e-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let n=await k(o,"sswap"),s=null,f=null,d=null,p=null,m=null;try{s=u?r._buf:b(r,"sswap-x",!0),f=l?t._buf:b(t,"sswap-y",!0),d=N([{value:e,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"sswap-params");let g=A(n.getBindGroupLayout(0),[s,f,d]),{commandEncoder:w,ts:x}=L(n,g,K(e));p=u?null:G(w,s),m=l?null:G(w,f),D(w);let h=await P(x);if(u&&l)return h!==void 0?{gpuTimeMs:h}:{};let E=await _(p,Float32Array);p=null;let v=await _(m,Float32Array);return m=null,h!==void 0?{x:E,y:v,gpuTimeMs:h}:{x:E,y:v}}finally{!u&&s&&c(s),!l&&f&&c(f),d&&c(d),p&&c(p),m&&c(m)}}async function rt(o,e,r,a,t,i,u){let l=a instanceof y,n=i instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(t)||!Number.isInteger(u))throw new Error("n, incx, and incy must be integers.");if(typeof r!="number")throw new Error("alpha must be a number.");if(Number.isNaN(r))throw new Error("alpha must not be NaN.");if(!Number.isFinite(r))throw new Error("alpha must be finite.");if(t<=0||u<=0)throw new Error("incx and incy must be positive.");if(!l&&!(a instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(i instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(l!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0)return n?{}:{y:i};if(a.length<(e-1)*t+1)throw new Error("x does not have enough elements for the given n and incx.");if(i.length<(e-1)*u+1)throw new Error("y does not have enough elements for the given n and incy.");let s=await k(o,"saxpy"),f=null,d=null,p=null,m=null;try{f=l?a._buf:b(a,"saxpy-x",!1),d=n?i._buf:b(i,"saxpy-y",!0),p=N([{value:e,type:"u32"},{value:r,type:"f32"},{value:t,type:"u32"},{value:u,type:"u32"}],"saxpy-params");let g=A(s.getBindGroupLayout(0),[f,d,p]),{commandEncoder:w,ts:x}=L(s,g,K(e));m=n?null:G(w,d),D(w);let h=await P(x);if(n&&l)return h!==void 0?{gpuTimeMs:h}:{};let E=await _(m,Float32Array);return m=null,h!==void 0?{y:E,gpuTimeMs:h}:{y:E}}finally{!l&&f&&c(f),!n&&d&&c(d),p&&c(p),m&&c(m)}}async function et(o,e,r,a,t,i){let u=r instanceof y,l=t instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!u&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!l&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(u!==l)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0)return l?{}:{y:t};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(e-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let n=await k(o,"scopy"),s=null,f=null,d=null,p=null;try{s=u?r._buf:b(r,"scopy-x",!1),f=l?t._buf:b(t,"scopy-y",!0),d=N([{value:e,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"scopy-params");let m=A(n.getBindGroupLayout(0),[s,f,d]),{commandEncoder:g,ts:w}=L(n,m,K(e));p=l?null:G(g,f),D(g);let x=await P(w);if(l&&u)return x!==void 0?{gpuTimeMs:x}:{};let h=await _(p,Float32Array);return p=null,x!==void 0?{y:h,gpuTimeMs:x}:{y:h}}finally{!u&&s&&c(s),!l&&f&&c(f),d&&c(d),p&&c(p)}}var tt=64;async function at(o,e,r,a,t,i){let u=r instanceof y,l=t instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!u&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!l&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(u!==l)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0)return{dot:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(e-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let n=await k(o,"sdot"),s=await k(o,"reduction/sum"),f=null,d=null,p=null,m=null,g=null,w=null;try{f=u?r._buf:b(r,"sdot-x",!1),d=l?t._buf:b(t,"sdot-y",!1),p=O(2*tt*4,"sdot-partials"),m=Z(4,"sdot-result"),g=N([{value:e,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"sdot-params");let x=A(n.getBindGroupLayout(0),[f,d,p,g]),{commandEncoder:h,ts:E}=L(n,x,2*tt);D(h);let v=A(s.getBindGroupLayout(0),[p,m]),{commandEncoder:S,ts:B}=L(s,v,1);w=G(S,m),D(S);let I=_(w,Float32Array);w=null;let[j,W,M]=await Promise.all([P(E),P(B),I]);return j!==void 0&&W!==void 0?{dot:M[0],gpuTimeMs:j+W}:{dot:M[0]}}finally{!u&&f&&c(f),!l&&d&&c(d),p&&c(p),m&&c(m),g&&c(g),w&&c(w)}}var ot=64;async function it(o,e,r,a){let t=r instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!t&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(e<=0)return{asum:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await k(o,"sasum"),u=await k(o,"reduction/sum"),l=null,n=null,s=null,f=null,d=null;try{l=t?r._buf:b(r,"sasum-x",!1),n=O(2*ot*4,"sasum-partials"),s=Z(4,"sasum-result"),f=N([{value:e,type:"u32"},{value:a,type:"u32"}],"sasum-params");let p=A(i.getBindGroupLayout(0),[l,n,f]),{commandEncoder:m,ts:g}=L(i,p,2*ot);D(m);let w=A(u.getBindGroupLayout(0),[n,s]),{commandEncoder:x,ts:h}=L(u,w,1);d=G(x,s),D(x);let E=_(d,Float32Array);d=null;let[v,S,B]=await Promise.all([P(g),P(h),E]);return v!==void 0&&S!==void 0?{asum:B[0],gpuTimeMs:v+S}:{asum:B[0]}}finally{!t&&l&&c(l),n&&c(n),s&&c(s),f&&c(f),d&&c(d)}}var yr=64;async function nt(o,e,r,a){let t=r instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!t&&!(r instanceof Float64Array))throw new Error("x must be a Float64Array or GpuVector.");if(t&&r.dtype!==Float64Array)throw new Error("x must be a Float64Array-backed GpuVector.");if(e<=0)return{asum:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=["f64/dekker","f64/utils/abs","f64/utils/add"],u=await k(o,[...i,"dasum"]),l=await k(o,[...i,"reduction/sumF64"]),n=null,s=null,f=null,d=null,p=null,m=null,g=null,w=null,x=null;try{if(t)n=r._buf,s=r._loBuf;else{let{hi:z,lo:V}=er(r.map(Math.abs));n=b(z,"dasum-xHi",!1),s=b(V,"dasum-xLo",!1)}f=O(2*yr*4,"dasum-partialsHi"),d=O(2*yr*4,"dasum-partialsLo"),p=Z(4,"dasum-result-hi"),m=Z(4,"dasum-result-lo"),g=N([{value:e,type:"u32"},{value:a,type:"u32"}],"dasum-params");let h=A(u.getBindGroupLayout(0),[n,s,f,d,g]),{commandEncoder:E,ts:v}=L(u,h,2*yr);D(E);let S=A(l.getBindGroupLayout(0),[f,d,p,m]),{commandEncoder:B,ts:I}=L(l,S,1);w=G(B,p),x=G(B,m),D(B);let j=_(w,Float32Array),W=_(x,Float32Array);w=null,x=null;let[M,T,R,U]=await Promise.all([P(v),P(I),j,W]),Q=sr(R,U)[0];return M!==void 0&&T!==void 0?{asum:Q,gpuTimeMs:M+T}:{asum:Q}}finally{!t&&n&&c(n),!t&&s&&c(s),f&&c(f),d&&c(d),p&&c(p),m&&c(m),g&&c(g),w&&c(w),x&&c(x)}}var st=64;async function ut(o,e,r,a){let t=r instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!t&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(e<=0)return{nrm2:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await k(o,"snrm2"),u=await k(o,"reduction/sum"),l=null,n=null,s=null,f=null,d=null;try{l=t?r._buf:b(r,"snrm2-x",!1),n=O(2*st*4,"snrm2-partials"),s=Z(4,"snrm2-result"),f=N([{value:e,type:"u32"},{value:a,type:"u32"}],"snrm2-params");let p=A(i.getBindGroupLayout(0),[l,n,f]),{commandEncoder:m,ts:g}=L(i,p,2*st);D(m);let w=A(u.getBindGroupLayout(0),[n,s]),{commandEncoder:x,ts:h}=L(u,w,1);d=G(x,s),D(x);let E=_(d,Float32Array);d=null;let[v,S,B]=await Promise.all([P(g),P(h),E]),I=Math.sqrt(B[0]);return v!==void 0&&S!==void 0?{nrm2:I,gpuTimeMs:v+S}:{nrm2:I}}finally{!t&&l&&c(l),n&&c(n),s&&c(s),f&&c(f),d&&c(d)}}var _r=64;async function lt(o,e,r,a){let t=r instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!t&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(e<=0)return{index:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await k(o,"isamax"),u=await k(o,"reduction/argmax"),l=null,n=null,s=null,f=null,d=null,p=null;try{l=t?r._buf:b(r,"isamax-x",!1),n=O(2*_r*4,"isamax-partials-val"),s=O(2*_r*4,"isamax-partials-idx"),f=Z(4,"isamax-result"),d=N([{value:e,type:"u32"},{value:a,type:"u32"}],"isamax-params");let m=A(i.getBindGroupLayout(0),[l,n,s,d]),{commandEncoder:g,ts:w}=L(i,m,2*_r);D(g);let x=A(u.getBindGroupLayout(0),[n,s,f]),{commandEncoder:h,ts:E}=L(u,x,1);p=G(h,f),D(h);let v=_(p,Uint32Array);p=null;let[S,B,I]=await Promise.all([P(w),P(E),v]),j=I[0];return S!==void 0&&B!==void 0?{index:j,gpuTimeMs:S+B}:{index:j}}finally{!t&&l&&c(l),n&&c(n),s&&c(s),f&&c(f),d&&c(d),p&&c(p)}}var br=64;async function ft(o,e,r,a){let t=r instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!t&&!(r instanceof Float64Array))throw new Error("x must be a Float64Array or GpuVector.");if(t&&r.dtype!==Float64Array)throw new Error("x must be a Float64Array-backed GpuVector.");if(e<=0)return{index:0};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=["f64/dekker","f64/utils/abs","f64/utils/greater","f64/utils/equal"],u=await k(o,[...i,"idamax"],"idamax_main"),l=await k(o,[...i,"reduction/argmaxF64"],"reduce_f64"),n=null,s=null,f=null,d=null,p=null,m=null,g=null,w=null;try{if(t)n=r._buf,s=r._loBuf;else{let{hi:R,lo:U}=er(r);n=b(R,"idamax-xHi",!1),s=b(U,"idamax-xLo",!1)}f=O(2*br*4,"idamax-partials-val-hi"),d=O(2*br*4,"idamax-partials-val-lo"),p=O(2*br*4,"idamax-partials-idx"),m=Z(4,"idamax-result"),g=N([{value:e,type:"u32"},{value:a,type:"u32"}],"idamax-params");let x=A(u.getBindGroupLayout(0),[n,s,f,d,p,g]),{commandEncoder:h,ts:E}=L(u,x,2*br);D(h);let v=A(l.getBindGroupLayout(0),[f,d,p,m]),{commandEncoder:S,ts:B}=L(l,v,1);w=G(S,m),D(S);let I=_(w,Uint32Array);w=null;let[j,W,M]=await Promise.all([P(E),P(B),I]),T=M[0];return j!==void 0&&W!==void 0?{index:T,gpuTimeMs:j+W}:{index:T}}finally{!t&&n&&c(n),!t&&s&&c(s),f&&c(f),d&&c(d),p&&c(p),m&&c(m),g&&c(g),w&&c(w)}}async function dt(o,e,r,a,t,i,u,l){let n=r instanceof y,s=t instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(typeof u!="number")throw new Error("c must be a number.");if(typeof l!="number")throw new Error("s must be a number.");if(Number.isNaN(u)||Number.isNaN(l))throw new Error("c and s must not be NaN.");if(!Number.isFinite(u))throw new Error("c must be finite.");if(!Number.isFinite(l))throw new Error("s must be finite.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!n&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!s&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(n!==s)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0)return n?{}:{x:r,y:t};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(e-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let f=await k(o,"srot"),d=null,p=null,m=null,g=null,w=null;try{d=n?r._buf:b(r,"srot-x",!0),p=s?t._buf:b(t,"srot-y",!0),m=N([{value:e,type:"u32"},{value:u,type:"f32"},{value:l,type:"f32"},{value:a,type:"u32"},{value:i,type:"u32"}],"srot-params");let x=A(f.getBindGroupLayout(0),[d,p,m]),{commandEncoder:h,ts:E}=L(f,x,K(e));g=n?null:G(h,d),w=s?null:G(h,p),D(h);let v=await P(E);if(n&&s)return v!==void 0?{gpuTimeMs:v}:{};let S=_(g,Float32Array),B=_(w,Float32Array);g=null,w=null;let[I,j]=await Promise.all([S,B]);return v!==void 0?{x:I,y:j,gpuTimeMs:v}:{x:I,y:j}}finally{!n&&d&&c(d),!s&&p&&c(p),m&&c(m),g&&c(g),w&&c(w)}}async function ct(o,e,r,a,t,i,u){let l=r instanceof y,n=t instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(!(u instanceof Float32Array)||u.length!==5)throw new Error("param must be a Float32Array of length 5.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!l&&!(r instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(t instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(l!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(e<=0||u[0]===-2)return l?{}:{x:r,y:t};if(r.length<(e-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(t.length<(e-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let s=await k(o,"srotm"),f=null,d=null,p=null,m=null,g=null,w=null;try{f=l?r._buf:b(r,"srotm-x",!0),d=n?t._buf:b(t,"srotm-y",!0),p=b(u,"srotm-param",!1),m=N([{value:e,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"srotm-params");let x=A(s.getBindGroupLayout(0),[f,d,p,m]),{commandEncoder:h,ts:E}=L(s,x,K(e));g=l?null:G(h,f),w=n?null:G(h,d),D(h);let v=await P(E);if(l&&n)return v!==void 0?{gpuTimeMs:v}:{};let S=_(g,Float32Array),B=_(w,Float32Array);g=null,w=null;let[I,j]=await Promise.all([S,B]);return v!==void 0?{x:I,y:j,gpuTimeMs:v}:{x:I,y:j}}finally{!l&&f&&c(f),!n&&d&&c(d),p&&c(p),m&&c(m),g&&c(g),w&&c(w)}}async function mt(o,e,r,a,t,i,u,l,n,s,f,d,p="row-major"){let m=i instanceof H,g=l instanceof y,w=f instanceof y;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="no-transpose"&&e!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(p!=="row-major"&&p!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(typeof t!="number")throw new Error("alpha must be a number.");if(Number.isNaN(t))throw new Error("alpha must not be NaN.");if(!Number.isFinite(t))throw new Error("alpha must be finite.");if(typeof s!="number")throw new Error("beta must be a number.");if(Number.isNaN(s))throw new Error("beta must not be NaN.");if(!Number.isFinite(s))throw new Error("beta must be finite.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(n)||!Number.isInteger(d)||!Number.isInteger(u))throw new Error("m, n, incx, incy, and lda must be integers.");if(n<=0||d<=0)throw new Error("incx and incy must be positive.");if(!m&&!(i instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!g&&!(l instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!w&&!(f instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(g!==w)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(g&&!m)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(g&&l._buf===f._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(m&&u!==i.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(m&&(i.rows<r||i.cols<a))throw new Error("A is too small for the given m and n.");if(r<0||a<0)throw new Error("m and n must be non-negative.");if(r===0||a===0)return w?{}:{y:f};(m?i.layout:p)==="column-major"&&([r,a]=[a,r],e=e==="no-transpose"?"transpose":"no-transpose");let h=e==="no-transpose",E=h?a:r,v=h?r:a;if(u<a)throw new Error("lda must be >= n.");if(!m&&i.length<(r-1)*u+a)throw new Error("A does not have enough elements for the given m, n, and lda.");if(l.length<(E-1)*n+1)throw new Error("x does not have enough elements for the given dimensions and incx.");if(f.length<(v-1)*d+1)throw new Error("y does not have enough elements for the given dimensions and incy.");let B=await k(o,h?"sgemv_n":"sgemv_t"),I=m?i._buf:b(i,"sgemv-A",!1),j=g?l._buf:b(l,"sgemv-x",!1),W=w?f._buf:b(f,"sgemv-y",!0),M=N([{value:r,type:"u32"},{value:a,type:"u32"},{value:t,type:"f32"},{value:s,type:"f32"},{value:n,type:"u32"},{value:d,type:"u32"},{value:u,type:"u32"}],"sgemv-params");try{let T=A(B.getBindGroupLayout(0),[I,j,W,M]),R=h?Math.min(r,o.limits.maxComputeWorkgroupsPerDimension):K(v),{commandEncoder:U,ts:Q}=L(B,T,R),z=w?null:G(U,W);D(U);let V=await P(Q);if(w)return V!==void 0?{gpuTimeMs:V}:{};let tr=await _(z,Float32Array);return V!==void 0?{y:tr,gpuTimeMs:V}:{y:tr}}finally{m||c(I),g||c(j),w||c(W),c(M)}}async function pt(o,e,r,a,t,i,u,l,n,s,f,d="row-major"){let p=u instanceof y,m=s instanceof y,g=t instanceof H;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="lower"&&e!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(d!=="row-major"&&d!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(!Number.isInteger(r)||!Number.isInteger(l)||!Number.isInteger(f)||!Number.isInteger(i))throw new Error("n, incx, incy, and lda must be integers.");if(typeof a!="number")throw new Error("alpha must be a number.");if(Number.isNaN(a))throw new Error("alpha must not be NaN.");if(!Number.isFinite(a))throw new Error("alpha must be finite.");if(typeof n!="number")throw new Error("beta must be a number.");if(Number.isNaN(n))throw new Error("beta must not be NaN.");if(!Number.isFinite(n))throw new Error("beta must be finite.");if(l<=0||f<=0)throw new Error("incx and incy must be positive.");if(i<r)throw new Error("lda must be >= n.");if(!g&&!(t instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!p&&!(u instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!m&&!(s instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(p!==m)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(p&&!g)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(p&&u._buf===s._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(g&&i!==t.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(g&&(t.rows<r||t.cols<r))throw new Error("A is too small for the given n.");if(r<0)throw new Error("n must be non-negative.");if(r===0)return m?{}:{y:s};if(!g&&t.length<(r-1)*i+r)throw new Error("A does not have enough elements for the given n and lda.");if(u.length<(r-1)*l+1)throw new Error("x does not have enough elements for the given n and incx.");if(s.length<(r-1)*f+1)throw new Error("y does not have enough elements for the given n and incy.");let x=(g?t.layout:d)==="column-major"?e==="upper":e==="lower",h=await k(o,"ssymv"),E=null,v=null,S=null,B=null;try{E=g?t._buf:b(t,"ssymv-A",!1),v=p?u._buf:b(u,"ssymv-x",!1),S=m?s._buf:b(s,"ssymv-y",!0),B=N([{value:r,type:"u32"},{value:a,type:"f32"},{value:n,type:"f32"},{value:l,type:"u32"},{value:f,type:"u32"},{value:i,type:"u32"},{value:x?0:1,type:"u32"}],"ssymv-params");let I=A(h.getBindGroupLayout(0),[E,v,S,B]),j=Math.min(r,o.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:W,ts:M}=L(h,I,j),T=m?null:G(W,S);D(W);let R=await P(M);if(m)return R!==void 0?{gpuTimeMs:R}:{};let U=await _(T,Float32Array);return R!==void 0?{y:U,gpuTimeMs:R}:{y:U}}finally{!g&&E&&c(E),!p&&v&&c(v),!m&&S&&c(S),B&&c(B)}}async function gt(o,e,r,a,t,i,u,l,n,s,f,d="row-major"){let p=l instanceof y,m=s instanceof y,g=i instanceof H,w=a==="unit";if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="lower"&&e!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(r!=="no-transpose"&&r!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!w&&a!=="non-unit")throw new Error("diag must be 'unit' or 'non-unit'.");if(d!=="row-major"&&d!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(!Number.isInteger(t)||!Number.isInteger(n)||!Number.isInteger(f)||!Number.isInteger(u))throw new Error("n, incx, incy, and lda must be integers.");if(n<=0||f<=0)throw new Error("incx and incy must be positive.");if(u<t)throw new Error("lda must be >= n.");if(!g&&!(i instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!p&&!(l instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!m&&!(s instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(p!==m)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(p&&l._buf===s._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(p&&!g)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(g&&m&&i._buf===s._buf)throw new Error("A and y must not reference the same GPU buffer.");if(g&&u!==i.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(g&&(i.rows<t||i.cols<t))throw new Error("A is too small for the given n.");if(t<0)throw new Error("n must be non-negative.");if(t===0)return m?{}:{y:s};if(!g&&i.length<(t-1)*u+t)throw new Error("A does not have enough elements for the given n and lda.");if(l.length<(t-1)*n+1)throw new Error("x does not have enough elements for the given n and incx.");if(s.length<(t-1)*f+1)throw new Error("y does not have enough elements for the given n and incy.");let h=(g?i.layout:d)==="column-major",E=h?e==="upper":e==="lower",v=h?r==="transpose":r==="no-transpose",S=await k(o,"strmv"),B=null,I=null,j=null,W=null;try{B=g?i._buf:b(i,"strmv-A",!1),I=p?l._buf:b(l,"strmv-x",!1),j=m?s._buf:b(s,"strmv-y",!0),W=N([{value:t,type:"u32"},{value:n,type:"u32"},{value:f,type:"u32"},{value:u,type:"u32"},{value:v?0:1,type:"u32"},{value:E?0:1,type:"u32"},{value:w?1:0,type:"u32"}],"strmv-params");let M=A(S.getBindGroupLayout(0),[B,I,j,W]),T=Math.min(t,o.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:R,ts:U}=L(S,M,T),Q=m?null:G(R,j);D(R);let z=await P(U);if(m)return z!==void 0?{gpuTimeMs:z}:{};let V=await _(Q,Float32Array);return z!==void 0?{y:V,gpuTimeMs:z}:{y:V}}finally{!g&&B&&c(B),!p&&I&&c(I),!m&&j&&c(j),W&&c(W)}}var Y=64;function wt(o,e,r){let a=new ArrayBuffer(o*e),t=new DataView(a);for(let i=0;i<o;i++){let u=r(i),l=i*e;u.forEach((n,s)=>t.setUint32(l+s*4,n,!0))}return a}function bt(o,e,r){let a=o.createBuffer({label:r,size:e.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return o.queue.writeBuffer(a,0,e),a}async function ht(o,e,r,a,t,i,u,l,n,s="row-major"){let f=l instanceof y,d=i instanceof H,p=a==="unit";if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="lower"&&e!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(r!=="no-transpose"&&r!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!p&&a!=="non-unit")throw new Error("diag must be 'unit' or 'non-unit'.");if(s!=="row-major"&&s!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(!Number.isInteger(t)||!Number.isInteger(n)||!Number.isInteger(u))throw new Error("n, incx, and lda must be integers.");if(n<=0)throw new Error("incx must be positive.");if(u<t)throw new Error("lda must be >= n.");if(!d&&!(i instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!f&&!(l instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(f&&!d)throw new Error("A must be a GpuMatrix when x is a GpuVector.");if(d&&u!==i.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(d&&(i.rows<t||i.cols<t))throw new Error("A is too small for the given n.");if(t<0)throw new Error("n must be non-negative.");if(t===0)return f?{}:{x:l};if(!d&&i.length<(t-1)*u+t)throw new Error("A does not have enough elements for the given n and lda.");if(l.length<(t-1)*n+1)throw new Error("x does not have enough elements for the given n and incx.");let g=(d?i.layout:s)==="column-major",w=g?e==="upper":e==="lower",x=g?r==="transpose":r==="no-transpose",h=await k(o,"strsv_invert_block"),E=await k(o,"strsv_apply_inverse"),v=await k(o,"strsv_update"),S=x===w,B=[];for(let V=0;V<t;V+=Y)B.push(V);S||B.reverse();let I=B.length,j=o.limits.maxComputeWorkgroupsPerDimension,W=o.limits.minUniformBufferOffsetAlignment,M=null,T=null,R=null,U=null,Q=null,z=null;try{M=d?i._buf:b(i,"strsv-A",!1),T=f?l._buf:b(l,"strsv-x",!0),R=O(I*Y*Y*4,"strsv-Ainv");let V=wt(I,W,q=>{let X=q*Y,ur=Math.min(X+Y,t);return[n,q,X,ur]});U=bt(o,V,"strsv-apply-params");let tr=wt(I,W,q=>{let X=q*Y,ur=Math.min(X+Y,t);return[t,n,u,x?0:1,w?0:1,X,ur]});Q=bt(o,tr,"strsv-update-params");let{commandEncoder:J,querySet:rr}=xr();z=N([{value:t,type:"u32"},{value:u,type:"u32"},{value:x?0:1,type:"u32"},{value:w?0:1,type:"u32"},{value:p?1:0,type:"u32"}],"strsv-invert-params");let fr=A(h.getBindGroupLayout(0),[M,R,z]);lr(J,h,fr,{x:Y,y:I},rr?{timestampWrites:{querySet:rr,beginningOfPassWriteIndex:0}}:void 0);for(let q=0;q<B.length;q++){let X=B[q],ur=Math.min(X+Y,t),Et=X/Y,Gt=q===B.length-1,Er=Et*W,Bt=A(E.getBindGroupLayout(0),[R,T,{buffer:U,offset:Er,size:16}]);lr(J,E,Bt,1,Gt&&rr?{timestampWrites:{querySet:rr,endOfPassWriteIndex:1}}:void 0);let Gr=S?t-ur:X;if(Gr===0)continue;let At=A(v.getBindGroupLayout(0),[M,T,{buffer:Q,offset:Er,size:32}]),kt=Math.min(Gr,j);lr(J,v,At,kt)}let ar=wr(J,rr),dr=f?null:G(J,T);D(J);let nr=await P(ar);if(f)return nr!==void 0?{gpuTimeMs:nr}:{};let cr=await _(dr,Float32Array);return nr!==void 0?{x:cr,gpuTimeMs:nr}:{x:cr}}finally{!d&&M&&c(M),!f&&T&&c(T),R&&c(R),U&&c(U),Q&&c(Q),z&&c(z)}}async function xt(o,e,r,a,t,i,u,l,n,s,f="row-major"){let d=n instanceof H;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(f!=="row-major"&&f!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(typeof a!="number")throw new Error("alpha must be a number.");if(Number.isNaN(a))throw new Error("alpha must not be NaN.");if(!Number.isFinite(a))throw new Error("alpha must be finite.");if(!Number.isInteger(e)||!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(l)||!Number.isInteger(s))throw new Error("m, n, incx, incy, and lda must be integers.");if(i<=0||l<=0)throw new Error("incx and incy must be positive.");if(!d&&!(n instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(d&&s!==n.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(d&&(n.rows<e||n.cols<r))throw new Error("A is too small for the given m and n.");(d?n.layout:f)==="column-major"&&([e,r]=[r,e],[t,u]=[u,t],[i,l]=[l,i]);let m=t instanceof y,g=u instanceof y;if(s<r)throw new Error("lda must be >= n.");if(!m&&!(t instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!g&&!(u instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(m!==g)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(m&&!d)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(d&&m&&n._buf===t._buf)throw new Error("A and x must not reference the same GPU buffer.");if(d&&g&&n._buf===u._buf)throw new Error("A and y must not reference the same GPU buffer.");if(e<0||r<0)throw new Error("m and n must be non-negative.");if(e===0||r===0)return d?{}:{A:n};if(!d&&n.length<(e-1)*s+r)throw new Error("A does not have enough elements for the given m, n, and lda.");if(t.length<(e-1)*i+1)throw new Error("x does not have enough elements for the given m and incx.");if(u.length<(r-1)*l+1)throw new Error("y does not have enough elements for the given n and incy.");let w=await k(o,"sger"),x=null,h=null,E=null,v=null;try{x=m?t._buf:b(t,"sger-x",!1),h=g?u._buf:b(u,"sger-y",!1),E=d?n._buf:b(n,"sger-A",!0),v=N([{value:e,type:"u32"},{value:r,type:"u32"},{value:a,type:"f32"},{value:i,type:"u32"},{value:l,type:"u32"},{value:s,type:"u32"}],"sger-params");let S=A(w.getBindGroupLayout(0),[x,h,E,v]),B=Math.min(e,o.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:I,ts:j}=L(w,S,B),W=d?null:G(I,E);D(I);let M=await P(j);if(d)return M!==void 0?{gpuTimeMs:M}:{};let T=await _(W,Float32Array);return M!==void 0?{A:T,gpuTimeMs:M}:{A:T}}finally{!m&&x&&c(x),!g&&h&&c(h),!d&&E&&c(E),v&&c(v)}}async function vt(o,e,r,a,t,i,u,l,n="row-major"){let s=t instanceof y,f=u instanceof H;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="lower"&&e!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(n!=="row-major"&&n!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(l))throw new Error("n, incx, and lda must be integers.");if(typeof a!="number")throw new Error("alpha must be a number.");if(Number.isNaN(a))throw new Error("alpha must not be NaN.");if(!Number.isFinite(a))throw new Error("alpha must be finite.");if(i<=0)throw new Error("incx must be positive.");if(l<r)throw new Error("lda must be >= n.");if(!f&&!(u instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!s&&!(t instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(s&&!f)throw new Error("A must be a GpuMatrix when x is a GpuVector.");if(f&&s&&u._buf===t._buf)throw new Error("A and x must not reference the same GPU buffer.");if(f&&l!==u.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(f&&(u.rows<r||u.cols<r))throw new Error("A is too small for the given n.");if(r<0)throw new Error("n must be non-negative.");if(r===0)return f?{}:{A:u};if(!f&&u.length<(r-1)*l+r)throw new Error("A does not have enough elements for the given n and lda.");if(t.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");let p=(f?u.layout:n)==="column-major"?e==="upper":e==="lower",m=await k(o,"ssyr"),g=null,w=null,x=null;try{g=s?t._buf:b(t,"ssyr-x",!1),w=f?u._buf:b(u,"ssyr-A",!0),x=N([{value:r,type:"u32"},{value:a,type:"f32"},{value:i,type:"u32"},{value:l,type:"u32"},{value:p?0:1,type:"u32"}],"ssyr-params");let h=A(m.getBindGroupLayout(0),[g,w,x]),E=Math.min(r,o.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:v,ts:S}=L(m,h,E),B=f?null:G(v,w);D(v);let I=await P(S);if(f)return I!==void 0?{gpuTimeMs:I}:{};let j=await _(B,Float32Array);return I!==void 0?{A:j,gpuTimeMs:I}:{A:j}}finally{!s&&g&&c(g),!f&&w&&c(w),x&&c(x)}}async function yt(o,e,r,a,t,i,u,l,n,s,f="row-major"){let d=t instanceof y,p=u instanceof y,m=n instanceof H;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="lower"&&e!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(f!=="row-major"&&f!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(!Number.isInteger(r)||!Number.isInteger(i)||!Number.isInteger(l)||!Number.isInteger(s))throw new Error("n, incx, incy, and lda must be integers.");if(typeof a!="number")throw new Error("alpha must be a number.");if(Number.isNaN(a))throw new Error("alpha must not be NaN.");if(!Number.isFinite(a))throw new Error("alpha must be finite.");if(i<=0||l<=0)throw new Error("incx and incy must be positive.");if(s<r)throw new Error("lda must be >= n.");if(!m&&!(n instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!d&&!(t instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!p&&!(u instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(d!==p)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(d&&!m)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(m&&d&&n._buf===t._buf)throw new Error("A and x must not reference the same GPU buffer.");if(m&&p&&n._buf===u._buf)throw new Error("A and y must not reference the same GPU buffer.");if(d&&t._buf===u._buf)throw new Error("x and y must not reference the same GPU buffer when both are GpuVectors.");if(m&&s!==n.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(m&&(n.rows<r||n.cols<r))throw new Error("A is too small for the given n.");if(r<0)throw new Error("n must be non-negative.");if(r===0)return m?{}:{A:n};if(!m&&n.length<(r-1)*s+r)throw new Error("A does not have enough elements for the given n and lda.");if(t.length<(r-1)*i+1)throw new Error("x does not have enough elements for the given n and incx.");if(u.length<(r-1)*l+1)throw new Error("y does not have enough elements for the given n and incy.");let w=(m?n.layout:f)==="column-major"?e==="upper":e==="lower",x=await k(o,"ssyr2"),h=null,E=null,v=null,S=null;try{h=d?t._buf:b(t,"ssyr2-x",!1),E=p?u._buf:b(u,"ssyr2-y",!1),v=m?n._buf:b(n,"ssyr2-A",!0),S=N([{value:r,type:"u32"},{value:a,type:"f32"},{value:i,type:"u32"},{value:l,type:"u32"},{value:s,type:"u32"},{value:w?0:1,type:"u32"}],"ssyr2-params");let B=A(x.getBindGroupLayout(0),[h,E,v,S]),I=Math.min(r,o.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:j,ts:W}=L(x,B,I),M=m?null:G(j,v);D(j);let T=await P(W);if(m)return T!==void 0?{gpuTimeMs:T}:{};let R=await _(M,Float32Array);return T!==void 0?{A:R,gpuTimeMs:T}:{A:R}}finally{!d&&h&&c(h),!p&&E&&c(E),!m&&v&&c(v),S&&c(S)}}var xa=32,va=32;async function _t(o,e,r,a,t,i,u,l,n,s,f,d,p,m,g="row-major"){let w=l instanceof H,x=s instanceof H,h=p instanceof H;if(!(o instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(e!=="no-transpose"&&e!=="transpose")throw new Error("transA must be 'no-transpose' or 'transpose'.");if(r!=="no-transpose"&&r!=="transpose")throw new Error("transB must be 'no-transpose' or 'transpose'.");if(g!=="row-major"&&g!=="column-major")throw new Error("layout must be 'row-major' or 'column-major'.");if(typeof u!="number")throw new Error("alpha must be a number.");if(Number.isNaN(u))throw new Error("alpha must not be NaN.");if(!Number.isFinite(u))throw new Error("alpha must be finite.");if(typeof d!="number")throw new Error("beta must be a number.");if(Number.isNaN(d))throw new Error("beta must not be NaN.");if(!Number.isFinite(d))throw new Error("beta must be finite.");if(!Number.isInteger(a)||!Number.isInteger(t)||!Number.isInteger(i)||!Number.isInteger(n)||!Number.isInteger(f)||!Number.isInteger(m))throw new Error("m, n, k, lda, ldb, and ldc must be integers.");if(!w&&!(l instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!x&&!(s instanceof Float32Array))throw new Error("B must be a Float32Array or GpuMatrix.");if(!h&&!(p instanceof Float32Array))throw new Error("C must be a Float32Array or GpuMatrix.");if((w||x)&&!h)throw new Error("C must be a GpuMatrix when A or B is a GpuMatrix.");if(h&&(!w||!x))throw new Error("A and B must be GpuMatrix when C is a GpuMatrix.");if(a<0||t<0||i<0)throw new Error("m, n, and k must be non-negative.");if(a===0||t===0)return h?{}:{C:p};let E=w?l.layout:g,v=x?s.layout:g,S=h?p.layout:g,B=E==="column-major"?i:a,I=E==="column-major"?a:i,j=e==="no-transpose"?B:I,W=e==="no-transpose"?I:B;if(n<W)throw new Error(`lda must be >= ${E==="column-major"?"rows":"cols"} of A as stored.`);if(w){if(n!==l.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");let[ir,ar]=e==="no-transpose"?[a,i]:[i,a];if(l.rows<ir||l.cols<ar)throw new Error("A is too small for the given m, k, and transA.")}else if(l.length<(j-1)*n+W)throw new Error("A does not have enough elements for the given dimensions and lda.");let M=v==="column-major"?t:i,T=v==="column-major"?i:t,R=r==="no-transpose"?M:T,U=r==="no-transpose"?T:M;if(f<U)throw new Error(`ldb must be >= ${v==="column-major"?"rows":"cols"} of B as stored.`);if(x){if(f!==s.lda)throw new Error("ldb must match B.lda when B is a GpuMatrix.");let[ir,ar]=r==="no-transpose"?[i,t]:[t,i];if(s.rows<ir||s.cols<ar)throw new Error("B is too small for the given n, k, and transB.")}else if(s.length<(R-1)*f+U)throw new Error("B does not have enough elements for the given dimensions and ldb.");let Q=S==="column-major"?t:a,z=S==="column-major"?a:t;if(m<z)throw new Error(`ldc must be >= ${S==="column-major"?"rows":"cols"} of C as stored.`);if(h){if(m!==p.lda)throw new Error("ldc must match C.lda when C is a GpuMatrix.");if(p.rows<a||p.cols<t)throw new Error("C is too small for the given m and n.")}else if(p.length<(Q-1)*m+z)throw new Error("C does not have enough elements for the given dimensions and ldc.");E==="column-major"&&(e=e==="no-transpose"?"transpose":"no-transpose"),v==="column-major"&&(r=r==="no-transpose"?"transpose":"no-transpose"),S==="column-major"&&([l,s]=[s,l],[w,x]=[x,w],[n,f]=[f,n],[e,r]=[r==="no-transpose"?"transpose":"no-transpose",e==="no-transpose"?"transpose":"no-transpose"],[a,t]=[t,a]);let V=await k(o,"sgemm"),tr=w?l._buf:b(l,"sgemm-A",!1),J=x?s._buf:b(s,"sgemm-B",!1),rr=h?p._buf:b(p,"sgemm-C",!0),fr=N([{value:a,type:"u32"},{value:t,type:"u32"},{value:i,type:"u32"},{value:u,type:"f32"},{value:d,type:"f32"},{value:n,type:"u32"},{value:f,type:"u32"},{value:m,type:"u32"},{value:e==="transpose"?1:0,type:"u32"},{value:r==="transpose"?1:0,type:"u32"}],"sgemm-params");try{let ir=A(V.getBindGroupLayout(0),[tr,J,rr,fr]),ar={x:Math.min(Math.ceil(t/va),o.limits.maxComputeWorkgroupsPerDimension),y:Math.min(Math.ceil(a/xa),o.limits.maxComputeWorkgroupsPerDimension)},{commandEncoder:dr,ts:nr}=L(V,ir,ar),cr=h?null:G(dr,rr);D(dr);let q=await P(nr);if(h)return q!==void 0?{gpuTimeMs:q}:{};let X=await _(cr,Float32Array);return q!==void 0?{C:X,gpuTimeMs:q}:{C:X}}finally{w||c(tr),x||c(J),h||c(rr),c(fr)}}return Nt(ya);})();
