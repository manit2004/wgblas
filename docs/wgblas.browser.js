var wgblas=(()=>{var De=Object.create;var J=Object.defineProperty;var Ce=Object.getOwnPropertyDescriptor;var Oe=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Qe=Object.prototype.hasOwnProperty;var rr=(a=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(a,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):a)(function(a){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+a+'" is not supported')});var I=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(i){throw e=[i],i}};var gr=(a,r)=>{for(var e in r)J(a,e,{get:r[e],enumerable:!0})},wr=(a,r,e,i)=>{if(r&&typeof r=="object"||typeof r=="function")for(let t of Oe(r))!Qe.call(a,t)&&t!==e&&J(a,t,{get:()=>r[t],enumerable:!(i=Ce(r,t))||i.enumerable});return a};var er=(a,r,e)=>(e=a!=null?De(ze(a)):{},wr(r||!a||!a.__esModule?J(e,"default",{value:a,enumerable:!0}):e,a)),qe=a=>wr(J({},"__esModule",{value:!0}),a);var Fr,Sr=I(()=>{Fr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var Nr,jr=I(()=>{Nr=`// sum reduction: collapses 2*WGS partials into one scalar.
// dispatch: 1 workgroup of WGS threads.
...
`});var Lr,Wr=I(()=>{Lr=`// sum reduction (f64): collapses 2*WGS partial [main, aux] pairs into one,
...
`});var Mr,Ir=I(()=>{Mr=`// sscal: x = alpha * x
...
`});var Hr,Vr=I(()=>{Hr=`// saxpy: y = alpha * x + y
...
`});var Or,Cr=I(()=>{Or=`// sdot: result = sum(x[i] * y[i])
...
`});var Qr,zr=I(()=>{Qr=`// sasum: result = sum(|x[i]|)
...
`});var Xr,qr=I(()=>{Xr=`// snrm2: result = sqrt(sum(x[i] * x[i]))
...
`});var Zr,$r=I(()=>{Zr=`// srot: x = c*x + s*y,  y = -s*x + c*y
...
`});var Kr,Yr=I(()=>{Kr=`// srotm: applies modified Givens rotation H to vectors x and y.
...
`});var re,Jr=I(()=>{re=`// isamax: returns index of element with largest absolute value
...
`});var te,ee=I(()=>{te=`// sgemv_n: y = alpha * A * x + beta * y  (A is m\xD7n row-major, no-transpose)
//
...
`});var ie,ae=I(()=>{ie=`// sgemv_t: y = alpha * A^T * x + beta * y  (A is m\xD7n row-major, transposed)
...
`});var ne,oe=I(()=>{ne=`// ssymv: y = alpha * A * x + beta * y
...
`});var fe,le=I(()=>{fe=`// f64add: adds two doubles, each packed as a [main, aux] pair (main: f32
...
`});var de,ce=I(()=>{de=`// dasum: result = sum(|x[i]|)
...
`});var pe,me=I(()=>{pe=`// strsv_block: solves diagonal block [blockStart, blockEnd) sequentially \u2014
...
`});var we,ge=I(()=>{we=`// strsv_update: subtracts a solved block's contribution from every
...
`});var be={};gr(be,{shaderSources:()=>_t});var _t,xe=I(()=>{Sr();jr();Wr();Ir();Ur();Vr();Rr();Cr();zr();qr();$r();Yr();Jr();ee();ae();oe();se();le();ce();me();ge();_t={"reduction/argmax":Fr,"reduction/sum":Nr,"reduction/sumF64":Lr,sscal:Mr,sswap:Tr,saxpy:Hr,scopy:Dr,sdot:Or,sasum:Qr,snrm2:Xr,srot:Zr,srotm:Kr,isamax:re,sgemv_n:te,sgemv_t:ie,ssymv:ne,strmv:ue,f64add:fe,dasum:de,strsv_block:pe,strsv_update:we}});var Bt={};gr(Bt,{GpuMatrix:()=>C,GpuVector:()=>h,cleanup:()=>_r,dasum:()=>Pe,gpuName:()=>Er,init:()=>yr,isamax:()=>je,randomFloat32Array:()=>Br,randomFloat64Array:()=>Pr,sasum:()=>Be,saxpy:()=>_e,scopy:()=>Ee,sdot:()=>ke,sgemv:()=>Le,snrm2:()=>Fe,srot:()=>Ne,srotm:()=>We,sscal:()=>ve,sswap:()=>ye,ssymv:()=>Ie,strmv:()=>Me,strsv:()=>Te});function br(a,r){return r?a.features.has("timestamp-query")?{requiredFeatures:["timestamp-query"]}:(console.warn("timestamp-query not supported on this device \u2014 benchmark mode disabled."),{}):{}}function xr(){if(!hr())return{querySet:null,passDescriptor:void 0};let r=M().createQuerySet({type:"timestamp",count:2});return{querySet:r,passDescriptor:{timestampWrites:{querySet:r,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}}}function tr(a,r){if(!r)return null;let e=M(),i=e.createBuffer({label:"timestamp-resolve",size:16,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC});a.resolveQuerySet(r,0,2,i,0);let t=e.createBuffer({label:"timestamp-readback",size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return a.copyBufferToBuffer(i,0,t,0,16),{tsReadBuffer:t,resolveBuffer:i,querySet:r}}async function B(a){if(!a)return;let{tsReadBuffer:r,resolveBuffer:e,querySet:i}=a;await r.mapAsync(GPUMapMode.READ);let t=new BigInt64Array(r.getMappedRange().slice());return r.unmap(),r.destroy(),e.destroy(),i.destroy(),Math.max(0,Number(t[1]-t[0]))/1e6}var z=null,X=null,vr=null,nr=!1;async function yr({powerPreference:a="high-performance",benchmark:r=!1}={}){if(z)return z;let e;if(typeof window>"u"){let{create:o,globals:u}=await import("webgpu");Object.assign(globalThis,u),e=o([]),vr=e}else e=navigator.gpu;if(!e)throw new Error("WebGPU not supported in this environment.");if(X=await e.requestAdapter({powerPreference:a})??await e.requestAdapter(),!X)throw new Error("No WebGPU adapter found.");nr=r;let t=[...br(X,r).requiredFeatures??[]];return z=await X.requestDevice({requiredFeatures:t}),z.addEventListener("uncapturederror",o=>{console.error("Uncaptured GPU error:",o.error.message)}),z}function _r(){z&&(z.destroy(),z=null),X=null,vr=null,nr=!1}function Er(){if(!X)throw new Error("WebGPU adapter not initialized \u2014 call init() first.");let{device:a,description:r}=X.info;return{description:r||"unknown",device:a||"unknown"}}function hr(){return nr}function M(){if(!z)throw new Error("WebGPU device not initialized \u2014 call init() first.");return z}function m(...a){a.flat().forEach(r=>r.destroy())}function b(a,r="blas-input",e=!1){let i=M(),t=i.limits.maxStorageBufferBindingSize,o=a.byteLength;if(o>t)throw new Error(`Buffer size ${o} bytes exceeds device limit of ${t} bytes.`);let u=e?GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC:GPUBufferUsage.STORAGE,n=i.createBuffer({label:r,size:o,usage:u,mappedAtCreation:!0}),l=a.constructor;return new l(n.getMappedRange()).set(a),n.unmap(),n}function D(a,r="blas-storage"){return M().createBuffer({label:r,size:a,usage:GPUBufferUsage.STORAGE})}function O(a,r="blas-result"){return M().createBuffer({label:r,size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC})}function _(a,r){let i=M().createBuffer({label:"blas-readback",size:r.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return a.copyBufferToBuffer(r,0,i,0,r.size),i}function N(a,r="blas-params"){let e=M(),i=a.length*4,t=Math.ceil(i/16)*16,o=new ArrayBuffer(t),u=new DataView(o);a.forEach(({value:l,type:s},c)=>{let f=c*4;if(s==="u32")u.setUint32(f,l,!0);else if(s==="i32")u.setInt32(f,l,!0);else if(s==="f32")u.setFloat32(f,l,!0);else throw new Error(`Unknown param type "${s}". Use "f32", "u32", or "i32".`)});let n=e.createBuffer({label:r,size:t,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return e.queue.writeBuffer(n,0,o),n}async function y(a,r=Float32Array){try{await a.mapAsync(GPUMapMode.READ);let e=new r(a.getMappedRange().slice());return a.unmap(),e}finally{a.destroy()}}var Xe=new ArrayBuffer(8),Z=new DataView(Xe),Gr=new ArrayBuffer(4),kr=new Uint32Array(Gr),Ar=new Float32Array(Gr);function $e(a){return kr[0]=a>>>0,Ar[0]}function Ze(a){return Ar[0]=a,kr[0]}function Ye(a,r,e,i){let t=r>>>3,o=r&7,u=i>>>29,n=e<<3|u,l=i&536870911,s=a<<31|t<<23|n,c=o>>>2&1,f=o&3,d=l>>>23,p=l&8388607,g=f<<6|d,w=(c<<31|g<<23|p)>>>0;return[$e(s),w]}function Ke(a,r){let e=Ze(a);r=r>>>0;let i=e>>>31,t=e>>>23&255,o=e&8388607,u=r>>>31,n=r>>>23&255,l=r&8388607,s=u<<2|n>>>6,c=(n&63)<<23|l,f=t<<3|s,d=o>>>3,g=((o&7)<<29|c)>>>0;return{sign:i,rawExp:f,mantissaHi:d,lo:g}}var Je=2040;function ar(a){Z.setFloat64(0,a,!1);let r=Z.getUint32(0,!1),e=Z.getUint32(4,!1),i=r>>>31,t=r>>>20&2047,o=r&1048575;if(t>=Je)throw new RangeError(`packF64: |${a}| is too large to pack safely (must be finite with magnitude below ~1.4e306); main's bit pattern would itself be NaN/Infinity-shaped and get silently corrupted by any real float32 round-trip`);return Ye(i,t,o,e)}function Y(a,r){let{sign:e,rawExp:i,mantissaHi:t,lo:o}=Ke(a,r),u=(e<<31|i<<20|t)>>>0;return Z.setUint32(0,u,!1),Z.setUint32(4,o,!1),Z.getFloat64(0,!1)}var h=class a{constructor(r,e,i=Float32Array,t=null){this._buf=r,this._auxBuf=t,this.length=e,this.dtype=i}static from(r){if(r instanceof Float64Array){let i=new Float32Array(r.length),t=new Uint32Array(r.length);for(let n=0;n<r.length;n++){let l=ar(r[n]);i[n]=l[0],t[n]=l[1]}let o=b(i,"gpu-vector-f64-main",!0),u=b(t,"gpu-vector-f64-aux",!0);return new a(o,r.length,Float64Array,u)}if(!(r instanceof Float32Array))throw new Error("GpuVector.from expects a Float32Array or Float64Array.");let e=b(r,"gpu-vector",!0);return new a(e,r.length,r.constructor)}async read(){let r=M(),e=r.createCommandEncoder(),i=_(e,this._buf);if(r.queue.submit([e.finish()]),!this._auxBuf)return y(i,this.dtype);let t=r.createCommandEncoder(),o=_(t,this._auxBuf);r.queue.submit([t.finish()]);let[u,n]=await Promise.all([y(i,Float32Array),y(o,Uint32Array)]),l=new Float64Array(this.length);for(let s=0;s<this.length;s++)l[s]=Y(u[s],n[s]);return l}destroy(){this._buf.destroy(),this._auxBuf&&this._auxBuf.destroy()}};var C=class a{constructor(r,e,i,t,o=null){this._buf=r,this._auxBuf=o,this.rows=e,this.cols=i,this.lda=t}static from(r,e,i,t=i){if(!(r instanceof Float32Array)&&!(r instanceof Float64Array))throw new Error("GpuMatrix.from expects a Float32Array or Float64Array.");if(!Number.isInteger(e)||e<=0)throw new Error("rows must be a positive integer.");if(!Number.isInteger(i)||i<=0)throw new Error("cols must be a positive integer.");if(!Number.isInteger(t)||t<i)throw new Error("lda must be an integer >= cols.");if(r.length<e*t)throw new Error("data does not have enough elements for the given rows and lda.");if(r instanceof Float64Array){let u=e*t,n=new Float32Array(u),l=new Uint32Array(u);for(let f=0;f<u;f++){let d=ar(r[f]);n[f]=d[0],l[f]=d[1]}let s=b(n,"gpu-matrix-f64-main",!0),c=b(l,"gpu-matrix-f64-aux",!0);return new a(s,e,i,t,c)}let o=b(r.subarray(0,e*t),"gpu-matrix",!0);return new a(o,e,i,t)}async read(){let r=M(),e=r.createCommandEncoder(),i=_(e,this._buf);if(r.queue.submit([e.finish()]),this._auxBuf){let u=r.createCommandEncoder(),n=_(u,this._auxBuf);r.queue.submit([u.finish()]);let[l,s]=await Promise.all([y(i,Float32Array),y(n,Uint32Array)]),c=new Float64Array(this.rows*this.lda);for(let d=0;d<c.length;d++)c[d]=Y(l[d],s[d]);if(this.lda===this.cols)return c;let f=new Float64Array(this.rows*this.cols);for(let d=0;d<this.rows;d++)f.set(c.subarray(d*this.lda,d*this.lda+this.cols),d*this.cols);return f}let t=await y(i,Float32Array);if(this.lda===this.cols)return t;let o=new Float32Array(this.rows*this.cols);for(let u=0;u<this.rows;u++)o.set(t.subarray(u*this.lda,u*this.lda+this.cols),u*this.cols);return o}destroy(){this._buf.destroy(),this._auxBuf&&this._auxBuf.destroy()}};function Br(a,r=-1,e=1){let i=new Float32Array(a);for(let t=0;t<a;t++)i[t]=r+Math.random()*(e-r);return i}function Pr(a,r=-1,e=1){let i=new Float64Array(a);for(let t=0;t<a;t++)i[t]=r+Math.random()*(e-r);return i}function G(a,r,e=0){let i=M(),t=r.map((o,u)=>({binding:e+u,resource:{buffer:o}}));return i.createBindGroup({layout:a,entries:t})}var rt=new WeakMap;function P(a){M().queue.submit([a.finish()])}function sr(){let a=M(),{querySet:r,passDescriptor:e}=xr();return{commandEncoder:a.createCommandEncoder(),querySet:r,passDescriptor:e}}function ir(a,r,e,i,t){let o=a.beginComputePass(t);o.setPipeline(r),o.setBindGroup(0,e),typeof i=="number"?o.dispatchWorkgroups(i):o.dispatchWorkgroups(i.x,i.y),o.end(),rt.set(a,o)}function j(a,r,e){let{commandEncoder:i,querySet:t,passDescriptor:o}=sr();ir(i,a,r,e,o);let u=tr(i,t);return{commandEncoder:i,ts:u}}var kt={},ur=new WeakMap;async function k(a,r,e="main"){ur.has(a)||ur.set(a,new Map);let i=ur.get(a),t=Array.isArray(r)?r:[r],o=`${t.join("+")}::${e}`;return i.has(o)||i.set(o,await Gt(t,e)),i.get(o)}async function Et(a){if(typeof process>"u"||!process.versions?.node){let{shaderSources:r}=await Promise.resolve().then(()=>(xe(),be)),e=r[a];if(!e)throw new Error(`Shader "${a}" not found in browser bundle.`);return e}else{let{readFileSync:r}=await import("fs"),{fileURLToPath:e}=await import("url"),{dirname:i,join:t}=await import("path"),o=i(e(kt.url));return r(t(o,`../shaders/${a}.wgsl`),"utf8")}}async function Gt(a,r="main"){let e=M(),i=a.join("+"),t=(await Promise.all(a.map(Et))).join(`
