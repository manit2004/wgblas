var wgblas=(()=>{var ue=Object.create;var $=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var le=Object.getOwnPropertyNames;var me=Object.getPrototypeOf,fe=Object.prototype.hasOwnProperty;var Q=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var R=(t,r,e)=>()=>{if(e)throw e[0];try{return t&&(r=t(t=0)),r}catch(a){throw e=[a],a}};var rr=(t,r)=>{for(var e in r)$(t,e,{get:r[e],enumerable:!0})},er=(t,r,e,a)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of le(r))!fe.call(t,o)&&o!==e&&$(t,o,{get:()=>r[o],enumerable:!(a=ce(r,o))||a.enumerable});return t};var X=(t,r,e)=>(e=t!=null?ue(me(t)):{},er(r||!t||!t.__esModule?$(e,"default",{value:t,enumerable:!0}):e,t)),pe=t=>er($({},"__esModule",{value:!0}),t);var pr,fr=R(()=>{pr=`// amax reduction: collapses 2*WGS (value, index) pairs into one index.
...
`});var gr,dr=R(()=>{gr=`// sum reduction: collapses 2*WGS partials into one scalar.
// dispatch: 1 workgroup of WGS threads.
...
`});var br,wr=R(()=>{br=`// sscal: x = alpha * x
...
`});var _r,hr=R(()=>{_r=`// saxpy: y = alpha * x + y
...
`});var Er,Br=R(()=>{Er=`// sdot: result = sum(x[i] * y[i])
...
`});var Pr,Ar=R(()=>{Pr=`// sasum: result = sum(|x[i]|)
...
`});var Sr,kr=R(()=>{Sr=`// snrm2: result = sqrt(sum(x[i] * x[i]))
...
`});var Wr,Fr=R(()=>{Wr=`// srot: x = c*x + s*y,  y = -s*x + c*y
...
`});var Tr,Ir=R(()=>{Tr=`// srotm: applies modified Givens rotation H to vectors x and y.
...
`});var Rr,Nr=R(()=>{Rr=`// isamax: returns index of element with largest absolute value
...
`});var Mr,Ur=R(()=>{Mr=`// sgemv_n: y = alpha * A * x + beta * y  (A is m\xD7n row-major, no-transpose)
//
...
`});var Vr,Dr=R(()=>{Vr=`// sgemv_t: y = alpha * A^T * x + beta * y  (A is m\xD7n row-major, transposed)
...
`});var Cr,Lr=R(()=>{Cr=`// ssymv: y = alpha * A * x + beta * y
...
`});var jr={};rr(jr,{shaderSources:()=>Fe});var Fe,zr=R(()=>{fr();dr();wr();vr();hr();yr();Br();Ar();kr();Fr();Ir();Nr();Ur();Dr();Lr();Fe={"reduction/argmax":pr,"reduction/sum":gr,sscal:br,sswap:xr,saxpy:_r,scopy:Gr,sdot:Er,sasum:Pr,snrm2:Sr,srot:Wr,srotm:Tr,isamax:Rr,sgemv_n:Mr,sgemv_t:Vr,ssymv:Cr}});var Re={};rr(Re,{GpuMatrix:()=>j,GpuVector:()=>w,cleanup:()=>ur,gpuName:()=>cr,init:()=>nr,isamax:()=>ee,randomFloat32Array:()=>lr,randomFloat64Array:()=>mr,sasum:()=>Zr,saxpy:()=>$r,scopy:()=>Qr,sdot:()=>Hr,sgemv:()=>oe,snrm2:()=>re,srot:()=>te,srotm:()=>ae,sscal:()=>Or,sswap:()=>Yr,ssymv:()=>ie});function tr(t,r){return r?t.features.has("timestamp-query")?{requiredFeatures:["timestamp-query"]}:(console.warn("timestamp-query not supported on this device \u2014 benchmark mode disabled."),{}):{}}function ar(){if(!ir())return{querySet:null,passDescriptor:void 0};let r=I().createQuerySet({type:"timestamp",count:2});return{querySet:r,passDescriptor:{timestampWrites:{querySet:r,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}}}function or(t,r){if(!r)return null;let e=I(),a=e.createBuffer({label:"timestamp-resolve",size:16,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC});t.resolveQuerySet(r,0,2,a,0);let o=e.createBuffer({label:"timestamp-readback",size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return t.copyBufferToBuffer(a,0,o,0,16),{tsReadBuffer:o,resolveBuffer:a,querySet:r}}async function E(t){if(!t)return;let{tsReadBuffer:r,resolveBuffer:e,querySet:a}=t;await r.mapAsync(GPUMapMode.READ);let o=new BigInt64Array(r.getMappedRange().slice());return r.unmap(),r.destroy(),e.destroy(),a.destroy(),Math.max(0,Number(o[1]-o[0]))/1e6}var M=null,z=null,sr=null,H=!1;async function nr({powerPreference:t="high-performance",benchmark:r=!1}={}){if(M)return M;let e;if(typeof window>"u"){let{create:i,globals:s}=await import("webgpu");Object.assign(globalThis,s),e=i([]),sr=e}else e=navigator.gpu;if(!e)throw new Error("WebGPU not supported in this environment.");if(z=await e.requestAdapter({powerPreference:t})??await e.requestAdapter(),!z)throw new Error("No WebGPU adapter found.");H=r;let o=[...tr(z,r).requiredFeatures??[]];return M=await z.requestDevice({requiredFeatures:o}),M.addEventListener("uncapturederror",i=>{console.error("Uncaptured GPU error:",i.error.message)}),M}function ur(){M&&(M.destroy(),M=null),z=null,sr=null,H=!1}function cr(){if(!z)throw new Error("WebGPU adapter not initialized \u2014 call init() first.");let{device:t,description:r}=z.info;return{description:r||"unknown",device:t||"unknown"}}function ir(){return H}function I(){if(!M)throw new Error("WebGPU device not initialized \u2014 call init() first.");return M}function d(...t){t.flat().forEach(r=>r.destroy())}function g(t,r="blas-input",e=!1){let a=I(),o=a.limits.maxStorageBufferBindingSize,i=t.byteLength;if(i>o)throw new Error(`Buffer size ${i} bytes exceeds device limit of ${o} bytes.`);let s=e?GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC:GPUBufferUsage.STORAGE,n=a.createBuffer({label:r,size:i,usage:s,mappedAtCreation:!0});return new Float32Array(n.getMappedRange()).set(t),n.unmap(),n}function V(t,r="blas-storage"){return I().createBuffer({label:r,size:t,usage:GPUBufferUsage.STORAGE})}function C(t,r="blas-result"){return I().createBuffer({label:r,size:t,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC})}function y(t,r){let a=I().createBuffer({label:"blas-readback",size:r.size,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});return t.copyBufferToBuffer(r,0,a,0,r.size),a}function W(t,r="blas-params"){let e=I(),a=t.length*4,o=Math.ceil(a/16)*16,i=new ArrayBuffer(o),s=new DataView(i);t.forEach(({value:u,type:c},l)=>{let m=l*4;if(c==="u32")s.setUint32(m,u,!0);else if(c==="i32")s.setInt32(m,u,!0);else if(c==="f32")s.setFloat32(m,u,!0);else throw new Error(`Unknown param type "${c}". Use "f32", "u32", or "i32".`)});let n=e.createBuffer({label:r,size:o,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return e.queue.writeBuffer(n,0,i),n}async function G(t,r=Float32Array){try{await t.mapAsync(GPUMapMode.READ);let e=new r(t.getMappedRange().slice());return t.unmap(),e}finally{t.destroy()}}var w=class t{constructor(r,e,a=Float32Array){this._buf=r,this.length=e,this.dtype=a}static from(r){if(!(r instanceof Float32Array))throw new Error("GpuVector.from expects a Float32Array.");let e=g(r,"gpu-vector",!0);return new t(e,r.length,r.constructor)}async read(){let r=I(),e=r.createCommandEncoder(),a=y(e,this._buf);return r.queue.submit([e.finish()]),G(a,this.dtype)}destroy(){this._buf.destroy()}};var j=class t{constructor(r,e,a,o){this._buf=r,this.rows=e,this.cols=a,this.lda=o}static from(r,e,a,o=a){if(!(r instanceof Float32Array))throw new Error("GpuMatrix.from expects a Float32Array.");if(!Number.isInteger(e)||e<=0)throw new Error("rows must be a positive integer.");if(!Number.isInteger(a)||a<=0)throw new Error("cols must be a positive integer.");if(!Number.isInteger(o)||o<a)throw new Error("lda must be an integer >= cols.");if(r.length<e*o)throw new Error("data does not have enough elements for the given rows and lda.");let i=g(r.subarray(0,e*o),"gpu-matrix",!0);return new t(i,e,a,o)}async read(){let r=I(),e=r.createCommandEncoder(),a=y(e,this._buf);r.queue.submit([e.finish()]);let o=await G(a,Float32Array);if(this.lda===this.cols)return o;let i=new Float32Array(this.rows*this.cols);for(let s=0;s<this.rows;s++)i.set(o.subarray(s*this.lda,s*this.lda+this.cols),s*this.cols);return i}destroy(){this._buf.destroy()}};function lr(t,r=-1,e=1){let a=new Float32Array(t);for(let o=0;o<t;o++)a[o]=r+Math.random()*(e-r);return a}function mr(t,r=-1,e=1){let a=new Float64Array(t);for(let o=0;o<t;o++)a[o]=r+Math.random()*(e-r);return a}function A(t,r){let e=I(),a=r.map((o,i)=>({binding:i,resource:{buffer:o}}));return e.createBindGroup({layout:t,entries:a})}var de=new WeakMap;function P(t){I().queue.submit([t.finish()])}function k(t,r,e){let a=I(),{querySet:o,passDescriptor:i}=ar(),s=a.createCommandEncoder(),n=s.beginComputePass(i);n.setPipeline(t),n.setBindGroup(0,r),typeof e=="number"?n.dispatchWorkgroups(e):n.dispatchWorkgroups(e.x,e.y),n.end();let u=or(s,o);return de.set(s,n),{commandEncoder:s,ts:u}}var Te={},K=new WeakMap;async function S(t,r){K.has(t)||K.set(t,new Map);let e=K.get(t);return e.has(r)||e.set(r,await Ie(r)),e.get(r)}async function We(t){if(typeof process>"u"||!process.versions?.node){let{shaderSources:r}=await Promise.resolve().then(()=>(zr(),jr)),e=r[t];if(!e)throw new Error(`Shader "${t}" not found in browser bundle.`);return e}else{let{readFileSync:r}=await import("fs"),{fileURLToPath:e}=await import("url"),{dirname:a,join:o}=await import("path"),i=a(e(Te.url));return r(o(i,`../shaders/${t}.wgsl`),"utf8")}}async function Ie(t){let r=I(),e=await We(t),a=r.createShaderModule({label:t,code:e}),i=(await a.getCompilationInfo()).messages.filter(n=>n.type==="error");if(i.length>0)throw new Error(`Shader "${t}" compilation failed:
${i.map(n=>`  line ${n.lineNum}: ${n.message}`).join(`
`)}`);let s=r.createComputePipeline({label:t,layout:"auto",compute:{module:a}});return s._shaderModule=a,s}var Ne=64,qr=8;function U(t,r){let e=I().limits.maxComputeWorkgroupsPerDimension;return r===void 0?Math.min(Math.ceil(t/Ne),e):{x:Math.min(Math.ceil(r/qr),e),y:Math.min(Math.ceil(t/qr),e)}}async function Or(t,r,e,a,o){let i=a instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(o))throw new Error("n and incx must be integers.");if(isNaN(e))throw new Error("alpha must not be NaN.");if(!isFinite(e))throw new Error("alpha must be finite.");if(o<=0)throw new Error("incx must be positive.");if(!(a instanceof Float32Array)&&!(a instanceof w))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return i?{}:a;if(a.length<(r-1)*o+1)throw new Error("x does not have enough elements for the given n and incx.");let s=await S(t,"sscal"),n=i?a._buf:g(a,"sscal-x",!0),u=W([{value:r,type:"u32"},{value:e,type:"f32"},{value:o,type:"u32"}],"sscal-params"),c=A(s.getBindGroupLayout(0),[n,u]),{commandEncoder:l,ts:m}=k(s,c,U(r)),p=i?null:y(l,n);P(l);let f=await E(m);if(i)return d(u),f!==void 0?{gpuTimeMs:f}:{};let v=await G(p,Float32Array);return d(n,u),f!==void 0?{x:v,gpuTimeMs:f}:v}async function Yr(t,r,e,a,o,i){let s=e instanceof w,n=o instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!(e instanceof Float32Array)&&!(e instanceof w))throw new Error("x must be a Float32Array or GpuVector.");if(!(o instanceof Float32Array)&&!(o instanceof w))throw new Error("y must be a Float32Array or GpuVector.");if(e.constructor!==o.constructor)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return s?{}:{x:e,y:o};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let u=await S(t,"sswap"),c=s?e._buf:g(e,"sswap-x",!0),l=n?o._buf:g(o,"sswap-y",!0),m=W([{value:r,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"sswap-params"),p=A(u.getBindGroupLayout(0),[c,l,m]),{commandEncoder:f,ts:v}=k(u,p,U(r)),h=s?null:y(f,c),B=n?null:y(f,l);P(f);let x=await E(v);if(s&&n)return d(m),x!==void 0?{gpuTimeMs:x}:{};let _=await G(h,Float32Array),b=await G(B,Float32Array);return d(c,l,m),x!==void 0?{x:_,y:b,gpuTimeMs:x}:{x:_,y:b}}async function $r(t,r,e,a,o,i,s){let n=a instanceof w,u=i instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(o)||!Number.isInteger(s))throw new Error("n, incx, and incy must be integers.");if(isNaN(e))throw new Error("alpha must not be NaN.");if(!isFinite(e))throw new Error("alpha must be finite.");if(o<=0||s<=0)throw new Error("incx and incy must be positive.");if(!n&&!(a instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!u&&!(i instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(n!==u)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return u?{}:{y:i};if(a.length<(r-1)*o+1)throw new Error("x does not have enough elements for the given n and incx.");if(i.length<(r-1)*s+1)throw new Error("y does not have enough elements for the given n and incy.");let c=await S(t,"saxpy"),l=n?a._buf:g(a,"saxpy-x",!1),m=u?i._buf:g(i,"saxpy-y",!0),p=W([{value:r,type:"u32"},{value:e,type:"f32"},{value:o,type:"u32"},{value:s,type:"u32"}],"saxpy-params"),f=A(c.getBindGroupLayout(0),[l,m,p]),{commandEncoder:v,ts:h}=k(c,f,U(r)),B=u?null:y(v,m);P(v);let x=await E(h);if(u&&n)return d(p),x!==void 0?{gpuTimeMs:x}:{};let _=await G(B,Float32Array);return d(l,m,p),x!==void 0?{y:_,gpuTimeMs:x}:{y:_}}async function Qr(t,r,e,a,o,i){let s=e instanceof w,n=o instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!s&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(o instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(s!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return n?{}:{y:o};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let u=await S(t,"scopy"),c=s?e._buf:g(e,"scopy-x",!1),l=n?o._buf:g(o,"scopy-y",!0),m=W([{value:r,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"scopy-params"),p=A(u.getBindGroupLayout(0),[c,l,m]),{commandEncoder:f,ts:v}=k(u,p,U(r)),h=n?null:y(f,l);P(f);let B=await E(v);if(n&&s)return d(m),B!==void 0?{gpuTimeMs:B}:{};let x=await G(h,Float32Array);return d(c,l,m),B!==void 0?{y:x,gpuTimeMs:B}:{y:x}}var Xr=64;async function Hr(t,r,e,a,o,i){let s=e instanceof w,n=o instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!s&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!n&&!(o instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(s!==n)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return{dot:0};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let u=await S(t,"sdot"),c=await S(t,"reduction/sum"),l=s?e._buf:g(e,"sdot-x",!1),m=n?o._buf:g(o,"sdot-y",!1),p=V(2*Xr*4,"sdot-partials"),f=C(4,"sdot-result"),v=W([{value:r,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"sdot-params"),h=A(u.getBindGroupLayout(0),[l,m,p,v]),{commandEncoder:B,ts:x}=k(u,h,2*Xr);P(B);let _=A(c.getBindGroupLayout(0),[p,f]),{commandEncoder:b,ts:F}=k(c,_,1),T=y(b,f);P(b);let[N,D,L]=await Promise.all([E(x),E(F),G(T,Float32Array)]);return s&&n?(d(p,f,v),N!==void 0&&D!==void 0?{dot:L[0],gpuTimeMs:N+D}:{dot:L[0]}):(d(l,m,p,f,v,T),N!==void 0&&D!==void 0?{dot:L[0],gpuTimeMs:N+D}:{dot:L[0]})}var Kr=64;async function Zr(t,r,e,a){let o=e instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!o&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{asum:0};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await S(t,"sasum"),s=await S(t,"reduction/sum"),n=o?e._buf:g(e,"sasum-x",!1),u=V(2*Kr*4,"sasum-partials"),c=C(4,"sasum-result"),l=W([{value:r,type:"u32"},{value:a,type:"u32"}],"sasum-params"),m=A(i.getBindGroupLayout(0),[n,u,l]),{commandEncoder:p,ts:f}=k(i,m,2*Kr);P(p);let v=A(s.getBindGroupLayout(0),[u,c]),{commandEncoder:h,ts:B}=k(s,v,1),x=y(h,c);P(h);let[_,b,F]=await Promise.all([E(f),E(B),G(x,Float32Array)]);return o?(d(u,c,l),_!==void 0&&b!==void 0?{asum:F[0],gpuTimeMs:_+b}:{asum:F[0]}):(d(n,u,c,l,x),_!==void 0&&b!==void 0?{asum:F[0],gpuTimeMs:_+b}:{asum:F[0]})}var Jr=64;async function re(t,r,e,a){let o=e instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!o&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{nrm2:0};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await S(t,"snrm2"),s=await S(t,"reduction/sum"),n=o?e._buf:g(e,"snrm2-x",!1),u=V(2*Jr*4,"snrm2-partials"),c=C(4,"snrm2-result"),l=W([{value:r,type:"u32"},{value:a,type:"u32"}],"snrm2-params"),m=A(i.getBindGroupLayout(0),[n,u,l]),{commandEncoder:p,ts:f}=k(i,m,2*Jr);P(p);let v=A(s.getBindGroupLayout(0),[u,c]),{commandEncoder:h,ts:B}=k(s,v,1),x=y(h,c);P(h);let[_,b,F]=await Promise.all([E(f),E(B),G(x,Float32Array)]),T=Math.sqrt(F[0]);return o?(d(u,c,l),_!==void 0&&b!==void 0?{nrm2:T,gpuTimeMs:_+b}:{nrm2:T}):(d(n,u,c,l,x),_!==void 0&&b!==void 0?{nrm2:T,gpuTimeMs:_+b}:{nrm2:T})}var Z=64;async function ee(t,r,e,a){let o=e instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a))throw new Error("n and incx must be integers.");if(a<=0)throw new Error("incx must be positive.");if(!o&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(r<=0)return{index:0};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");let i=await S(t,"isamax"),s=await S(t,"reduction/argmax"),n=o?e._buf:g(e,"isamax-x",!1),u=V(2*Z*4,"isamax-partials-val"),c=V(2*Z*4,"isamax-partials-idx"),l=C(4,"isamax-result"),m=W([{value:r,type:"u32"},{value:a,type:"u32"}],"isamax-params"),p=A(i.getBindGroupLayout(0),[n,u,c,m]),{commandEncoder:f,ts:v}=k(i,p,2*Z);P(f);let h=A(s.getBindGroupLayout(0),[u,c,l]),{commandEncoder:B,ts:x}=k(s,h,1),_=y(B,l);P(B);let[b,F,T]=await Promise.all([E(v),E(x),G(_,Uint32Array)]),N=T[0];return o?(d(u,c,l,m),b!==void 0&&F!==void 0?{index:N,gpuTimeMs:b+F}:{index:N}):(d(n,u,c,l,m,_),b!==void 0&&F!==void 0?{index:N,gpuTimeMs:b+F}:{index:N})}async function te(t,r,e,a,o,i,s,n){let u=e instanceof w,c=o instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(isNaN(s)||isNaN(n))throw new Error("c and s must not be NaN.");if(!isFinite(s))throw new Error("c must be finite.");if(!isFinite(n))throw new Error("s must be finite.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!u&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!c&&!(o instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(u!==c)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0)return u?{}:{x:e,y:o};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let l=await S(t,"srot"),m=u?e._buf:g(e,"srot-x",!0),p=c?o._buf:g(o,"srot-y",!0),f=W([{value:r,type:"u32"},{value:s,type:"f32"},{value:n,type:"f32"},{value:a,type:"u32"},{value:i,type:"u32"}],"srot-params"),v=A(l.getBindGroupLayout(0),[m,p,f]),{commandEncoder:h,ts:B}=k(l,v,U(r)),x=u?null:y(h,m),_=c?null:y(h,p);P(h);let b=await E(B);if(u&&c)return d(f),b!==void 0?{gpuTimeMs:b}:{};let[F,T]=await Promise.all([G(x,Float32Array),G(_,Float32Array)]);return d(m,p,f),b!==void 0?{x:F,y:T,gpuTimeMs:b}:{x:F,y:T}}async function ae(t,r,e,a,o,i,s){let n=e instanceof w,u=o instanceof w;if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!Number.isInteger(r)||!Number.isInteger(a)||!Number.isInteger(i))throw new Error("n, incx, and incy must be integers.");if(!(s instanceof Float32Array)||s.length!==5)throw new Error("param must be a Float32Array of length 5.");if(a<=0||i<=0)throw new Error("incx and incy must be positive.");if(!n&&!(e instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!u&&!(o instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(n!==u)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(r<=0||s[0]===-2)return n?{}:{x:e,y:o};if(e.length<(r-1)*a+1)throw new Error("x does not have enough elements for the given n and incx.");if(o.length<(r-1)*i+1)throw new Error("y does not have enough elements for the given n and incy.");let c=await S(t,"srotm"),l=n?e._buf:g(e,"srotm-x",!0),m=u?o._buf:g(o,"srotm-y",!0),p=g(s,"srotm-param",!1),f=W([{value:r,type:"u32"},{value:a,type:"u32"},{value:i,type:"u32"}],"srotm-params"),v=A(c.getBindGroupLayout(0),[l,m,p,f]),{commandEncoder:h,ts:B}=k(c,v,U(r)),x=n?null:y(h,l),_=u?null:y(h,m);P(h);let b=await E(B);if(n&&u)return d(p,f),b!==void 0?{gpuTimeMs:b}:{};let[F,T]=await Promise.all([G(x,Float32Array),G(_,Float32Array)]);return d(l,m,p,f),b!==void 0?{x:F,y:T,gpuTimeMs:b}:{x:F,y:T}}async function oe(t,r,e,a,o,i,s,n,u,c,l,m){let p=n instanceof w,f=l instanceof w,v=i instanceof j,h=r==="no-transpose";if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!h&&r!=="transpose")throw new Error("trans must be 'no-transpose' or 'transpose'.");if(!Number.isInteger(e)||!Number.isInteger(a)||!Number.isInteger(u)||!Number.isInteger(m)||!Number.isInteger(s))throw new Error("m, n, incx, incy, and lda must be integers.");if(isNaN(o))throw new Error("alpha must not be NaN.");if(!isFinite(o))throw new Error("alpha must be finite.");if(isNaN(c))throw new Error("beta must not be NaN.");if(!isFinite(c))throw new Error("beta must be finite.");if(u<=0||m<=0)throw new Error("incx and incy must be positive.");if(s<a)throw new Error("lda must be >= n.");if(!v&&!(i instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!p&&!(n instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!f&&!(l instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(p!==f)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(p&&!v)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(v&&s!==i.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(v&&(i.rows<e||i.cols<a))throw new Error("A is too small for the given m and n.");if(e<=0||a<=0)return f?{}:{y:l};let B=h?a:e,x=h?e:a;if(!v&&i.length<(e-1)*s+a)throw new Error("A does not have enough elements for the given m, n, and lda.");if(n.length<(B-1)*u+1)throw new Error("x does not have enough elements for the given dimensions and incx.");if(l.length<(x-1)*m+1)throw new Error("y does not have enough elements for the given dimensions and incy.");let b=await S(t,h?"sgemv_n":"sgemv_t"),F=v?i._buf:g(i,"sgemv-A",!1),T=p?n._buf:g(n,"sgemv-x",!1),N=f?l._buf:g(l,"sgemv-y",!0),D=W([{value:e,type:"u32"},{value:a,type:"u32"},{value:o,type:"f32"},{value:c,type:"f32"},{value:u,type:"u32"},{value:m,type:"u32"},{value:s,type:"u32"}],"sgemv-params");try{let L=A(b.getBindGroupLayout(0),[F,T,N,D]),q=h?Math.min(e,t.limits.maxComputeWorkgroupsPerDimension):U(x),{commandEncoder:O,ts:se}=k(b,L,q),ne=f?null:y(O,N);P(O);let Y=await E(se);if(f)return Y!==void 0?{gpuTimeMs:Y}:{};let J=await G(ne,Float32Array);return Y!==void 0?{y:J,gpuTimeMs:Y}:{y:J}}finally{v||d(F),p||d(T),f||d(N),d(D)}}async function ie(t,r,e,a,o,i,s,n,u,c,l){let m=s instanceof w,p=c instanceof w,f=o instanceof j,v=r==="lower";if(!(t instanceof GPUDevice))throw new Error("device must be a GPUDevice.");if(!v&&r!=="upper")throw new Error("uplo must be 'lower' or 'upper'.");if(!Number.isInteger(e)||!Number.isInteger(n)||!Number.isInteger(l)||!Number.isInteger(i))throw new Error("n, incx, incy, and lda must be integers.");if(typeof a!="number")throw new Error("alpha must be a number.");if(Number.isNaN(a))throw new Error("alpha must not be NaN.");if(!Number.isFinite(a))throw new Error("alpha must be finite.");if(typeof u!="number")throw new Error("beta must be a number.");if(Number.isNaN(u))throw new Error("beta must not be NaN.");if(!Number.isFinite(u))throw new Error("beta must be finite.");if(n<=0||l<=0)throw new Error("incx and incy must be positive.");if(i<e)throw new Error("lda must be >= n.");if(!f&&!(o instanceof Float32Array))throw new Error("A must be a Float32Array or GpuMatrix.");if(!m&&!(s instanceof Float32Array))throw new Error("x must be a Float32Array or GpuVector.");if(!p&&!(c instanceof Float32Array))throw new Error("y must be a Float32Array or GpuVector.");if(m!==p)throw new Error("x and y must be the same type (both Float32Array or both GpuVector).");if(m&&!f)throw new Error("A must be a GpuMatrix when x and y are GpuVectors.");if(m&&s===c)throw new Error("x and y must not reference the same object when both are GpuVectors.");if(f&&i!==o.lda)throw new Error("lda must match A.lda when A is a GpuMatrix.");if(f&&(o.rows<e||o.cols<e))throw new Error("A is too small for the given n.");if(e<0)throw new Error("n must be non-negative.");if(e===0)return p?{}:{y:c};if(!f&&o.length<(e-1)*i+e)throw new Error("A does not have enough elements for the given n and lda.");if(s.length<(e-1)*n+1)throw new Error("x does not have enough elements for the given n and incx.");if(c.length<(e-1)*l+1)throw new Error("y does not have enough elements for the given n and incy.");let h=await S(t,"ssymv"),B=null,x=null,_=null,b=null;try{B=f?o._buf:g(o,"ssymv-A",!1),x=m?s._buf:g(s,"ssymv-x",!1),_=p?c._buf:g(c,"ssymv-y",!0),b=W([{value:e,type:"u32"},{value:a,type:"f32"},{value:u,type:"f32"},{value:n,type:"u32"},{value:l,type:"u32"},{value:i,type:"u32"},{value:v?0:1,type:"u32"}],"ssymv-params");let F=A(h.getBindGroupLayout(0),[B,x,_,b]),T=Math.min(Math.ceil(e/16),t.limits.maxComputeWorkgroupsPerDimension),{commandEncoder:N,ts:D}=k(h,F,T),L=p?null:y(N,_);P(N);let q=await E(D);if(p)return q!==void 0?{gpuTimeMs:q}:{};let O=await G(L,Float32Array);return q!==void 0?{y:O,gpuTimeMs:q}:{y:O}}finally{!f&&B&&d(B),!m&&x&&d(x),!p&&_&&d(_),b&&d(b)}}return pe(Re);})();
