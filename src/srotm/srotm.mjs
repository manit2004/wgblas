...
export async function srotm(n, x, incx, y, incy, param) {
    ...
    if (!_pipeline) _pipeline = await loadShader("srotm");
    ...
    const bindGroup = createBindGroup(_pipeline.getBindGroupLayout(0), [xBuffer, yBuffer, paramBuffer, paramsBuffer]);
