 ...
 * @see [sdot.mjs](https://github.com/manit2004/wgblas/blob/main/src/sdot/sdot.mjs#L18-L116)
 ...
 * @param incy - stride for y (must be a positive integer)
 * @returns dot product scalar — always a CPU readback, even for GpuVector inputs
 * @see [sdot.mjs](https://github.com/manit2004/wgblas/blob/main/src/sdot/sdot.mjs)
 * @category BLAS Level 1
 */
export declare function sdot(
  device: GPUDevice,
