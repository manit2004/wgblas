 ...
 * console.log(x);
 * ```
 * @see <a href="https://github.com/manit2004/wgblas/blob/main/src/random/random.mjsLINEHASHL1-L5">Source code: random.mjs (L1–L5)</a>
 * @category Utilities
 */
 ...
 * console.log(x);
 * ```
 * @see <a href="https://github.com/manit2004/wgblas/blob/main/src/random/random.mjsLINEHASHL7-L11">Source code: random.mjs (L7–L11)</a>
 * @category Utilities
 */
