 ...
 * @see [sasum.mjs](https://github.com/manit2004/wgblas/blob/main/src/sasum/sasum.mjs#L18-L96)
 ...
 * @param incx - stride for x (must be a positive integer)
 * @returns absolute sum scalar — always a CPU readback, even for GpuVector inputs
 * @see [sasum.mjs](https://github.com/manit2004/wgblas/blob/main/src/sasum/sasum.mjs)
 * @category BLAS Level 1
 */
export declare function sasum(
  device: GPUDevice,
