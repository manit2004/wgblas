 ...
 * @see [Source code: sswap.mjs (L15)](https://github.com/manit2004/wgblas/blob/main/src/sswap/sswap.mjs#L15)
 ...
 * @param incy - stride for y (must be a positive integer)
 * @see <a href="https://github.com/manit2004/wgblas/blob/main/src/sswap/sswap.mjs#L15">Source code: sswap.mjs (L15)</a>
 * @category BLAS Level 1
 */
export declare function sswap(
  device: GPUDevice,
