...
// dscal: same shape as sscal, just a Float64Array x — toX/fromX stay at
// their defaults (a plain .slice()), no adapter needed.
export const dscalReference = makeXReference(stdlibDscal, (a) => [a.alpha]);
