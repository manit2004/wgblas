...
// for a drot result is 2^-48 rather than 2^-52 — see shaders/f64/dekker.wgsl.
// Same bound shape as srot's own f32 forwardFactor (tests/srot/helpers.js):
// each output is a sum of two products, so the bound is eps times the sum of
// the two term magnitudes — just with double-double's own epsilon.
const eps = 2 ** -48;
