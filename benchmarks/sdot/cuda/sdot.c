...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.sdot.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("sdot", gpu_model, "sdot", "sdot", bench_ns, med_times, gbs_vals, num_ns);
