...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.scopy.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("scopy", gpu_model, "scopy", "scopy", bench_ns, med_times, gbs_vals, num_ns);
