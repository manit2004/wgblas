 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0070 | 0.0734 | 0.0034 | 0.1488 | 49.3% |
 * | 64 | 0.0070 | 0.1468 | 0.0035 | 0.2909 | 50.5% |
 * | 128 | 0.0070 | 0.2936 | 0.0037 | 0.5565 | 52.8% |
 * | 512 | 0.0072 | 1.1378 | 0.0037 | 2.2164 | 51.3% |
 * | 1024 | 0.0072 | 2.2908 | 0.0036 | 4.6126 | 49.7% |
 * | 4096 | 0.0072 | 9.1429 | 0.0036 | 18.2857 | 50.0% |
 * | 16384 | 0.0081 | 32.1886 | 0.0045 | 58.5143 | 55.0% |
 * | 65536 | 0.0101 | 103.3691 | 0.0087 | 120.0293 | 86.1% |
 * | 262144 | 0.0299 | 140.2590 | 0.0325 | 128.9444 | 108.8% |
 * | 1048576 | 0.1024 | 163.8400 | 0.1165 | 144.0549 | 113.7% |
 * | 4194304 | 0.3912 | 171.5602 | 0.4623 | 145.1567 | 118.2% |
 * | 16777216 | 1.5503 | 173.1484 | 1.7947 | 149.5682 | 115.8% |
 *
 * > Efficiency = wgblas GB/s ÷ cuBLAS GB/s × 100. Higher means wgblas is closer to cuBLAS throughput.
 *
 * <svg id="bc-sswap-nvidia_geforce_gtx_1650" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 260" width="600" height="260" role="img" aria-label="GB/s vs n for sswap">
 ...
 * <polyline class="ln1" points="58.0,219.9 85.7,219.9 113.4,219.7 168.7,218.9 196.4,217.7 251.8,210.9 307.2,187.8 362.5,116.6 417.9,79.7 473.3,56.2 528.6,48.4 584.0,46.9"/>
 * <polyline class="ln2" points="58.0,219.9 85.7,219.7 113.4,219.4 168.7,217.8 196.4,215.4 251.8,201.7 307.2,161.5 362.5,100.0 417.9,91.1 473.3,75.9 528.6,74.8 584.0,70.4"/>
 ...
 * <circle class="mk1" cx="251.8" cy="210.9" r="4"/>
 * <circle class="mk1" cx="307.2" cy="187.8" r="4"/>
 * <circle class="mk1" cx="362.5" cy="116.6" r="4"/>
 * <circle class="mk1" cx="417.9" cy="79.7" r="4"/>
 ...
 * <circle class="mk2" cx="251.8" cy="201.7" r="4"/>
 * <circle class="mk2" cx="307.2" cy="161.5" r="4"/>
 * <circle class="mk2" cx="362.5" cy="100.0" r="4"/>
 * <circle class="mk2" cx="417.9" cy="91.1" r="4"/>
 * <circle class="mk2" cx="473.3" cy="75.9" r="4"/>
 * <circle class="mk2" cx="528.6" cy="74.8" r="4"/>
 * <circle class="mk2" cx="584.0" cy="70.4" r="4"/>
