 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0068 | 0.3474 | 0.0040 | 0.5873 | 59.2% |
 * | 64 | 0.0069 | 1.2778 | 0.0056 | 1.5862 | 80.6% |
 * | 128 | 0.0071 | 4.7928 | 0.0099 | 3.4434 | 139.2% |
 * | 256 | 0.0086 | 15.4667 | 0.0249 | 5.3676 | 288.1% |
 * | 512 | 0.0114 | 46.4719 | 0.0857 | 6.1801 | 752.0% |
 * | 1024 | 0.0287 | 73.5000 | 0.3430 | 6.1436 | 1196.4% |
 * | 1280 | 0.0389 | 84.5395 | 0.2056 | 16.0025 | 528.3% |
 * | 2048 | 0.0823 | 102.1711 | 0.2666 | 31.5429 | 323.9% |
 * | 4096 | 0.2770 | 121.3005 | 1.1735 | 28.6283 | 423.7% |
 *
 ...
 * <polyline class="ln1" points="58.0,219.4 133.1,218.0 208.3,212.3 283.4,195.3 358.6,145.6 433.7,102.4 457.9,84.7 508.9,56.5 584.0,25.9"/>
 * <polyline class="ln2" points="58.0,219.1 133.1,217.5 208.3,214.5 283.4,211.4 358.6,210.1 433.7,210.2 457.9,194.4 508.9,169.5 584.0,174.2"/>
 * <circle class="mk1" cx="58.0" cy="219.4" r="4"/>
 * <circle class="mk1" cx="133.1" cy="218.0" r="4"/>
 * <circle class="mk1" cx="208.3" cy="212.3" r="4"/>
 * <circle class="mk1" cx="283.4" cy="195.3" r="4"/>
 * <circle class="mk1" cx="358.6" cy="145.6" r="4"/>
 * <circle class="mk1" cx="433.7" cy="102.4" r="4"/>
 * <circle class="mk1" cx="457.9" cy="84.7" r="4"/>
 * <circle class="mk1" cx="508.9" cy="56.5" r="4"/>
 * <circle class="mk1" cx="584.0" cy="25.9" r="4"/>
 ...
 * <circle class="mk2" cx="457.9" cy="194.4" r="4"/>
 * <circle class="mk2" cx="508.9" cy="169.5" r="4"/>
 * <circle class="mk2" cx="584.0" cy="174.2" r="4"/>
 ...
 * <text class="at" x="508.9" y="236" text-anchor="middle">2.0K</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">4.1K</text>
 * <polyline class="ln1" points="58.0,218.9 133.1,218.8 208.3,218.8 283.4,218.6 358.6,218.1 433.7,215.2 457.9,213.5 508.9,206.3 584.0,173.8"/>
 * <polyline class="ln2" points="58.0,219.3 133.1,219.1 208.3,218.3 283.4,215.8 358.6,205.7 433.7,162.8 457.9,185.7 508.9,175.6 584.0,24.4"/>
 * <circle class="mk1" cx="58.0" cy="218.9" r="4"/>
 * <circle class="mk1" cx="133.1" cy="218.8" r="4"/>
 * <circle class="mk1" cx="208.3" cy="218.8" r="4"/>
 * <circle class="mk1" cx="283.4" cy="218.6" r="4"/>
 * <circle class="mk1" cx="358.6" cy="218.1" r="4"/>
 * <circle class="mk1" cx="433.7" cy="215.2" r="4"/>
 * <circle class="mk1" cx="457.9" cy="213.5" r="4"/>
 * <circle class="mk1" cx="508.9" cy="206.3" r="4"/>
 * <circle class="mk1" cx="584.0" cy="173.8" r="4"/>
 ...
 * <circle class="mk2" cx="358.6" cy="205.7" r="4"/>
 * <circle class="mk2" cx="433.7" cy="162.8" r="4"/>
 * <circle class="mk2" cx="457.9" cy="185.7" r="4"/>
