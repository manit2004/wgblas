 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0082 | 0.2891 | 0.0060 | 0.3957 | 73.1% |
 * | 64 | 0.0082 | 1.0718 | 0.0075 | 1.1795 | 90.9% |
 * | 128 | 0.0095 | 3.5885 | 0.0104 | 3.2638 | 109.9% |
 * | 256 | 0.0144 | 9.2594 | 0.0178 | 7.4906 | 123.6% |
 * | 512 | 0.0274 | 19.3271 | 0.0348 | 15.2269 | 126.9% |
 * | 1024 | 0.0778 | 27.0789 | 0.1720 | 12.2511 | 221.0% |
 * | 1280 | 0.1208 | 27.2246 | 0.0688 | 47.8362 | 56.9% |
 * | 2048 | 0.2647 | 31.7679 | 0.1009 | 83.3045 | 38.1% |
 * | 4096 | 1.3808 | 24.3307 | 0.2560 | 131.2320 | 18.5% |
 *
 ...
 * <polyline class="ln1" points="58.0,219.6 133.1,218.6 208.3,215.2 283.4,207.7 358.6,194.2 433.7,183.9 457.9,183.7 508.9,177.6 584.0,187.6"/>
 * <polyline class="ln2" points="58.0,219.5 133.1,218.4 208.3,215.6 283.4,210.0 358.6,199.7 433.7,203.7 457.9,156.2 508.9,108.9 584.0,45.0"/>
 * <circle class="mk1" cx="58.0" cy="219.6" r="4"/>
 * <circle class="mk1" cx="133.1" cy="218.6" r="4"/>
 * <circle class="mk1" cx="208.3" cy="215.2" r="4"/>
 * <circle class="mk1" cx="283.4" cy="207.7" r="4"/>
 * <circle class="mk1" cx="358.6" cy="194.2" r="4"/>
 * <circle class="mk1" cx="433.7" cy="183.9" r="4"/>
 * <circle class="mk1" cx="457.9" cy="183.7" r="4"/>
 * <circle class="mk1" cx="508.9" cy="177.6" r="4"/>
 * <circle class="mk1" cx="584.0" cy="187.6" r="4"/>
 ...
 * <circle class="mk2" cx="433.7" cy="203.7" r="4"/>
 * <circle class="mk2" cx="457.9" cy="156.2" r="4"/>
 * <circle class="mk2" cx="508.9" cy="108.9" r="4"/>
 * <circle class="mk2" cx="584.0" cy="45.0" r="4"/>
 ...
 * <text class="at" x="508.9" y="236" text-anchor="middle">2.0K</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">4.1K</text>
 * <polyline class="ln1" points="58.0,218.9 133.1,218.9 208.3,218.7 283.4,218.1 358.6,216.3 433.7,209.6 457.9,203.9 508.9,184.7 584.0,35.9"/>
 * <polyline class="ln2" points="58.0,219.2 133.1,219.0 208.3,218.6 283.4,217.6 358.6,215.4 433.7,197.1 457.9,210.8 508.9,206.5 584.0,185.9"/>
 ...
 * <circle class="mk1" cx="508.9" cy="184.7" r="4"/>
 * <circle class="mk1" cx="584.0" cy="35.9" r="4"/>
 ...
 * <circle class="mk2" cx="457.9" cy="210.8" r="4"/>
 * <circle class="mk2" cx="508.9" cy="206.5" r="4"/>
 * <circle class="mk2" cx="584.0" cy="185.9" r="4"/>
 * </svg>
 *
 * ## See also
 *
