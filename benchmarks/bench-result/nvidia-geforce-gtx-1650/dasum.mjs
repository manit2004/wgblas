 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0289 | 0.0088 | 0.0184 | 0.0139 | 63.7% |
 * | 64 | 0.0291 | 0.0176 | 0.0187 | 0.0274 | 64.3% |
 * | 128 | 0.0307 | 0.0333 | 0.0188 | 0.0544 | 61.3% |
 * | 512 | 0.0322 | 0.1272 | 0.0189 | 0.2162 | 58.9% |
 * | 1024 | 0.0327 | 0.2502 | 0.0193 | 0.4252 | 58.9% |
 * | 4096 | 0.0346 | 0.9473 | 0.0189 | 1.7371 | 54.5% |
 * | 16384 | 0.0398 | 3.2953 | 0.0189 | 6.9189 | 47.6% |
 * | 65536 | 0.0528 | 9.9207 | 0.0214 | 24.5269 | 40.4% |
 * | 262144 | 0.1240 | 16.9125 | 0.0360 | 58.1767 | 29.1% |
 * | 1048576 | 0.2994 | 28.0173 | 0.0958 | 87.5857 | 32.0% |
 * | 4194304 | 1.2238 | 27.4181 | 0.3168 | 105.9114 | 25.9% |
 * | 16777216 | 3.7286 | 35.9966 | 1.1929 | 112.5157 | 32.0% |
 *
 ...
 * <polyline class="ln1" points="58.0,220.0 85.7,220.0 113.4,219.9 168.7,219.8 196.4,219.6 251.8,218.5 307.2,214.7 362.5,204.1 417.9,192.9 473.3,175.2 528.6,176.1 584.0,162.4"/>
 * <polyline class="ln2" points="58.0,220.0 85.7,220.0 113.4,219.9 168.7,219.7 196.4,219.3 251.8,217.2 307.2,208.9 362.5,180.8 417.9,126.9 473.3,79.9 528.6,50.5 584.0,40.0"/>
 ...
 * <circle class="mk1" cx="362.5" cy="204.1" r="4"/>
 * <circle class="mk1" cx="417.9" cy="192.9" r="4"/>
 * <circle class="mk1" cx="473.3" cy="175.2" r="4"/>
 * <circle class="mk1" cx="528.6" cy="176.1" r="4"/>
 * <circle class="mk1" cx="584.0" cy="162.4" r="4"/>
 ...
 * <circle class="mk2" cx="307.2" cy="208.9" r="4"/>
 * <circle class="mk2" cx="362.5" cy="180.8" r="4"/>
 * <circle class="mk2" cx="417.9" cy="126.9" r="4"/>
 * <circle class="mk2" cx="473.3" cy="79.9" r="4"/>
 ...
 * <text class="at" x="528.6" y="236" text-anchor="middle">4.2M</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">17M</text>
 * <polyline class="ln1" points="58.0,218.6 85.7,218.5 113.4,218.5 168.7,218.4 196.4,218.4 251.8,218.3 307.2,218.0 362.5,217.4 417.9,213.8 473.3,205.0 528.6,158.8 584.0,33.6"/>
 * <polyline class="ln2" points="58.0,219.1 85.7,219.1 113.4,219.1 168.7,219.1 196.4,219.0 251.8,219.1 307.2,219.1 362.5,218.9 417.9,218.2 473.3,215.2 528.6,204.2 584.0,160.4"/>
 ...
 * <circle class="mk1" cx="473.3" cy="205.0" r="4"/>
 * <circle class="mk1" cx="528.6" cy="158.8" r="4"/>
 * <circle class="mk1" cx="584.0" cy="33.6" r="4"/>
 * <circle class="mk2" cx="58.0" cy="219.1" r="4"/>
 * <circle class="mk2" cx="85.7" cy="219.1" r="4"/>
 * <circle class="mk2" cx="113.4" cy="219.1" r="4"/>
 * <circle class="mk2" cx="168.7" cy="219.1" r="4"/>
 ...
 * <circle class="mk2" cx="473.3" cy="215.2" r="4"/>
 * <circle class="mk2" cx="528.6" cy="204.2" r="4"/>
 * <circle class="mk2" cx="584.0" cy="160.4" r="4"/>
 * </svg>
 *
 * ## See also
 *
