 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0061 | 0.0417 | 0.0027 | 0.0964 | 43.2% |
 * | 64 | 0.0061 | 0.0833 | 0.0027 | 0.1916 | 43.5% |
 * | 128 | 0.0061 | 0.1675 | 0.0028 | 0.3678 | 45.6% |
 * | 512 | 0.0061 | 0.6667 | 0.0027 | 1.5238 | 43.8% |
 * | 1024 | 0.0061 | 1.3333 | 0.0027 | 3.0659 | 43.5% |
 * | 4096 | 0.0061 | 5.3333 | 0.0028 | 11.5706 | 46.1% |
 * | 16384 | 0.0066 | 19.8835 | 0.0033 | 39.9610 | 49.8% |
 * | 65536 | 0.0083 | 63.5039 | 0.0044 | 119.5912 | 53.1% |
 * | 262144 | 0.0191 | 109.5920 | 0.0158 | 132.6640 | 82.6% |
 * | 1048576 | 0.0609 | 137.7530 | 0.0532 | 157.8230 | 87.3% |
 * | 4194304 | 0.2212 | 151.7037 | 0.2026 | 165.6257 | 91.6% |
 * | 16777216 | 0.8190 | 163.8848 | 0.8009 | 167.5912 | 97.8% |
 *
 ...
 * <polyline class="ln1" points="58.0,220.0 85.7,219.9 113.4,219.8 168.7,219.3 196.4,218.7 251.8,214.7 307.2,200.1 362.5,156.5 417.9,110.4 473.3,82.2 528.6,68.3 584.0,56.1"/>
 * <polyline class="ln2" points="58.0,219.9 85.7,219.8 113.4,219.6 168.7,218.5 196.4,216.9 251.8,208.4 307.2,180.0 362.5,100.4 417.9,87.3 473.3,62.2 528.6,54.4 584.0,52.4"/>
 ...
 * <circle class="mk1" cx="307.2" cy="200.1" r="4"/>
 * <circle class="mk1" cx="362.5" cy="156.5" r="4"/>
 * <circle class="mk1" cx="417.9" cy="110.4" r="4"/>
 * <circle class="mk1" cx="473.3" cy="82.2" r="4"/>
 ...
 * <circle class="mk2" cx="251.8" cy="208.4" r="4"/>
 * <circle class="mk2" cx="307.2" cy="180.0" r="4"/>
 * <circle class="mk2" cx="362.5" cy="100.4" r="4"/>
 * <circle class="mk2" cx="417.9" cy="87.3" r="4"/>
 * <circle class="mk2" cx="473.3" cy="62.2" r="4"/>
 * <circle class="mk2" cx="528.6" cy="54.4" r="4"/>
 * <circle class="mk2" cx="584.0" cy="52.4" r="4"/>
 ...
 * <text class="at" x="528.6" y="236" text-anchor="middle">4.2M</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">17M</text>
 * <polyline class="ln1" points="58.0,218.8 85.7,218.8 113.4,218.8 168.7,218.8 196.4,218.8 251.8,218.8 307.2,218.7 362.5,218.3 417.9,216.2 473.3,207.8 528.6,175.8 584.0,56.2"/>
 * <polyline class="ln2" points="58.0,219.5 85.7,219.5 113.4,219.4 168.7,219.5 196.4,219.5 251.8,219.4 307.2,219.3 362.5,219.1 417.9,216.8 473.3,209.4 528.6,179.5 584.0,59.8"/>
 ...
 * <circle class="mk1" cx="417.9" cy="216.2" r="4"/>
 * <circle class="mk1" cx="473.3" cy="207.8" r="4"/>
 * <circle class="mk1" cx="528.6" cy="175.8" r="4"/>
 ...
 * <circle class="mk2" cx="584.0" cy="59.8" r="4"/>
 * </svg>
 *
 * ## See also
 *
