 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0074 | 0.5862 | 0.0041 | 1.0709 | 54.7% |
 * | 64 | 0.0076 | 2.2326 | 0.0041 | 4.1250 | 54.1% |
 * | 128 | 0.0082 | 8.1250 | 0.0041 | 16.2500 | 50.0% |
 * | 256 | 0.0093 | 28.5181 | 0.0044 | 60.7059 | 47.0% |
 * | 512 | 0.0120 | 87.4894 | 0.0082 | 129.0039 | 67.8% |
 * | 1024 | 0.0368 | 114.2977 | 0.0359 | 117.1525 | 97.6% |
 * | 1280 | 0.0539 | 121.8052 | 0.0706 | 92.9617 | 131.0% |
 * | 2048 | 0.1206 | 139.2412 | 0.1249 | 134.4951 | 103.5% |
 * | 4096 | 0.4444 | 151.0783 | 0.4855 | 138.3063 | 109.2% |
 *
 ...
 * <polyline class="ln1" points="58.0,219.4 133.1,217.8 208.3,211.9 283.4,191.5 358.6,132.5 433.7,105.7 457.9,98.2 508.9,80.8 584.0,68.9"/>
 * <polyline class="ln2" points="58.0,218.9 133.1,215.9 208.3,203.8 283.4,159.3 358.6,91.0 433.7,102.8 457.9,127.0 508.9,85.5 584.0,81.7"/>
 * <circle class="mk1" cx="58.0" cy="219.4" r="4"/>
 * <circle class="mk1" cx="133.1" cy="217.8" r="4"/>
 * <circle class="mk1" cx="208.3" cy="211.9" r="4"/>
 * <circle class="mk1" cx="283.4" cy="191.5" r="4"/>
 * <circle class="mk1" cx="358.6" cy="132.5" r="4"/>
 * <circle class="mk1" cx="433.7" cy="105.7" r="4"/>
 * <circle class="mk1" cx="457.9" cy="98.2" r="4"/>
 * <circle class="mk1" cx="508.9" cy="80.8" r="4"/>
 ...
 * <circle class="mk2" cx="283.4" cy="159.3" r="4"/>
 * <circle class="mk2" cx="358.6" cy="91.0" r="4"/>
 * <circle class="mk2" cx="433.7" cy="102.8" r="4"/>
 * <circle class="mk2" cx="457.9" cy="127.0" r="4"/>
 * <circle class="mk2" cx="508.9" cy="85.5" r="4"/>
 * <circle class="mk2" cx="584.0" cy="81.7" r="4"/>
 ...
 * <text class="at" x="508.9" y="236" text-anchor="middle">2.0K</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">4.1K</text>
 * <polyline class="ln1" points="58.0,217.0 133.1,217.0 208.3,216.7 283.4,216.3 358.6,215.2 433.7,205.3 457.9,198.4 508.9,171.8 584.0,42.2"/>
 * <polyline class="ln2" points="58.0,218.4 133.1,218.4 208.3,218.4 283.4,218.2 358.6,216.7 433.7,205.6 457.9,191.8 508.9,170.0 584.0,25.8"/>
 ...
 * <circle class="mk1" cx="358.6" cy="215.2" r="4"/>
 * <circle class="mk1" cx="433.7" cy="205.3" r="4"/>
 * <circle class="mk1" cx="457.9" cy="198.4" r="4"/>
 * <circle class="mk1" cx="508.9" cy="171.8" r="4"/>
 * <circle class="mk1" cx="584.0" cy="42.2" r="4"/>
 ...
 * <circle class="mk2" cx="433.7" cy="205.6" r="4"/>
 * <circle class="mk2" cx="457.9" cy="191.8" r="4"/>
 * <circle class="mk2" cx="508.9" cy="170.0" r="4"/>
 * <circle class="mk2" cx="584.0" cy="25.8" r="4"/>
 * </svg>
 *
 * ## See also
 *
