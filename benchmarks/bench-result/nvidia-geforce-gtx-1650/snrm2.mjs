 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0200 | 0.0064 | 0.0182 | 0.0070 | 91.2% |
 * | 64 | 0.0200 | 0.0128 | 0.0182 | 0.0141 | 90.8% |
 * | 128 | 0.0200 | 0.0256 | 0.0182 | 0.0281 | 91.1% |
 * | 512 | 0.0200 | 0.1025 | 0.0182 | 0.1127 | 90.9% |
 * | 1024 | 0.0200 | 0.2043 | 0.0182 | 0.2246 | 91.0% |
 * | 4096 | 0.0199 | 0.8218 | 0.0173 | 0.9446 | 87.0% |
 * | 16384 | 0.0206 | 3.1777 | 0.0181 | 3.6184 | 87.8% |
 * | 65536 | 0.0205 | 12.8000 | 0.0174 | 15.0588 | 85.0% |
 * | 262144 | 0.0273 | 38.4375 | 0.0186 | 56.3508 | 68.2% |
 * | 1048576 | 0.0463 | 90.5193 | 0.0437 | 95.8829 | 94.4% |
 * | 4194304 | 0.1167 | 143.8179 | 0.1434 | 117.0286 | 122.9% |
 * | 16777216 | 0.4055 | 165.4949 | 0.5887 | 114.0004 | 145.2% |
 *
 ...
 * <polyline class="ln1" points="58.0,220.0 85.7,220.0 113.4,220.0 168.7,219.9 196.4,219.8 251.8,219.2 307.2,216.8 362.5,207.2 417.9,181.6 473.3,129.5 528.6,76.2 584.0,54.5"/>
 * <polyline class="ln2" points="58.0,220.0 85.7,220.0 113.4,220.0 168.7,219.9 196.4,219.8 251.8,219.1 307.2,216.4 362.5,204.9 417.9,163.6 473.3,124.1 528.6,103.0 584.0,106.0"/>
 ...
 * <circle class="mk1" cx="417.9" cy="181.6" r="4"/>
 * <circle class="mk1" cx="473.3" cy="129.5" r="4"/>
 * <circle class="mk1" cx="528.6" cy="76.2" r="4"/>
 ...
 * <circle class="mk2" cx="362.5" cy="204.9" r="4"/>
 * <circle class="mk2" cx="417.9" cy="163.6" r="4"/>
 * <circle class="mk2" cx="473.3" cy="124.1" r="4"/>
 * <circle class="mk2" cx="528.6" cy="103.0" r="4"/>
 * <circle class="mk2" cx="584.0" cy="106.0" r="4"/>
 ...
 * <text class="at" x="528.6" y="236" text-anchor="middle">4.2M</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">17M</text>
 * <polyline class="ln1" points="58.0,213.3 85.7,213.3 113.4,213.3 168.7,213.3 196.4,213.3 251.8,213.4 307.2,213.1 362.5,213.2 417.9,210.9 473.3,204.6 528.6,181.1 584.0,84.8"/>
 * <polyline class="ln2" points="58.0,213.9 85.7,213.9 113.4,213.9 168.7,213.9 196.4,213.9 251.8,214.2 307.2,214.0 362.5,214.2 417.9,213.8 473.3,205.4 528.6,172.2 584.0,23.8"/>
 * <circle class="mk1" cx="58.0" cy="213.3" r="4"/>
 * <circle class="mk1" cx="85.7" cy="213.3" r="4"/>
 * <circle class="mk1" cx="113.4" cy="213.3" r="4"/>
 * <circle class="mk1" cx="168.7" cy="213.3" r="4"/>
 * <circle class="mk1" cx="196.4" cy="213.3" r="4"/>
 * <circle class="mk1" cx="251.8" cy="213.4" r="4"/>
 * <circle class="mk1" cx="307.2" cy="213.1" r="4"/>
 * <circle class="mk1" cx="362.5" cy="213.2" r="4"/>
 * <circle class="mk1" cx="417.9" cy="210.9" r="4"/>
 * <circle class="mk1" cx="473.3" cy="204.6" r="4"/>
 * <circle class="mk1" cx="528.6" cy="181.1" r="4"/>
 * <circle class="mk1" cx="584.0" cy="84.8" r="4"/>
 ...
 * <circle class="mk2" cx="251.8" cy="214.2" r="4"/>
 * <circle class="mk2" cx="307.2" cy="214.0" r="4"/>
 * <circle class="mk2" cx="362.5" cy="214.2" r="4"/>
 * <circle class="mk2" cx="417.9" cy="213.8" r="4"/>
 * <circle class="mk2" cx="473.3" cy="205.4" r="4"/>
 * <circle class="mk2" cx="528.6" cy="172.2" r="4"/>
 * <circle class="mk2" cx="584.0" cy="23.8" r="4"/>
 * </svg>
 *
 * ## See also
 *
