 ...
 * |---|-----------|-------------|-----------|-------------|------------|
 * | 32 | 0.0061 | 0.0836 | 0.0028 | 0.1818 | 46.0% |
 * | 64 | 0.0060 | 0.1693 | 0.0028 | 0.3596 | 47.1% |
 * | 128 | 0.0060 | 0.3386 | 0.0028 | 0.7232 | 46.8% |
 * | 512 | 0.0061 | 1.3474 | 0.0029 | 2.7826 | 48.4% |
 * | 1024 | 0.0061 | 2.6877 | 0.0029 | 5.6575 | 47.5% |
 * | 4096 | 0.0061 | 10.6667 | 0.0033 | 20.0784 | 53.1% |
 * | 16384 | 0.0067 | 39.3846 | 0.0038 | 68.2667 | 57.7% |
 * | 65536 | 0.0084 | 125.5479 | 0.0067 | 157.5385 | 79.7% |
 * | 262144 | 0.0287 | 146.2041 | 0.0273 | 153.4801 | 95.3% |
 * | 1048576 | 0.1024 | 163.8400 | 0.1006 | 166.7583 | 98.2% |
 * | 4194304 | 0.3954 | 169.7206 | 0.3952 | 169.7892 | 100.0% |
 * | 16777216 | 1.5489 | 173.3022 | 1.5657 | 171.4445 | 101.1% |
 *
 ...
 * <polyline class="ln1" points="58.0,219.9 85.7,219.8 113.4,219.7 168.7,218.7 196.4,217.3 251.8,209.3 307.2,180.6 362.5,94.5 417.9,73.8 473.3,56.2 528.6,50.3 584.0,46.7"/>
 * <polyline class="ln2" points="58.0,219.8 85.7,219.6 113.4,219.3 168.7,217.2 196.4,214.3 251.8,199.9 307.2,151.7 362.5,62.5 417.9,66.5 473.3,53.2 528.6,50.2 584.0,48.6"/>
 ...
 * <circle class="mk1" cx="307.2" cy="180.6" r="4"/>
 * <circle class="mk1" cx="362.5" cy="94.5" r="4"/>
 * <circle class="mk1" cx="417.9" cy="73.8" r="4"/>
 * <circle class="mk1" cx="473.3" cy="56.2" r="4"/>
 * <circle class="mk1" cx="528.6" cy="50.3" r="4"/>
 * <circle class="mk1" cx="584.0" cy="46.7" r="4"/>
 ...
 * <circle class="mk2" cx="251.8" cy="199.9" r="4"/>
 * <circle class="mk2" cx="307.2" cy="151.7" r="4"/>
 * <circle class="mk2" cx="362.5" cy="62.5" r="4"/>
 * <circle class="mk2" cx="417.9" cy="66.5" r="4"/>
 * <circle class="mk2" cx="473.3" cy="53.2" r="4"/>
 * <circle class="mk2" cx="528.6" cy="50.2" r="4"/>
 ...
 * <text class="at" x="528.6" y="236" text-anchor="middle">4.2M</text>
 * <text class="at" x="584.0" y="236" text-anchor="middle">17M</text>
 * <polyline class="ln1" points="58.0,219.4 85.7,219.4 113.4,219.4 168.7,219.4 196.4,219.4 251.8,219.4 307.2,219.3 362.5,219.2 417.9,217.1 473.3,209.8 528.6,180.5 584.0,65.1"/>
 * <polyline class="ln2" points="58.0,219.7 85.7,219.7 113.4,219.7 168.7,219.7 196.4,219.7 251.8,219.7 307.2,219.6 362.5,219.3 417.9,217.3 473.3,209.9 528.6,180.5 584.0,63.4"/>
 ...
 * <circle class="mk1" cx="584.0" cy="65.1" r="4"/>
