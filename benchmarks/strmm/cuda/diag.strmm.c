// diag sweep — strmm.c pins diag to its baseline.
//
...
int main(void) {
    ...
    float alpha = 1.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasStrmm(handle, CUBLAS_SIDE_LEFT, CUBLAS_FILL_MODE_LOWER, CUBLAS_OP_N, diag, n, n, &alpha, d_A, lda, d_B, ldb, d_C, ldc));
            }
    ...
    save_results_flag(gpu_model, "strmm", "diag.strmm", "diag",
