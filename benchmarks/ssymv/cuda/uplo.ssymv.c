// uplo sweep — ssymv.c pins uplo to its baseline.
//
...
int main(void) {
    ...
    float beta = 0.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSsymv(handle, uplo, n, &alpha, d_A, lda, d_x, 1, &beta, d_y, 1));
            }
    ...
    save_results_flag(gpu_model, "ssymv", "uplo.ssymv", "uplo",
