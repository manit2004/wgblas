// ldb sweep — ssymm.c pins ldb to its baseline.
//
// Same as the lda sweep, on B — the operand streamed along the inner loop.
...
int main(void) {
    ...
    save_results_pad_ex(gpu_model, "ssymm", "ldb.ssymm",
