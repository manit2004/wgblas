// uplo sweep — ssymm.c pins uplo to its baseline.
//
...
int main(void) {
    ...
    float beta = 0.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSsymm(handle, CUBLAS_SIDE_LEFT, uplo, n, n, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
            }
    ...
    save_results_flag(gpu_model, "ssymm", "uplo.ssymm", "uplo",
