...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.sasum.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("sasum", gpu_model, "sasum", "sasum", bench_ns, med_times, gbs_vals, num_ns);
