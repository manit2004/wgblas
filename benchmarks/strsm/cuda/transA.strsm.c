// transA sweep — strsm.c pins transA to its baseline.
//
...
int main(void) {
    ...
    float alpha = 1.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasStrsm(handle, CUBLAS_SIDE_LEFT, CUBLAS_FILL_MODE_LOWER, transA, CUBLAS_DIAG_NON_UNIT, n, n, &alpha, d_A, lda, d_B, ldb));
            }
    ...
    save_results_flag(gpu_model, "strsm", "transA.strsm", "transA",
