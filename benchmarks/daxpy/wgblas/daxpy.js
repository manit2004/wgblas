...
const STRIDE = 1; // unit stride — coalesced, best case. See stride.daxpy.js for incx/incy > 1.
...
for (const n of SIZES) {
  ...
  // x read + y read + y written, double-double (hi, lo) f32 pairs — 8
  // bytes/element, matching the memory traffic a real f64 buffer needs.
  const bytes = 3 * n * 8;
...
saveResults("daxpy", gpuModel, records, { folder: "daxpy" });
