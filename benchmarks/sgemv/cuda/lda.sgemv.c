// lda sweep — sgemv.c pins lda to its baseline.
//
// Column byte-stride is lda*4, so padding moves every column relative to the coalescing
...
int main(void) {
    ...
    save_results_pad(gpu_model, "sgemv", "lda.sgemv",
