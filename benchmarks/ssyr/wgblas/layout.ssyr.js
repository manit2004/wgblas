// layout sweep — ssyr.js pins layout to its baseline.
//
...
for (const layout of LAYOUTS) {
  for (const n of SIZES) {
    ...
    for (let i = 0; i < WARMUP_ITERS; i++) {
      await ssyr(device, "lower", n, 1.0, xGpu, 1, AGpu, lda, layout);
    }
    ...
    // triangle read + write + x — logical elements touched, same for every layout
