// Stride sweep — srotm.c is entirely incx=incy=1 (coalesced, best case).
...
// plateau) — stride=1 itself is covered by srotm.c, not repeated here.
...
int main(void) {
    ...
    save_results_stride(gpu_model, "srotm", "stride.srotm", rec_strides, rec_ns, med_times, gbs_vals, num_recs);
