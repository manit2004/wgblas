...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.drot.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("drot", gpu_model, "drot", "drot", bench_ns, med_times, gbs_vals, num_ns);
