// Stride sweep — drot.js is entirely incx=incy=1 (coalesced, best case).
// Same rationale as srot's own stride sweep. stride=1 itself is covered by
// drot.js, not repeated here.
...
for (const stride of STRIDES) {
  for (const n of SIZES) {
    ...
    // 8 bytes per double-double-emulated element, not 4 — see drot.js.
