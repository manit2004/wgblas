// alpha sweep — sger.c pins alpha to its baseline.
//
...
int main(void) {
    ...
    float alpha = alpha_v;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSger(handle, n, n, &alpha, d_x, 1, d_y, 1, d_A, lda));
            }
            ...
            // A read + write + x + y — logical elements touched, same for every alpha
    ...
    save_results_scalar(gpu_model, "sger", "alpha.sger", "alpha",
