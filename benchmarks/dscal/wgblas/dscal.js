...
const STRIDE = 1; // unit stride — coalesced, best case. See stride.dscal.js for incx > 1.
...
for (const n of SIZES) {
  ...
  // x read + x written (in-place), double-double (hi, lo) f32 pairs — 8
...
saveResults("dscal", gpuModel, records, { folder: "dscal" });
