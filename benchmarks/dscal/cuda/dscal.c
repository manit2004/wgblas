...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.dscal.c for incx > 1.
...
int main(void) {
    ...
    save_results_ex("dscal", gpu_model, "dscal", "dscal", bench_ns, med_times, gbs_vals, num_ns);
