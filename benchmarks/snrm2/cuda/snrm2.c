...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.snrm2.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("snrm2", gpu_model, "snrm2", "snrm2", bench_ns, med_times, gbs_vals, num_ns);
