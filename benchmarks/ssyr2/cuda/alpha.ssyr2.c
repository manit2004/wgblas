// alpha sweep — ssyr2.c pins alpha to its baseline.
//
...
int main(void) {
    ...
    float alpha = alpha_v;
            ...
            // triangle read + write + x + y — logical elements touched, same for every alpha
    ...
    save_results_scalar(gpu_model, "ssyr2", "alpha.ssyr2", "alpha",
