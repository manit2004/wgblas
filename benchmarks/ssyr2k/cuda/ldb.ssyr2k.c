// ldb sweep — ssyr2k.c pins ldb to its baseline.
//
...
int main(void) {
    ...
    float beta = 0.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSsyr2k(handle, CUBLAS_FILL_MODE_LOWER, CUBLAS_OP_N, n, n, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
            }
            ...
            float bytes = (2.0f * n * n + 2.0f * n * n) * sizeof(float);
    ...
    save_results_pad_ex(gpu_model, "ssyr2k", "ldb.ssyr2k",
