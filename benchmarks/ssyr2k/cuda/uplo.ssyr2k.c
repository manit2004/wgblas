// uplo sweep — ssyr2k.c pins uplo to its baseline.
//
...
int main(void) {
    ...
    float beta = 0.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSsyr2k(handle, uplo, CUBLAS_OP_N, n, n, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
            }
    ...
    save_results_flag(gpu_model, "ssyr2k", "uplo.ssyr2k", "uplo",
