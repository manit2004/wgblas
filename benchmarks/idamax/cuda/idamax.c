...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.idamax.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("idamax", gpu_model, "idamax", "idamax", bench_ns, med_times, gbs_vals, num_ns);
