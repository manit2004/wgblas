...
#define STRIDE 1 // unit stride — coalesced, best case. See stride.sswap.c for incx/incy > 1.
...
int main(void) {
    ...
    save_results_ex("sswap", gpu_model, "sswap", "sswap", bench_ns, med_times, gbs_vals, num_ns);
