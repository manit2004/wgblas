// uplo sweep — ssyrk.c pins uplo to its baseline.
//
...
int main(void) {
    ...
    float beta = 0.0f;
            ...
            for (int i = 0; i < WARMUP_ITERS; i++) {
                CUBLAS_CHECK(cublasSsyrk(handle, uplo, CUBLAS_OP_N, n, n, &alpha, d_A, lda, &beta, d_C, ldc));
            }
    ...
    save_results_flag(gpu_model, "ssyrk", "uplo.ssyrk", "uplo",
