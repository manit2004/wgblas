// Stride sweep — saxpy.js is entirely incx=incy=1 (coalesced, best case).
...
// plateau) — stride=1 itself is covered by saxpy.js, not repeated here.
...
for (const stride of STRIDES) {
  for (const n of SIZES) {
    ...
    const bytes = 3 * n * 4; // logical elements touched, same regardless of stride
