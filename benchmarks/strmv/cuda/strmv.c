...
int main(void) {
    ...
    for (int si = 0; si < num_sizes; si++) {
        ...
        for (int i = 0; i < WARMUP_ITERS; i++) {
            ...
            CUBLAS_CHECK(cublasStrmv(handle, CUBLAS_FILL_MODE_LOWER, CUBLAS_OP_N, CUBLAS_DIAG_NON_UNIT, n, d_A, lda, d_x, 1));
        }
    ...
    save_results_ex("strmv", gpu_model, "strmv", "strmv", sizes, med_times, gbs_vals, num_sizes);
