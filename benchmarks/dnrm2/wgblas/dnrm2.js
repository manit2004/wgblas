...
const STRIDE = 1; // unit stride — coalesced, best case. See stride.dnrm2.js for incx > 1.
...
for (const n of SIZES) {
  ...
  // x read only, double-double (hi, lo) f32 pair — 8 bytes/element.
  const bytes = n * 8;
...
saveResults("dnrm2", gpuModel, records, { folder: "dnrm2" });
